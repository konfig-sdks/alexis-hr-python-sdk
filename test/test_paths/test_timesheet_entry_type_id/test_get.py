...
from alexis_hr_python_sdk.paths.timesheet_entry_type_id import get
from alexis_hr_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestTimesheetEntryTypeId(ApiTestMixin, unittest.TestCase):
    """
    TimesheetEntryTypeId unit test stubs
