...
from alexis_hr_python_sdk.paths.employment_type_id import delete
from alexis_hr_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestEmploymentTypeId(ApiTestMixin, unittest.TestCase):
    """
    EmploymentTypeId unit test stubs
