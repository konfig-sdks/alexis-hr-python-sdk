...
from alexis_hr_python_sdk.paths.timesheet_entry_id import delete
from alexis_hr_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestTimesheetEntryId(ApiTestMixin, unittest.TestCase):
    """
    TimesheetEntryId unit test stubs
