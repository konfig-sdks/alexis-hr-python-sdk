...
from alexis_hr_python_sdk.paths.employee_team_reference import post
from alexis_hr_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestEmployeeTeamReference(ApiTestMixin, unittest.TestCase):
    """
    EmployeeTeamReference unit test stubs
