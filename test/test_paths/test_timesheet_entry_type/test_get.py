...
from alexis_hr_python_sdk.paths.timesheet_entry_type import get
from alexis_hr_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestTimesheetEntryType(ApiTestMixin, unittest.TestCase):
    """
    TimesheetEntryType unit test stubs
