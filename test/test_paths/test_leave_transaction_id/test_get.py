...
from alexis_hr_python_sdk.paths.leave_transaction_id import get
from alexis_hr_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestLeaveTransactionId(ApiTestMixin, unittest.TestCase):
    """
    LeaveTransactionId unit test stubs
