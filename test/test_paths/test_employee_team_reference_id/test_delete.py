...
import alexis_hr_python_sdk
from alexis_hr_python_sdk.paths.employee_team_reference_id import delete
from alexis_hr_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestEmployeeTeamReferenceId(ApiTestMixin, unittest.TestCase):
    """
    EmployeeTeamReferenceId unit test stubs
