...
class RequiredUpdateCompensationRequest(TypedDict):
    pass

class OptionalUpdateCompensationRequest(TypedDict, total=False):
    employeeId: str
...
class UpdateCompensationRequest(RequiredUpdateCompensationRequest, OptionalUpdateCompensationRequest):
    pass
