...
from alexis_hr_python_sdk.type.point_response_coordinates import PointResponseCoordinates

class RequiredPointResponse(TypedDict):
    type: str

    coordinates: PointResponseCoordinates

class OptionalPointResponse(TypedDict, total=False):
    pass

class PointResponse(RequiredPointResponse, OptionalPointResponse):
    pass
