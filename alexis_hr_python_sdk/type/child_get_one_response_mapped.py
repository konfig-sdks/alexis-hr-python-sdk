...
class RequiredChildGetOneResponseMapped(TypedDict):
    # Status String
    status: str
...
class OptionalChildGetOneResponseMapped(TypedDict, total=False):
    relations: typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]]

class ChildGetOneResponseMapped(RequiredChildGetOneResponseMapped, OptionalChildGetOneResponseMapped):
    pass
