...
class RequiredEmptyResponseMapped(TypedDict):
    # Status String
    status: str

    data: typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]]

class OptionalEmptyResponseMapped(TypedDict, total=False):
    pass

class EmptyResponseMapped(RequiredEmptyResponseMapped, OptionalEmptyResponseMapped):
    pass
