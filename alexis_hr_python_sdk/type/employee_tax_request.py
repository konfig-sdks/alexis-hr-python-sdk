...
class RequiredEmployeeTaxRequest(TypedDict):
    pass

class OptionalEmployeeTaxRequest(TypedDict, total=False):
    table: typing.Union[int, float]

    column: typing.Union[int, float]

class EmployeeTaxRequest(RequiredEmployeeTaxRequest, OptionalEmployeeTaxRequest):
    pass
