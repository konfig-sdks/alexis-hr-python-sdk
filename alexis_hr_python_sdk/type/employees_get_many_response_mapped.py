...
from alexis_hr_python_sdk.type.employee_get_many_relations_response import EmployeeGetManyRelationsResponse
from alexis_hr_python_sdk.type.employee_response import EmployeeResponse

class RequiredEmployeesGetManyResponseMapped(TypedDict):
    # Status String
    status: str

    # Resource data
    data: typing.List[EmployeeResponse]
...
class OptionalEmployeesGetManyResponseMapped(TypedDict, total=False):
...
class EmployeesGetManyResponseMapped(RequiredEmployeesGetManyResponseMapped, OptionalEmployeesGetManyResponseMapped):
    pass
