...
class RequiredUpdateEmploymentTypeRequest(TypedDict):
    country: str

class OptionalUpdateEmploymentTypeRequest(TypedDict, total=False):
    name: str

    vacation: bool

    maxMonths: typing.Union[int, float]

class UpdateEmploymentTypeRequest(RequiredUpdateEmploymentTypeRequest, OptionalUpdateEmploymentTypeRequest):
    pass
