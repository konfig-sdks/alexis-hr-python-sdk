...
class RequiredCompensationResponseMapped(TypedDict):
    # Status String
    status: str
...
class OptionalCompensationResponseMapped(TypedDict, total=False):
    pass

class CompensationResponseMapped(RequiredCompensationResponseMapped, OptionalCompensationResponseMapped):
    pass
