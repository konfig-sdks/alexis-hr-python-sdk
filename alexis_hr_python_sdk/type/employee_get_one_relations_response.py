...
class RequiredEmployeeGetOneRelationsResponse(TypedDict):
    pass

class OptionalEmployeeGetOneRelationsResponse(TypedDict, total=False):
...
class EmployeeGetOneRelationsResponse(RequiredEmployeeGetOneRelationsResponse, OptionalEmployeeGetOneRelationsResponse):
    pass
