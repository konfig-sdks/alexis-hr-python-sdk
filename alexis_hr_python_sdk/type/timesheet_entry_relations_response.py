...
from alexis_hr_python_sdk.type.timesheet_entry_type_response import TimesheetEntryTypeResponse
from alexis_hr_python_sdk.type.timesheet_response import TimesheetResponse

class RequiredTimesheetEntryRelationsResponse(TypedDict):
    pass

class OptionalTimesheetEntryRelationsResponse(TypedDict, total=False):
    employee: typing.List[EmployeeResponse]

    timesheet: typing.List[TimesheetResponse]

    type: typing.List[TimesheetEntryTypeResponse]

class TimesheetEntryRelationsResponse(RequiredTimesheetEntryRelationsResponse, OptionalTimesheetEntryRelationsResponse):
    pass
