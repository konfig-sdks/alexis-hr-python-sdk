...
class RequiredTimesheetEntryResponse(TypedDict):
    id: str
...
class OptionalTimesheetEntryResponse(TypedDict, total=False):
    updated: datetime

    note: str

class TimesheetEntryResponse(RequiredTimesheetEntryResponse, OptionalTimesheetEntryResponse):
    pass
