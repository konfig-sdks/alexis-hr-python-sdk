...
class RequiredOfficeResponseMapped(TypedDict):
    # Status String
    status: str
...
class OptionalOfficeResponseMapped(TypedDict, total=False):
    pass

class OfficeResponseMapped(RequiredOfficeResponseMapped, OptionalOfficeResponseMapped):
    pass
