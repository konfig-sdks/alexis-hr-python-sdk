...
from alexis_hr_python_sdk.type.work_week_day_response import WorkWeekDayResponse

class RequiredWorkWeekResponse(TypedDict):
    id: str
...
class OptionalWorkWeekResponse(TypedDict, total=False):
    officeId: str
...
class WorkWeekResponse(RequiredWorkWeekResponse, OptionalWorkWeekResponse):
    pass
