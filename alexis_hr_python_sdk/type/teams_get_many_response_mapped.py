...
class RequiredTeamsGetManyResponseMapped(TypedDict):
    # Status String
    status: str

    # Resource data
    data: typing.List[TeamResponse]
...
class OptionalTeamsGetManyResponseMapped(TypedDict, total=False):
...
class TeamsGetManyResponseMapped(RequiredTeamsGetManyResponseMapped, OptionalTeamsGetManyResponseMapped):
    pass
