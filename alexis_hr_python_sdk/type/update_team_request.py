...
class RequiredUpdateTeamRequest(TypedDict):
    pass

class OptionalUpdateTeamRequest(TypedDict, total=False):
    description: str
...
class UpdateTeamRequest(RequiredUpdateTeamRequest, OptionalUpdateTeamRequest):
    pass
