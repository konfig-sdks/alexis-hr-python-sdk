...
from alexis_hr_python_sdk.type.leave_relations_response import LeaveRelationsResponse
from alexis_hr_python_sdk.type.leave_response import LeaveResponse

class RequiredLeavesGetManyResponseMapped(TypedDict):
    # Status String
    status: str

    # Resource data
    data: typing.List[LeaveResponse]
...
class OptionalLeavesGetManyResponseMapped(TypedDict, total=False):
...
class LeavesGetManyResponseMapped(RequiredLeavesGetManyResponseMapped, OptionalLeavesGetManyResponseMapped):
    pass
