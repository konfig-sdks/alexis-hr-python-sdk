...
from alexis_hr_python_sdk.type.work_shift_request import WorkShiftRequest

class RequiredWorkWeekDayRequest(TypedDict):
    working: bool

    duration: typing.Union[int, float]

    shifts: typing.List[WorkShiftRequest]

class OptionalWorkWeekDayRequest(TypedDict, total=False):
    pass

class WorkWeekDayRequest(RequiredWorkWeekDayRequest, OptionalWorkWeekDayRequest):
    pass
