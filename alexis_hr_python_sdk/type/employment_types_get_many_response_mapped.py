...
class RequiredEmploymentTypesGetManyResponseMapped(TypedDict):
    # Status String
    status: str

    # Resource data
    data: typing.List[EmploymentTypeResponse]
...
class OptionalEmploymentTypesGetManyResponseMapped(TypedDict, total=False):
...
class EmploymentTypesGetManyResponseMapped(RequiredEmploymentTypesGetManyResponseMapped, OptionalEmploymentTypesGetManyResponseMapped):
    pass
