...
class RequiredLeaveTypeResponseMapped(TypedDict):
    # Status String
    status: str
...
class OptionalLeaveTypeResponseMapped(TypedDict, total=False):
    pass

class LeaveTypeResponseMapped(RequiredLeaveTypeResponseMapped, OptionalLeaveTypeResponseMapped):
    pass
