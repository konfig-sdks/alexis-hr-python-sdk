...
class RequiredOfficeResponse(TypedDict):
    id: str
...
class OptionalOfficeResponse(TypedDict, total=False):
    pass

class OfficeResponse(RequiredOfficeResponse, OptionalOfficeResponse):
    pass
