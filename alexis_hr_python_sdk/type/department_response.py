...
class RequiredDepartmentResponse(TypedDict):
    id: str
...
class OptionalDepartmentResponse(TypedDict, total=False):
    description: str

    costCenterId: str

    effectiveCostCenterId: str

    parentId: str

class DepartmentResponse(RequiredDepartmentResponse, OptionalDepartmentResponse):
    pass
