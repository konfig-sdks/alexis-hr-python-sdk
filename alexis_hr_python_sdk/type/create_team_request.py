...
class RequiredCreateTeamRequest(TypedDict):
    name: str
...
class OptionalCreateTeamRequest(TypedDict, total=False):
    description: str

class CreateTeamRequest(RequiredCreateTeamRequest, OptionalCreateTeamRequest):
    pass
