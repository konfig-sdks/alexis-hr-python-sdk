...
from alexis_hr_python_sdk.type.employment_relations_response import EmploymentRelationsResponse
from alexis_hr_python_sdk.type.employment_response import EmploymentResponse

class RequiredEmploymentsGetManyResponseMapped(TypedDict):
    # Status String
    status: str

    # Resource data
    data: typing.List[EmploymentResponse]
...
class OptionalEmploymentsGetManyResponseMapped(TypedDict, total=False):
...
class EmploymentsGetManyResponseMapped(RequiredEmploymentsGetManyResponseMapped, OptionalEmploymentsGetManyResponseMapped):
    pass
