...
class RequiredCostCenterResponse(TypedDict):
    id: str
...
class OptionalCostCenterResponse(TypedDict, total=False):
    name: str

class CostCenterResponse(RequiredCostCenterResponse, OptionalCostCenterResponse):
    pass
