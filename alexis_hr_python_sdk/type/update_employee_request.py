...
class RequiredUpdateEmployeeRequest(TypedDict):
    pass

class OptionalUpdateEmployeeRequest(TypedDict, total=False):
    title: str
...
class UpdateEmployeeRequest(RequiredUpdateEmployeeRequest, OptionalUpdateEmployeeRequest):
    pass
