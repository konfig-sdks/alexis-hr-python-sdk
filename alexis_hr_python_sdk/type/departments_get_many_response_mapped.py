...
from alexis_hr_python_sdk.type.department_relations_response import DepartmentRelationsResponse
from alexis_hr_python_sdk.type.department_response import DepartmentResponse

class RequiredDepartmentsGetManyResponseMapped(TypedDict):
    # Status String
    status: str

    # Resource data
    data: typing.List[DepartmentResponse]
...
class OptionalDepartmentsGetManyResponseMapped(TypedDict, total=False):
...
class DepartmentsGetManyResponseMapped(RequiredDepartmentsGetManyResponseMapped, OptionalDepartmentsGetManyResponseMapped):
    pass
