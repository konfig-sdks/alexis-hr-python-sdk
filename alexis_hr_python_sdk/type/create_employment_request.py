...
class RequiredCreateEmploymentRequest(TypedDict):
    employeeId: str
...
class OptionalCreateEmploymentRequest(TypedDict, total=False):
    endDate: datetime
...
class CreateEmploymentRequest(RequiredCreateEmploymentRequest, OptionalCreateEmploymentRequest):
    pass
