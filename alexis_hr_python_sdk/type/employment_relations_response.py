...
class RequiredEmploymentRelationsResponse(TypedDict):
    pass

class OptionalEmploymentRelationsResponse(TypedDict, total=False):
    type: typing.List[EmploymentTypeResponse]

    employee: typing.List[EmployeeResponse]

class EmploymentRelationsResponse(RequiredEmploymentRelationsResponse, OptionalEmploymentRelationsResponse):
    pass
