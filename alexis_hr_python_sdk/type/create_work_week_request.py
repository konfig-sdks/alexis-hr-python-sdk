...
class RequiredCreateWorkWeekRequest(TypedDict):
...
class OptionalCreateWorkWeekRequest(TypedDict, total=False):
    employeeId: str
...
class CreateWorkWeekRequest(RequiredCreateWorkWeekRequest, OptionalCreateWorkWeekRequest):
    pass
