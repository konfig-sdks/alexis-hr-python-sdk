...
class RequiredCompensationsGetManyResponseMapped(TypedDict):
    # Status String
    status: str

    # Resource data
    data: typing.List[CompensationResponse]
...
class OptionalCompensationsGetManyResponseMapped(TypedDict, total=False):
...
class CompensationsGetManyResponseMapped(RequiredCompensationsGetManyResponseMapped, OptionalCompensationsGetManyResponseMapped):
    pass
