...
class RequiredWorkWeekResponseMapped(TypedDict):
    # Status String
    status: str
...
class OptionalWorkWeekResponseMapped(TypedDict, total=False):
    pass

class WorkWeekResponseMapped(RequiredWorkWeekResponseMapped, OptionalWorkWeekResponseMapped):
    pass
