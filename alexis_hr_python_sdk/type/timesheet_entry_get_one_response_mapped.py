...
class RequiredTimesheetEntryGetOneResponseMapped(TypedDict):
    # Status String
    status: str
...
class OptionalTimesheetEntryGetOneResponseMapped(TypedDict, total=False):
    # Resource relations
    relations: TimesheetEntryRelationsResponse

class TimesheetEntryGetOneResponseMapped(RequiredTimesheetEntryGetOneResponseMapped, OptionalTimesheetEntryGetOneResponseMapped):
    pass
