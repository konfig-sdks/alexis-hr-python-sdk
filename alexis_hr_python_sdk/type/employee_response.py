...
from alexis_hr_python_sdk.type.bank_account_response import BankAccountResponse
from alexis_hr_python_sdk.type.employee_tax_response import EmployeeTaxResponse
from alexis_hr_python_sdk.type.home_address_response import HomeAddressResponse

class RequiredEmployeeResponse(TypedDict):
    id: str
...
class OptionalEmployeeResponse(TypedDict, total=False):
    title: str
    ...
    employmentTypeId: str

    employmentCountry: str
    ...
    workPhoneSanitized: str

    hireDate: datetime

    endDate: datetime

    hasOccupationalPension: bool
    ...
    custom: typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]]

class EmployeeResponse(RequiredEmployeeResponse, OptionalEmployeeResponse):
    pass
