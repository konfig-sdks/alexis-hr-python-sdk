...
class RequiredUpdateLeaveTypeRequest(TypedDict):
    pass

class OptionalUpdateLeaveTypeRequest(TypedDict, total=False):
    name: str
...
class UpdateLeaveTypeRequest(RequiredUpdateLeaveTypeRequest, OptionalUpdateLeaveTypeRequest):
    pass
