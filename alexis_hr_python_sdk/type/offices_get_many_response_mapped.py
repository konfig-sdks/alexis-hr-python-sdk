...
class RequiredOfficesGetManyResponseMapped(TypedDict):
    # Status String
    status: str

    # Resource data
    data: typing.List[OfficeResponse]
...
class OptionalOfficesGetManyResponseMapped(TypedDict, total=False):
...
class OfficesGetManyResponseMapped(RequiredOfficesGetManyResponseMapped, OptionalOfficesGetManyResponseMapped):
    pass
