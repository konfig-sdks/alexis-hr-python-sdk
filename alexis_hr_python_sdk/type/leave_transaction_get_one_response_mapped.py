...
class RequiredLeaveTransactionGetOneResponseMapped(TypedDict):
    # Status String
    status: str
...
class OptionalLeaveTransactionGetOneResponseMapped(TypedDict, total=False):
    # Resource relations
    relations: LeaveTransactionRelationsResponse

class LeaveTransactionGetOneResponseMapped(RequiredLeaveTransactionGetOneResponseMapped, OptionalLeaveTransactionGetOneResponseMapped):
    pass
