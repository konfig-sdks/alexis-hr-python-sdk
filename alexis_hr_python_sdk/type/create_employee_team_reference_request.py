...
class RequiredCreateEmployeeTeamReferenceRequest(TypedDict):
    teamId: str
...
class OptionalCreateEmployeeTeamReferenceRequest(TypedDict, total=False):
    pass

class CreateEmployeeTeamReferenceRequest(RequiredCreateEmployeeTeamReferenceRequest, OptionalCreateEmployeeTeamReferenceRequest):
    pass
