...
from alexis_hr_python_sdk.type.leave_type_get_one_relation_response import LeaveTypeGetOneRelationResponse
from alexis_hr_python_sdk.type.leave_type_response import LeaveTypeResponse

class RequiredLeaveTypeGetOneResponseMapped(TypedDict):
    # Status String
    status: str
...
class OptionalLeaveTypeGetOneResponseMapped(TypedDict, total=False):
    # Resource relations
    relations: LeaveTypeGetOneRelationResponse

class LeaveTypeGetOneResponseMapped(RequiredLeaveTypeGetOneResponseMapped, OptionalLeaveTypeGetOneResponseMapped):
    pass
