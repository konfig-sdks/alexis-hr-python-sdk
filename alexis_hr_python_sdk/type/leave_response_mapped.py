...
class RequiredLeaveResponseMapped(TypedDict):
    # Status String
    status: str
...
class OptionalLeaveResponseMapped(TypedDict, total=False):
    pass

class LeaveResponseMapped(RequiredLeaveResponseMapped, OptionalLeaveResponseMapped):
    pass
