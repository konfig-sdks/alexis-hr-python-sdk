...
class RequiredEmploymentTypeResponse(TypedDict):
    id: str
...
class OptionalEmploymentTypeResponse(TypedDict, total=False):
    companyId: str
...
class EmploymentTypeResponse(RequiredEmploymentTypeResponse, OptionalEmploymentTypeResponse):
    pass
