...
class RequiredTimesheetEntryTypesGetManyResponseMapped(TypedDict):
    # Status String
    status: str

    # Resource data
    data: typing.List[TimesheetEntryTypeResponse]
...
class OptionalTimesheetEntryTypesGetManyResponseMapped(TypedDict, total=False):
    # Offset amount of received resources
    offset: typing.Union[int, float]

    relations: typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]]

class TimesheetEntryTypesGetManyResponseMapped(RequiredTimesheetEntryTypesGetManyResponseMapped, OptionalTimesheetEntryTypesGetManyResponseMapped):
    pass
