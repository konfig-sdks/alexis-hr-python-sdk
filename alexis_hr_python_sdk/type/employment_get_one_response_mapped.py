...
class RequiredEmploymentGetOneResponseMapped(TypedDict):
    # Status String
    status: str
...
class OptionalEmploymentGetOneResponseMapped(TypedDict, total=False):
    # Resource relations
    relations: EmploymentRelationsResponse

class EmploymentGetOneResponseMapped(RequiredEmploymentGetOneResponseMapped, OptionalEmploymentGetOneResponseMapped):
    pass
