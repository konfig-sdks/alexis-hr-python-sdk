...
class RequiredUpdateLeaveRequest(TypedDict):
    extent: typing.Union[int, float]

class OptionalUpdateLeaveRequest(TypedDict, total=False):
    description: str
...
class UpdateLeaveRequest(RequiredUpdateLeaveRequest, OptionalUpdateLeaveRequest):
    pass
