...
class RequiredTimesheetEntryResponseMapped(TypedDict):
    # Status String
    status: str
...
class OptionalTimesheetEntryResponseMapped(TypedDict, total=False):
    pass

class TimesheetEntryResponseMapped(RequiredTimesheetEntryResponseMapped, OptionalTimesheetEntryResponseMapped):
    pass
