...
class RequiredUpdateTimesheetEntryRequest(TypedDict):
    pass

class OptionalUpdateTimesheetEntryRequest(TypedDict, total=False):
    typeId: str
...
class UpdateTimesheetEntryRequest(RequiredUpdateTimesheetEntryRequest, OptionalUpdateTimesheetEntryRequest):
    pass
