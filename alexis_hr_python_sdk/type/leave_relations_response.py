...
class RequiredLeaveRelationsResponse(TypedDict):
    pass

class OptionalLeaveRelationsResponse(TypedDict, total=False):
    type: typing.List[LeaveTypeResponse]

    employee: typing.List[EmployeeResponse]

class LeaveRelationsResponse(RequiredLeaveRelationsResponse, OptionalLeaveRelationsResponse):
    pass
