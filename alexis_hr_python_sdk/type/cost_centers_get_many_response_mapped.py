...
class RequiredCostCentersGetManyResponseMapped(TypedDict):
    # Status String
    status: str

    # Resource data
    data: typing.List[CostCenterResponse]
...
class OptionalCostCentersGetManyResponseMapped(TypedDict, total=False):
...
class CostCentersGetManyResponseMapped(RequiredCostCentersGetManyResponseMapped, OptionalCostCentersGetManyResponseMapped):
    pass
