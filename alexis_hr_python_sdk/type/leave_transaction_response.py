...
from alexis_hr_python_sdk.type.leave_transaction_parent_response import LeaveTransactionParentResponse

class RequiredLeaveTransactionResponse(TypedDict):
    description: str
...
class OptionalLeaveTransactionResponse(TypedDict, total=False):
    pass

class LeaveTransactionResponse(RequiredLeaveTransactionResponse, OptionalLeaveTransactionResponse):
    pass
