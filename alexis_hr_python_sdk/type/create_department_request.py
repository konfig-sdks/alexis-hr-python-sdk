...
class RequiredCreateDepartmentRequest(TypedDict):
    name: str

class OptionalCreateDepartmentRequest(TypedDict, total=False):
    description: str
...
class CreateDepartmentRequest(RequiredCreateDepartmentRequest, OptionalCreateDepartmentRequest):
    pass
