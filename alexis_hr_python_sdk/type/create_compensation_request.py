...
class RequiredCreateCompensationRequest(TypedDict):
    employeeId: str
    ...
    payoutDay: typing.Union[int, float]
...
class OptionalCreateCompensationRequest(TypedDict, total=False):
    companyId: str
...
class CreateCompensationRequest(RequiredCreateCompensationRequest, OptionalCreateCompensationRequest):
    pass
