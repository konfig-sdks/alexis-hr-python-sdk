...
class RequiredUpdateEmploymentRequest(TypedDict):
    pass

class OptionalUpdateEmploymentRequest(TypedDict, total=False):
    employeeId: str
...
class UpdateEmploymentRequest(RequiredUpdateEmploymentRequest, OptionalUpdateEmploymentRequest):
    pass
