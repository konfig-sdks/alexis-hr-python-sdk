...
class RequiredCompensationGetOneResponseMapped(TypedDict):
    # Status String
    status: str
...
class OptionalCompensationGetOneResponseMapped(TypedDict, total=False):
    relations: typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]]

class CompensationGetOneResponseMapped(RequiredCompensationGetOneResponseMapped, OptionalCompensationGetOneResponseMapped):
    pass
