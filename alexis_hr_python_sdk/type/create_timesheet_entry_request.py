...
class RequiredCreateTimesheetEntryRequest(TypedDict):
    typeId: str
...
class OptionalCreateTimesheetEntryRequest(TypedDict, total=False):
    note: str

class CreateTimesheetEntryRequest(RequiredCreateTimesheetEntryRequest, OptionalCreateTimesheetEntryRequest):
    pass
