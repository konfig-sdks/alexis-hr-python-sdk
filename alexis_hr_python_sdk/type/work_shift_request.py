...
class RequiredWorkShiftRequest(TypedDict):
...
class OptionalWorkShiftRequest(TypedDict, total=False):
    pass

class WorkShiftRequest(RequiredWorkShiftRequest, OptionalWorkShiftRequest):
    pass
