...
class RequiredHomeAddressRequest(TypedDict):
    pass

class OptionalHomeAddressRequest(TypedDict, total=False):
    street: str
...
class HomeAddressRequest(RequiredHomeAddressRequest, OptionalHomeAddressRequest):
    pass
