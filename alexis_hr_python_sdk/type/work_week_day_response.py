...
from alexis_hr_python_sdk.type.work_shift_response import WorkShiftResponse

class RequiredWorkWeekDayResponse(TypedDict):
    working: bool

    duration: typing.Union[int, float]

    shifts: typing.List[WorkShiftResponse]

class OptionalWorkWeekDayResponse(TypedDict, total=False):
    pass

class WorkWeekDayResponse(RequiredWorkWeekDayResponse, OptionalWorkWeekDayResponse):
    pass
