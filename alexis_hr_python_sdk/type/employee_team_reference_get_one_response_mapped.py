...
class RequiredEmployeeTeamReferenceGetOneResponseMapped(TypedDict):
    # Status String
    status: str
...
class OptionalEmployeeTeamReferenceGetOneResponseMapped(TypedDict, total=False):
    # Resource relations
    relations: EmployeeTeamReferenceRelationsResponse

class EmployeeTeamReferenceGetOneResponseMapped(RequiredEmployeeTeamReferenceGetOneResponseMapped, OptionalEmployeeTeamReferenceGetOneResponseMapped):
    pass
