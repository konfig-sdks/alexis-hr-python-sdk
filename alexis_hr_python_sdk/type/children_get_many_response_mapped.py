...
class RequiredChildrenGetManyResponseMapped(TypedDict):
    # Status String
    status: str

    # Resource data
    data: typing.List[ChildResponse]
...
class OptionalChildrenGetManyResponseMapped(TypedDict, total=False):
...
class ChildrenGetManyResponseMapped(RequiredChildrenGetManyResponseMapped, OptionalChildrenGetManyResponseMapped):
    pass
