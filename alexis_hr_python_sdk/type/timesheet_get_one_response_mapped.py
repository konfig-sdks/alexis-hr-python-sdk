...
class RequiredTimesheetGetOneResponseMapped(TypedDict):
    # Status String
    status: str
...
class OptionalTimesheetGetOneResponseMapped(TypedDict, total=False):
    # Resource relations
    relations: TimesheetRelationsResponse

class TimesheetGetOneResponseMapped(RequiredTimesheetGetOneResponseMapped, OptionalTimesheetGetOneResponseMapped):
    pass
