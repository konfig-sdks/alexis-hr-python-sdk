...
from alexis_hr_python_sdk.type.employee_get_one_relations_response import EmployeeGetOneRelationsResponse
from alexis_hr_python_sdk.type.employee_response import EmployeeResponse

class RequiredEmployeeGetOneResponseMapped(TypedDict):
    # Status String
    status: str
...
class OptionalEmployeeGetOneResponseMapped(TypedDict, total=False):
    # Resource relations
    relations: EmployeeGetOneRelationsResponse

class EmployeeGetOneResponseMapped(RequiredEmployeeGetOneResponseMapped, OptionalEmployeeGetOneResponseMapped):
    pass
