...
from alexis_hr_python_sdk.type.timesheet_entry_relations_response import TimesheetEntryRelationsResponse
from alexis_hr_python_sdk.type.timesheet_entry_response import TimesheetEntryResponse

class RequiredTimesheetEntriesGetManyResponseMapped(TypedDict):
    # Status String
    status: str

    # Resource data
    data: typing.List[TimesheetEntryResponse]
...
class OptionalTimesheetEntriesGetManyResponseMapped(TypedDict, total=False):
...
class TimesheetEntriesGetManyResponseMapped(RequiredTimesheetEntriesGetManyResponseMapped, OptionalTimesheetEntriesGetManyResponseMapped):
    pass
