...
class RequiredDepartmentResponseMapped(TypedDict):
    # Status String
    status: str
...
class OptionalDepartmentResponseMapped(TypedDict, total=False):
    pass

class DepartmentResponseMapped(RequiredDepartmentResponseMapped, OptionalDepartmentResponseMapped):
    pass
