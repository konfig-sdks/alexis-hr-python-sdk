...
class RequiredUpdateDepartmentRequest(TypedDict):
    name: str

class OptionalUpdateDepartmentRequest(TypedDict, total=False):
    description: str
...
class UpdateDepartmentRequest(RequiredUpdateDepartmentRequest, OptionalUpdateDepartmentRequest):
    pass
