...
from alexis_hr_python_sdk.type.leave_type_response import LeaveTypeResponse

class RequiredLeaveTransactionRelationsResponse(TypedDict):
    pass

class OptionalLeaveTransactionRelationsResponse(TypedDict, total=False):
    child: typing.List[ChildResponse]

    leaveType: typing.List[LeaveTypeResponse]

    employee: typing.List[EmployeeResponse]

class LeaveTransactionRelationsResponse(RequiredLeaveTransactionRelationsResponse, OptionalLeaveTransactionRelationsResponse):
    pass
