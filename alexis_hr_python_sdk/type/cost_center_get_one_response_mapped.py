...
class RequiredCostCenterGetOneResponseMapped(TypedDict):
    # Status String
    status: str
...
class OptionalCostCenterGetOneResponseMapped(TypedDict, total=False):
    relations: typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]]

class CostCenterGetOneResponseMapped(RequiredCostCenterGetOneResponseMapped, OptionalCostCenterGetOneResponseMapped):
    pass
