...
class RequiredWorkShiftResponse(TypedDict):
    startHour: typing.Union[int, float]

    startMinute: typing.Union[int, float]

    endHour: typing.Union[int, float]

    endMinute: typing.Union[int, float]

    duration: typing.Union[int, float]

class OptionalWorkShiftResponse(TypedDict, total=False):
    pass

class WorkShiftResponse(RequiredWorkShiftResponse, OptionalWorkShiftResponse):
    pass
