...
class RequiredCostCenterResponseMapped(TypedDict):
    # Status String
    status: str
...
class OptionalCostCenterResponseMapped(TypedDict, total=False):
    pass

class CostCenterResponseMapped(RequiredCostCenterResponseMapped, OptionalCostCenterResponseMapped):
    pass
