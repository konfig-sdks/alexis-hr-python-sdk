...
from alexis_hr_python_sdk.type.leave_transaction_relations_response import LeaveTransactionRelationsResponse
from alexis_hr_python_sdk.type.leave_transaction_response import LeaveTransactionResponse

class RequiredLeaveTransactionsGetManyResponseMapped(TypedDict):
    # Status String
    status: str

    # Resource data
    data: typing.List[LeaveTransactionResponse]
...
class OptionalLeaveTransactionsGetManyResponseMapped(TypedDict, total=False):
...
class LeaveTransactionsGetManyResponseMapped(RequiredLeaveTransactionsGetManyResponseMapped, OptionalLeaveTransactionsGetManyResponseMapped):
    pass
