...
class RequiredCompanyGetOneResponseMapped(TypedDict):
    # Status String
    status: str
...
class OptionalCompanyGetOneResponseMapped(TypedDict, total=False):
    relations: typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]]

class CompanyGetOneResponseMapped(RequiredCompanyGetOneResponseMapped, OptionalCompanyGetOneResponseMapped):
    pass
