...
class RequiredDepartmentGetOneResponseMapped(TypedDict):
    # Status String
    status: str
...
class OptionalDepartmentGetOneResponseMapped(TypedDict, total=False):
    # Resource relations
    relations: DepartmentRelationsResponse

class DepartmentGetOneResponseMapped(RequiredDepartmentGetOneResponseMapped, OptionalDepartmentGetOneResponseMapped):
    pass
