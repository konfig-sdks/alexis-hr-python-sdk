...
from alexis_hr_python_sdk.type.employee_team_reference_relations_response import EmployeeTeamReferenceRelationsResponse
from alexis_hr_python_sdk.type.employee_team_reference_response import EmployeeTeamReferenceResponse

class RequiredEmployeeTeamReferencesGetManyResponseMapped(TypedDict):
    # Status String
    status: str

    # Resource data
    data: typing.List[EmployeeTeamReferenceResponse]
...
class OptionalEmployeeTeamReferencesGetManyResponseMapped(TypedDict, total=False):
...
class EmployeeTeamReferencesGetManyResponseMapped(RequiredEmployeeTeamReferencesGetManyResponseMapped, OptionalEmployeeTeamReferencesGetManyResponseMapped):
    pass
