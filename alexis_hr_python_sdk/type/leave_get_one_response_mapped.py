...
class RequiredLeaveGetOneResponseMapped(TypedDict):
    # Status String
    status: str
...
class OptionalLeaveGetOneResponseMapped(TypedDict, total=False):
    # Resource relations
    relations: LeaveRelationsResponse

class LeaveGetOneResponseMapped(RequiredLeaveGetOneResponseMapped, OptionalLeaveGetOneResponseMapped):
    pass
