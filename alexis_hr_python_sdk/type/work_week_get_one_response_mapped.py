...
class RequiredWorkWeekGetOneResponseMapped(TypedDict):
    # Status String
    status: str
...
class OptionalWorkWeekGetOneResponseMapped(TypedDict, total=False):
    # Resource relations
    relations: WorkWeekRelationsResponse

class WorkWeekGetOneResponseMapped(RequiredWorkWeekGetOneResponseMapped, OptionalWorkWeekGetOneResponseMapped):
    pass
