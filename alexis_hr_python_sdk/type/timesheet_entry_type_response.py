...
class RequiredTimesheetEntryTypeResponse(TypedDict):
    id: str

    name: str

class OptionalTimesheetEntryTypeResponse(TypedDict, total=False):
    kind: str

class TimesheetEntryTypeResponse(RequiredTimesheetEntryTypeResponse, OptionalTimesheetEntryTypeResponse):
    pass
