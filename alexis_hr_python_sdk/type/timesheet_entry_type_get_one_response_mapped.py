...
class RequiredTimesheetEntryTypeGetOneResponseMapped(TypedDict):
    # Status String
    status: str
...
class OptionalTimesheetEntryTypeGetOneResponseMapped(TypedDict, total=False):
    relations: typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]]

class TimesheetEntryTypeGetOneResponseMapped(RequiredTimesheetEntryTypeGetOneResponseMapped, OptionalTimesheetEntryTypeGetOneResponseMapped):
    pass
