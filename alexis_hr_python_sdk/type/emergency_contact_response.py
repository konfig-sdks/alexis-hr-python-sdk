...
class RequiredEmergencyContactResponse(TypedDict):
    id: str
...
class OptionalEmergencyContactResponse(TypedDict, total=False):
    pass

class EmergencyContactResponse(RequiredEmergencyContactResponse, OptionalEmergencyContactResponse):
    pass
