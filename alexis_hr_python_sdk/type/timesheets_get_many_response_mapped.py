...
from alexis_hr_python_sdk.type.timesheet_relations_response import TimesheetRelationsResponse
from alexis_hr_python_sdk.type.timesheet_response import TimesheetResponse

class RequiredTimesheetsGetManyResponseMapped(TypedDict):
    # Status String
    status: str

    # Resource data
    data: typing.List[TimesheetResponse]
...
class OptionalTimesheetsGetManyResponseMapped(TypedDict, total=False):
...
class TimesheetsGetManyResponseMapped(RequiredTimesheetsGetManyResponseMapped, OptionalTimesheetsGetManyResponseMapped):
    pass
