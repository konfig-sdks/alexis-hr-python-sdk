...
class RequiredChildResponseMapped(TypedDict):
    # Status String
    status: str
...
class OptionalChildResponseMapped(TypedDict, total=False):
    pass

class ChildResponseMapped(RequiredChildResponseMapped, OptionalChildResponseMapped):
    pass
