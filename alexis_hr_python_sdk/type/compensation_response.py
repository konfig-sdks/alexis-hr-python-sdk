...
class RequiredCompensationResponse(TypedDict):
    id: str
...
class OptionalCompensationResponse(TypedDict, total=False):
    note: str

class CompensationResponse(RequiredCompensationResponse, OptionalCompensationResponse):
    pass
