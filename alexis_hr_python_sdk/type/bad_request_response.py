...
class RequiredBadRequestResponse(TypedDict):
    statusCode: typing.Union[int, float]

class OptionalBadRequestResponse(TypedDict, total=False):
    message: typing.Union[typing.List[str], str]

    error: str

class BadRequestResponse(RequiredBadRequestResponse, OptionalBadRequestResponse):
    pass
