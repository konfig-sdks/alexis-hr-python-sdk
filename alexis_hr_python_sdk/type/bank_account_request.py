...
class RequiredBankAccountRequest(TypedDict):
    pass

class OptionalBankAccountRequest(TypedDict, total=False):
    bank: str
...
class BankAccountRequest(RequiredBankAccountRequest, OptionalBankAccountRequest):
    pass
