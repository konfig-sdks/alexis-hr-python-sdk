...
class RequiredTeamResponseMapped(TypedDict):
    # Status String
    status: str
...
class OptionalTeamResponseMapped(TypedDict, total=False):
    pass

class TeamResponseMapped(RequiredTeamResponseMapped, OptionalTeamResponseMapped):
    pass
