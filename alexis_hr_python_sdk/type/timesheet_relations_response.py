...
class RequiredTimesheetRelationsResponse(TypedDict):
    pass

class OptionalTimesheetRelationsResponse(TypedDict, total=False):
    approverEmployee: typing.List[EmployeeResponse]

    employee: typing.List[EmployeeResponse]

class TimesheetRelationsResponse(RequiredTimesheetRelationsResponse, OptionalTimesheetRelationsResponse):
    pass
