...
class RequiredLeaveTypeCodeResponse(TypedDict):
    id: str
...
class OptionalLeaveTypeCodeResponse(TypedDict, total=False):
    pass

class LeaveTypeCodeResponse(RequiredLeaveTypeCodeResponse, OptionalLeaveTypeCodeResponse):
    pass
