...
class RequiredUpdateOfficeRequest(TypedDict):
    pass

class OptionalUpdateOfficeRequest(TypedDict, total=False):
    name: str
...
class UpdateOfficeRequest(RequiredUpdateOfficeRequest, OptionalUpdateOfficeRequest):
    pass
