...
class RequiredTeamGetOneResponseMapped(TypedDict):
    # Status String
    status: str
...
class OptionalTeamGetOneResponseMapped(TypedDict, total=False):
    relations: typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]]

class TeamGetOneResponseMapped(RequiredTeamGetOneResponseMapped, OptionalTeamGetOneResponseMapped):
    pass
