...
class RequiredInternalServerErrorResponse(TypedDict):
    statusCode: typing.Union[int, float]

class OptionalInternalServerErrorResponse(TypedDict, total=False):
    message: str

    error: str

class InternalServerErrorResponse(RequiredInternalServerErrorResponse, OptionalInternalServerErrorResponse):
    pass
