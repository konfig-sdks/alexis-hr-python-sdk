...
class RequiredLeaveTransactionParentResponse(TypedDict):
    id: str

    type: str

class OptionalLeaveTransactionParentResponse(TypedDict, total=False):
    pass

class LeaveTransactionParentResponse(RequiredLeaveTransactionParentResponse, OptionalLeaveTransactionParentResponse):
    pass
