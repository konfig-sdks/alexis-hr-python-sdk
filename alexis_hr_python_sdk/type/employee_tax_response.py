...
class RequiredEmployeeTaxResponse(TypedDict):
    pass

class OptionalEmployeeTaxResponse(TypedDict, total=False):
    table: typing.Union[int, float]

    column: typing.Union[int, float]

class EmployeeTaxResponse(RequiredEmployeeTaxResponse, OptionalEmployeeTaxResponse):
    pass
