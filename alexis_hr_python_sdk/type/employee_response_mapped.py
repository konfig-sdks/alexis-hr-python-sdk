...
class RequiredEmployeeResponseMapped(TypedDict):
    # Status String
    status: str
...
class OptionalEmployeeResponseMapped(TypedDict, total=False):
    pass

class EmployeeResponseMapped(RequiredEmployeeResponseMapped, OptionalEmployeeResponseMapped):
    pass
