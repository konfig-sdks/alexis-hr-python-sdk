...
class RequiredUpdateChildRequest(TypedDict):
    name: str

    birthdate: datetime

class OptionalUpdateChildRequest(TypedDict, total=False):
    pass

class UpdateChildRequest(RequiredUpdateChildRequest, OptionalUpdateChildRequest):
    pass
