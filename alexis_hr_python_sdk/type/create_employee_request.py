...
class RequiredCreateEmployeeRequest(TypedDict):
    pass

class OptionalCreateEmployeeRequest(TypedDict, total=False):
    title: str
...
class CreateEmployeeRequest(RequiredCreateEmployeeRequest, OptionalCreateEmployeeRequest):
    pass
