...
class RequiredCreateChildRequest(TypedDict):
    employeeId: str
...
class OptionalCreateChildRequest(TypedDict, total=False):
    pass

class CreateChildRequest(RequiredCreateChildRequest, OptionalCreateChildRequest):
    pass
