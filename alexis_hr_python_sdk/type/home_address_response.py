...
from alexis_hr_python_sdk.type.point_response import PointResponse

class RequiredHomeAddressResponse(TypedDict):
    pass

class OptionalHomeAddressResponse(TypedDict, total=False):
    street: str
...
class HomeAddressResponse(RequiredHomeAddressResponse, OptionalHomeAddressResponse):
    pass
