...
from alexis_hr_python_sdk.type.leave_type_get_many_relations_response import LeaveTypeGetManyRelationsResponse
from alexis_hr_python_sdk.type.leave_type_response import LeaveTypeResponse

class RequiredLeaveTypesGetManyResponseMapped(TypedDict):
    # Status String
    status: str

    # Resource data
    data: typing.List[LeaveTypeResponse]
...
class OptionalLeaveTypesGetManyResponseMapped(TypedDict, total=False):
...
class LeaveTypesGetManyResponseMapped(RequiredLeaveTypesGetManyResponseMapped, OptionalLeaveTypesGetManyResponseMapped):
    pass
