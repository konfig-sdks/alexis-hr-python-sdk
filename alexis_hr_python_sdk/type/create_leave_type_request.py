...
class RequiredCreateLeaveTypeRequest(TypedDict):
    name: str

class OptionalCreateLeaveTypeRequest(TypedDict, total=False):
    kind: str
...
class CreateLeaveTypeRequest(RequiredCreateLeaveTypeRequest, OptionalCreateLeaveTypeRequest):
    pass
