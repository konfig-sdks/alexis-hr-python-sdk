...
class RequiredEmploymentResponseMapped(TypedDict):
    # Status String
    status: str
...
class OptionalEmploymentResponseMapped(TypedDict, total=False):
    pass

class EmploymentResponseMapped(RequiredEmploymentResponseMapped, OptionalEmploymentResponseMapped):
    pass
