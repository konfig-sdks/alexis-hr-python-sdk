...
class RequiredUpdateCostCenterRequest(TypedDict):
    pass

class OptionalUpdateCostCenterRequest(TypedDict, total=False):
    code: str

    name: str

class UpdateCostCenterRequest(RequiredUpdateCostCenterRequest, OptionalUpdateCostCenterRequest):
    pass
