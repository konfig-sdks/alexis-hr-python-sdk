...
class RequiredEmploymentTypeGetOneResponseMapped(TypedDict):
    # Status String
    status: str
...
class OptionalEmploymentTypeGetOneResponseMapped(TypedDict, total=False):
    relations: typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]]

class EmploymentTypeGetOneResponseMapped(RequiredEmploymentTypeGetOneResponseMapped, OptionalEmploymentTypeGetOneResponseMapped):
    pass
