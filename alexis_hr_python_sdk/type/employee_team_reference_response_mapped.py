...
class RequiredEmployeeTeamReferenceResponseMapped(TypedDict):
    # Status String
    status: str
...
class OptionalEmployeeTeamReferenceResponseMapped(TypedDict, total=False):
    pass

class EmployeeTeamReferenceResponseMapped(RequiredEmployeeTeamReferenceResponseMapped, OptionalEmployeeTeamReferenceResponseMapped):
    pass
