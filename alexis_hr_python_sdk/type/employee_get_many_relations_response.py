...
from alexis_hr_python_sdk.type.child_response import ChildResponse
from alexis_hr_python_sdk.type.compensation_response import CompensationResponse
from alexis_hr_python_sdk.type.cost_center_response import CostCenterResponse
from alexis_hr_python_sdk.type.department_response import DepartmentResponse
from alexis_hr_python_sdk.type.emergency_contact_response import EmergencyContactResponse
from alexis_hr_python_sdk.type.employee_response import EmployeeResponse
from alexis_hr_python_sdk.type.employee_team_reference_response import EmployeeTeamReferenceResponse
from alexis_hr_python_sdk.type.employment_response import EmploymentResponse
from alexis_hr_python_sdk.type.employment_type_response import EmploymentTypeResponse
from alexis_hr_python_sdk.type.office_response import OfficeResponse

class RequiredEmployeeGetManyRelationsResponse(TypedDict):
    pass

class OptionalEmployeeGetManyRelationsResponse(TypedDict, total=False):
    office: typing.List[OfficeResponse]

    costCenter: typing.List[CostCenterResponse]

    effectiveCostCenter: typing.List[CostCenterResponse]

    child: typing.List[ChildResponse]

    department: typing.List[DepartmentResponse]

    emergencyContact: typing.List[EmergencyContactResponse]

    employment: typing.List[EmploymentResponse]

    employmentType: typing.List[EmploymentTypeResponse]

    compensation: typing.List[CompensationResponse]

    managerEmployee: typing.List[EmployeeResponse]

    teamReference: typing.List[EmployeeTeamReferenceResponse]

class EmployeeGetManyRelationsResponse(RequiredEmployeeGetManyRelationsResponse, OptionalEmployeeGetManyRelationsResponse):
    pass
