...
class RequiredCreateOfficeRequest(TypedDict):
    name: str
...
class OptionalCreateOfficeRequest(TypedDict, total=False):
    pass

class CreateOfficeRequest(RequiredCreateOfficeRequest, OptionalCreateOfficeRequest):
    pass
