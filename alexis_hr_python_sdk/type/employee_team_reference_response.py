...
class RequiredEmployeeTeamReferenceResponse(TypedDict):
    id: str
...
class OptionalEmployeeTeamReferenceResponse(TypedDict, total=False):
    pass

class EmployeeTeamReferenceResponse(RequiredEmployeeTeamReferenceResponse, OptionalEmployeeTeamReferenceResponse):
    pass
