...
class RequiredCreateLeaveRequest(TypedDict):
    employeeId: str
...
class OptionalCreateLeaveRequest(TypedDict, total=False):
    description: str
    ...
    morning: typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]]

    afternoon: typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]]

class CreateLeaveRequest(RequiredCreateLeaveRequest, OptionalCreateLeaveRequest):
    pass
