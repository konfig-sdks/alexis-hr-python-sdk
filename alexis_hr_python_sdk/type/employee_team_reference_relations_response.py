...
from alexis_hr_python_sdk.type.employee_team_reference_relations_response_employee import EmployeeTeamReferenceRelationsResponseEmployee
from alexis_hr_python_sdk.type.team_response import TeamResponse
from alexis_hr_python_sdk.type.user_response import UserResponse

class RequiredEmployeeTeamReferenceRelationsResponse(TypedDict):
    pass

class OptionalEmployeeTeamReferenceRelationsResponse(TypedDict, total=False):
    employee: EmployeeTeamReferenceRelationsResponseEmployee

    team: typing.List[TeamResponse]

    user: typing.List[UserResponse]

class EmployeeTeamReferenceRelationsResponse(RequiredEmployeeTeamReferenceRelationsResponse, OptionalEmployeeTeamReferenceRelationsResponse):
    pass
