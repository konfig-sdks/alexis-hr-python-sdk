...
class RequiredDepartmentRelationsResponse(TypedDict):
    pass

class OptionalDepartmentRelationsResponse(TypedDict, total=False):
    costCenter: typing.List[CostCenterResponse]

    effectiveCostCenter: typing.List[CostCenterResponse]

class DepartmentRelationsResponse(RequiredDepartmentRelationsResponse, OptionalDepartmentRelationsResponse):
    pass
