...
class RequiredCreateEmploymentTypeRequest(TypedDict):
    name: str
...
class OptionalCreateEmploymentTypeRequest(TypedDict, total=False):
    maxMonths: typing.Union[int, float]

class CreateEmploymentTypeRequest(RequiredCreateEmploymentTypeRequest, OptionalCreateEmploymentTypeRequest):
    pass
