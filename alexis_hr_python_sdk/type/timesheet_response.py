...
class RequiredTimesheetResponse(TypedDict):
    id: str
    ...
    localCutOffDate: datetime

    utcCutOffDate: datetime

    approvalDeadlineDate: datetime

    interval: str

    approverEmployeeId: str
...
class OptionalTimesheetResponse(TypedDict, total=False):
    note: str

    updated: datetime

class TimesheetResponse(RequiredTimesheetResponse, OptionalTimesheetResponse):
    pass
