...
class RequiredEmploymentTypeResponseMapped(TypedDict):
    # Status String
    status: str
...
class OptionalEmploymentTypeResponseMapped(TypedDict, total=False):
    pass

class EmploymentTypeResponseMapped(RequiredEmploymentTypeResponseMapped, OptionalEmploymentTypeResponseMapped):
    pass
