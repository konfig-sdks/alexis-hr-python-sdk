...
class RequiredWorkWeekRelationsResponse(TypedDict):
    pass

class OptionalWorkWeekRelationsResponse(TypedDict, total=False):
    office: typing.List[OfficeResponse]

    employee: typing.List[EmployeeResponse]

class WorkWeekRelationsResponse(RequiredWorkWeekRelationsResponse, OptionalWorkWeekRelationsResponse):
    pass
