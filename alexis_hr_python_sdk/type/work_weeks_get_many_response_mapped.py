...
from alexis_hr_python_sdk.type.work_week_relations_response import WorkWeekRelationsResponse
from alexis_hr_python_sdk.type.work_week_response import WorkWeekResponse

class RequiredWorkWeeksGetManyResponseMapped(TypedDict):
    # Status String
    status: str

    # Resource data
    data: typing.List[WorkWeekResponse]
...
class OptionalWorkWeeksGetManyResponseMapped(TypedDict, total=False):
...
class WorkWeeksGetManyResponseMapped(RequiredWorkWeeksGetManyResponseMapped, OptionalWorkWeeksGetManyResponseMapped):
    pass
