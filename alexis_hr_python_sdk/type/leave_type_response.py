...
class RequiredLeaveTypeResponse(TypedDict):
    id: str
...
class OptionalLeaveTypeResponse(TypedDict, total=False):
    archived: typing.Optional[bool]

class LeaveTypeResponse(RequiredLeaveTypeResponse, OptionalLeaveTypeResponse):
    pass
