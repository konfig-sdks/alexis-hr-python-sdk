...
from alexis_hr_python_sdk.type.company_response import CompanyResponse

class RequiredCompaniesGetManyResponseMapped(TypedDict):
    # Status String
    status: str
...
class OptionalCompaniesGetManyResponseMapped(TypedDict, total=False):
...
class CompaniesGetManyResponseMapped(RequiredCompaniesGetManyResponseMapped, OptionalCompaniesGetManyResponseMapped):
    pass
