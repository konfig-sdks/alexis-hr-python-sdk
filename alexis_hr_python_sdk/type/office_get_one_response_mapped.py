...
class RequiredOfficeGetOneResponseMapped(TypedDict):
    # Status String
    status: str
...
class OptionalOfficeGetOneResponseMapped(TypedDict, total=False):
    relations: typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]]

class OfficeGetOneResponseMapped(RequiredOfficeGetOneResponseMapped, OptionalOfficeGetOneResponseMapped):
    pass
