...
from alexis_hr_python_sdk.model.update_compensation_request import UpdateCompensationRequest as UpdateCompensationRequestSchema
...
from alexis_hr_python_sdk.type.update_compensation_request import UpdateCompensationRequest
...
from alexis_hr_python_sdk.pydantic.update_compensation_request import UpdateCompensationRequest as UpdateCompensationRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = UpdateCompensationRequestSchema


request_body_update_compensation_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = CompensationResponseMappedSchema
...
class BaseApi(api_client.Api):
    ...
    def _replace_one_compensation_mapped_args(
        self,
        id: str,
        ...
        payout_day: typing.Optional[typing.Union[int, float]] = None,
        payout_period: typing.Optional[str] = None,
        payout_frequency: typing.Optional[str] = None,
        salary_schedule: typing.Optional[str] = None,
        paid_overtime: typing.Optional[bool] = None,
    ...
    async def _areplace_one_compensation_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/compensation/{id}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_update_compensation_request.serialize(body, content_type)
    ...
    def _replace_one_compensation_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class ReplaceOneCompensationRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def areplace_one_compensation(
        self,
        id: str,
        employee_id: typing.Optional[str] = None,
        user_id: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._replace_one_compensation_mapped_args(
            id=id,
        ...
        return await self._areplace_one_compensation_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def replace_one_compensation(
        self,
        id: str,
        employee_id: typing.Optional[str] = None,
        user_id: typing.Optional[str] = None,
        ...
        return self._replace_one_compensation_oapg(
            body=args.body,
            path_params=args.path,
        )

class ReplaceOneCompensation(BaseApi):
    ...
    async def areplace_one_compensation(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.areplace_one_compensation(
            id=id,
            employee_id=employee_id,
            user_id=user_id,
            amount=amount,
    ...
    def replace_one_compensation(
        ...
        raw_response = self.raw.replace_one_compensation(
            id=id,
            employee_id=employee_id,
            user_id=user_id,
            amount=amount,
