...
from alexis_hr_python_sdk.model.compensation_get_one_response_mapped import CompensationGetOneResponseMapped as CompensationGetOneResponseMappedSchema
...
from alexis_hr_python_sdk.type.compensation_get_one_response_mapped import CompensationGetOneResponseMapped
...
from alexis_hr_python_sdk.pydantic.compensation_get_one_response_mapped import CompensationGetOneResponseMapped as CompensationGetOneResponseMappedPydantic
...
SchemaFor200ResponseBodyApplicationJson = CompensationGetOneResponseMappedSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: CompensationGetOneResponseMapped
...
class GetOne(BaseApi):
    ...
    async def aget_one(
        ...
        validate: bool = False,
        **kwargs,
    ) -> CompensationGetOneResponseMappedPydantic:
        ...
        if validate:
            return CompensationGetOneResponseMappedPydantic(**raw_response.body)
        return api_client.construct_model_instance(CompensationGetOneResponseMappedPydantic, raw_response.body)
