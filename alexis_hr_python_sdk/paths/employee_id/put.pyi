...
from alexis_hr_python_sdk.model.home_address_request import HomeAddressRequest as HomeAddressRequestSchema
from alexis_hr_python_sdk.model.unauthorized_response import UnauthorizedResponse as UnauthorizedResponseSchema
from alexis_hr_python_sdk.model.employee_response_mapped import EmployeeResponseMapped as EmployeeResponseMappedSchema
from alexis_hr_python_sdk.model.update_employee_request import UpdateEmployeeRequest as UpdateEmployeeRequestSchema
from alexis_hr_python_sdk.model.employee_tax_request import EmployeeTaxRequest as EmployeeTaxRequestSchema
...
from alexis_hr_python_sdk.model.bank_account_request import BankAccountRequest as BankAccountRequestSchema

from alexis_hr_python_sdk.type.home_address_request import HomeAddressRequest
...
from alexis_hr_python_sdk.type.employee_response_mapped import EmployeeResponseMapped
...
from alexis_hr_python_sdk.type.update_employee_request import UpdateEmployeeRequest
from alexis_hr_python_sdk.type.employee_tax_request import EmployeeTaxRequest
from alexis_hr_python_sdk.type.bank_account_request import BankAccountRequest
...
from alexis_hr_python_sdk.pydantic.bank_account_request import BankAccountRequest as BankAccountRequestPydantic
...
from alexis_hr_python_sdk.pydantic.home_address_request import HomeAddressRequest as HomeAddressRequestPydantic
from alexis_hr_python_sdk.pydantic.employee_response_mapped import EmployeeResponseMapped as EmployeeResponseMappedPydantic
from alexis_hr_python_sdk.pydantic.employee_tax_request import EmployeeTaxRequest as EmployeeTaxRequestPydantic
from alexis_hr_python_sdk.pydantic.update_employee_request import UpdateEmployeeRequest as UpdateEmployeeRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = UpdateEmployeeRequestSchema


request_body_update_employee_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = EmployeeResponseMappedSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: EmployeeResponseMapped
...
class BaseApi(api_client.Api):
    ...
    def _replace_one_employee_mapped_args(
        self,
        id: str,
        title: typing.Optional[str] = None,
        office_id: typing.Optional[str] = None,
        manager_employee_id: typing.Optional[str] = None,
        ...
        tax: typing.Optional[EmployeeTaxRequest] = None,
        work_email: typing.Optional[str] = None,
        work_phone: typing.Optional[str] = None,
        has_occupational_pension: typing.Optional[bool] = None,
        private_email: typing.Optional[str] = None,
        first_name: typing.Optional[str] = None,
        last_name: typing.Optional[str] = None,
        ssn: typing.Optional[str] = None,
        private_phone: typing.Optional[str] = None,
        birth_date: typing.Optional[str] = None,
        avatar_url: typing.Optional[str] = None,
        nationality: typing.Optional[str] = None,
        gender: typing.Optional[str] = None,
        pronoun: typing.Optional[str] = None,
        bank_account: typing.Optional[BankAccountRequest] = None,
        home_address: typing.Optional[HomeAddressRequest] = None,
        custom: typing.Optional[typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]]] = None,
        ...
        if manager_employee_id is not None:
            _body["managerEmployeeId"] = manager_employee_id
        ...
        if has_occupational_pension is not None:
            _body["hasOccupationalPension"] = has_occupational_pension
        if private_email is not None:
            _body["privateEmail"] = private_email
        ...
        if ssn is not None:
            _body["ssn"] = ssn
        if private_phone is not None:
            _body["privatePhone"] = private_phone
        if birth_date is not None:
            _body["birthDate"] = birth_date
        if avatar_url is not None:
            _body["avatarUrl"] = avatar_url
        if nationality is not None:
            _body["nationality"] = nationality
        if gender is not None:
            _body["gender"] = gender
        if pronoun is not None:
            _body["pronoun"] = pronoun
    ...
    async def _areplace_one_employee_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/employee/{id}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_update_employee_request.serialize(body, content_type)
    ...
    def _replace_one_employee_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class ReplaceOneEmployeeRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def areplace_one_employee(
        self,
        id: str,
        title: typing.Optional[str] = None,
        office_id: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._replace_one_employee_mapped_args(
            id=id,
            title=title,
            office_id=office_id,
            ...
            has_occupational_pension=has_occupational_pension,
        ...
        return await self._areplace_one_employee_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def replace_one_employee(
        self,
        id: str,
        title: typing.Optional[str] = None,
        office_id: typing.Optional[str] = None,
        ...
        return self._replace_one_employee_oapg(
            body=args.body,
            path_params=args.path,
        )

class ReplaceOneEmployee(BaseApi):
    ...
    async def areplace_one_employee(
        ...
        validate: bool = False,
        **kwargs,
    ) -> EmployeeResponseMappedPydantic:
        raw_response = await self.raw.areplace_one_employee(
            id=id,
            title=title,
            office_id=office_id,
            manager_employee_id=manager_employee_id,
        ...
        if validate:
            return EmployeeResponseMappedPydantic(**raw_response.body)
        return api_client.construct_model_instance(EmployeeResponseMappedPydantic, raw_response.body)
    ...
    def replace_one_employee(
        ...
        raw_response = self.raw.replace_one_employee(
            id=id,
            title=title,
            office_id=office_id,
            manager_employee_id=manager_employee_id,
