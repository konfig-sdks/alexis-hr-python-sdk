...
from alexis_hr_python_sdk.model.employee_get_one_response_mapped import EmployeeGetOneResponseMapped as EmployeeGetOneResponseMappedSchema
...
from alexis_hr_python_sdk.type.employee_get_one_response_mapped import EmployeeGetOneResponseMapped
...
from alexis_hr_python_sdk.pydantic.employee_get_one_response_mapped import EmployeeGetOneResponseMapped as EmployeeGetOneResponseMappedPydantic
...
SchemaFor200ResponseBodyApplicationJson = EmployeeGetOneResponseMappedSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: EmployeeGetOneResponseMapped
...
class GetOneRaw(BaseApi):
    ...
    async def aget_one(
        ...
        **kwargs,
        ...
        args = self._get_one_mapped_args(
            id=id,
            select=select,
            relations=relations,
        )
        return await self._aget_one_oapg(
    ...
    def get_one(
        ...
        return self._get_one_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetOne(BaseApi):
    ...
    async def aget_one(
        ...
        validate: bool = False,
        **kwargs,
    ) -> EmployeeGetOneResponseMappedPydantic:
        raw_response = await self.raw.aget_one(
            id=id,
            select=select,
            relations=relations,
            **kwargs,
        ...
        if validate:
            return EmployeeGetOneResponseMappedPydantic(**raw_response.body)
        return api_client.construct_model_instance(EmployeeGetOneResponseMappedPydantic, raw_response.body)
