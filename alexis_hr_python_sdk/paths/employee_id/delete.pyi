...
class BaseApi(api_client.Api):
    ...
    def _remove_employee_mapped_args(
        self,
        id: str,
    ...
    async def _aremove_employee_oapg(
        self,
...
class RemoveEmployeeRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_employee(
        self,
        id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._remove_employee_mapped_args(
            id=id,
        )
        return await self._aremove_employee_oapg(
    ...
    def remove_employee(
        ...
        return self._remove_employee_oapg(
            path_params=args.path,
        )

class RemoveEmployee(BaseApi):
    ...
    async def aremove_employee(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_employee(
            id=id,
            **kwargs,
        )
        if validate:
    ...
    def remove_employee(
        ...
        raw_response = self.raw.remove_employee(
            id=id,
        )
        if validate:
            return EmptyResponseMappedPydantic(**raw_response.body)
