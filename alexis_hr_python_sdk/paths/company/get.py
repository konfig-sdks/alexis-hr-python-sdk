...
from alexis_hr_python_sdk.model.companies_get_many_response_mapped import CompaniesGetManyResponseMapped as CompaniesGetManyResponseMappedSchema

from alexis_hr_python_sdk.type.forbidden_response import ForbiddenResponse
from alexis_hr_python_sdk.type.companies_get_many_response_mapped import CompaniesGetManyResponseMapped
...
from alexis_hr_python_sdk.pydantic.companies_get_many_response_mapped import CompaniesGetManyResponseMapped as CompaniesGetManyResponseMappedPydantic
...
SchemaFor200ResponseBodyApplicationJson = CompaniesGetManyResponseMappedSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: CompaniesGetManyResponseMapped
...
class BaseApi(api_client.Api):
    ...
    def _list_many_companies_mapped_args(
        self,
    ...
    async def _alist_many_companies_oapg(
        self,
...
class ListManyCompaniesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_many_companies(
        self,
        select: typing.Optional[typing.List[str]] = None,
        filters: typing.Optional[typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]]] = None,
        limit: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._list_many_companies_mapped_args(
            select=select,
            filters=filters,
            limit=limit,
            offset=offset,
        ...
        return await self._alist_many_companies_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def list_many_companies(
        self,
        select: typing.Optional[typing.List[str]] = None,
        filters: typing.Optional[typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]]] = None,
        limit: typing.Optional[int] = None,
        ...
        return self._list_many_companies_oapg(
            query_params=args.query,
        )

class ListManyCompanies(BaseApi):
    ...
    async def alist_many_companies(
        ...
        validate: bool = False,
        **kwargs,
    ) -> CompaniesGetManyResponseMappedPydantic:
        raw_response = await self.raw.alist_many_companies(
            select=select,
            filters=filters,
            limit=limit,
            offset=offset,
        ...
        if validate:
            return CompaniesGetManyResponseMappedPydantic(**raw_response.body)
        return api_client.construct_model_instance(CompaniesGetManyResponseMappedPydantic, raw_response.body)
    ...
    def list_many_companies(
        ...
        raw_response = self.raw.list_many_companies(
            select=select,
            filters=filters,
            limit=limit,
            offset=offset,
