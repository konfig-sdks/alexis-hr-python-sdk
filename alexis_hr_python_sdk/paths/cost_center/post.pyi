...
from alexis_hr_python_sdk.model.create_cost_center_request import CreateCostCenterRequest as CreateCostCenterRequestSchema

from alexis_hr_python_sdk.type.forbidden_response import ForbiddenResponse
from alexis_hr_python_sdk.type.create_cost_center_request import CreateCostCenterRequest
...
from alexis_hr_python_sdk.pydantic.create_cost_center_request import CreateCostCenterRequest as CreateCostCenterRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = CreateCostCenterRequestSchema


request_body_create_cost_center_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = CostCenterResponseMappedSchema
...
class BaseApi(api_client.Api):
    ...
    def _create_one_cost_center_mapped_args(
        self,
        code: str,
    ...
    async def _acreate_one_cost_center_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_create_cost_center_request.serialize(body, content_type)
    ...
    def _create_one_cost_center_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class CreateOneCostCenterRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_one_cost_center(
        self,
        code: str,
        name: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._create_one_cost_center_mapped_args(
            code=code,
            name=name,
        )
        return await self._acreate_one_cost_center_oapg(
            body=args.body,
            **kwargs,
        )
    
    def create_one_cost_center(
        self,
        code: str,
        name: typing.Optional[str] = None,
    ) -> typing.Union[
        ...
        return self._create_one_cost_center_oapg(
            body=args.body,
        )

class CreateOneCostCenter(BaseApi):
    ...
    async def acreate_one_cost_center(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_one_cost_center(
            code=code,
            name=name,
            **kwargs,
        )
    ...
    def create_one_cost_center(
        ...
        raw_response = self.raw.create_one_cost_center(
            code=code,
            name=name,
        )
        if validate:
