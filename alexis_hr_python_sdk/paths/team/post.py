...
from alexis_hr_python_sdk.model.create_team_request import CreateTeamRequest as CreateTeamRequestSchema
...
from alexis_hr_python_sdk.type.create_team_request import CreateTeamRequest
...
from alexis_hr_python_sdk.pydantic.create_team_request import CreateTeamRequest as CreateTeamRequestPydantic
from alexis_hr_python_sdk.pydantic.team_response_mapped import TeamResponseMapped as TeamResponseMappedPydantic

from . import path

# body param
SchemaForRequestBodyApplicationJson = CreateTeamRequestSchema


request_body_create_team_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = TeamResponseMappedSchema
...
class BaseApi(api_client.Api):
    ...
    def _create_one_team_mapped_args(
        self,
        name: str,
        bg_color: str,
        fg_color: str,
    ...
    async def _acreate_one_team_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_create_team_request.serialize(body, content_type)
...
class CreateOneTeamRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_one_team(
        self,
        name: str,
        bg_color: str,
        fg_color: str,
        ...
        **kwargs,
        ...
        args = self._create_one_team_mapped_args(
            name=name,
            bg_color=bg_color,
            fg_color=fg_color,
            description=description,
        )
        return await self._acreate_one_team_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def create_one_team(
        ...
        return self._create_one_team_oapg(
            body=args.body,
        )

class CreateOneTeam(BaseApi):
    ...
    async def acreate_one_team(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_one_team(
            name=name,
            bg_color=bg_color,
            fg_color=fg_color,
            description=description,
    ...
    def create_one_team(
        ...
        raw_response = self.raw.create_one_team(
            name=name,
            bg_color=bg_color,
            fg_color=fg_color,
            description=description,
