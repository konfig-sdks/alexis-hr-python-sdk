...
from alexis_hr_python_sdk.model.office_response_mapped import OfficeResponseMapped as OfficeResponseMappedSchema
...
from alexis_hr_python_sdk.model.create_office_request import CreateOfficeRequest as CreateOfficeRequestSchema
...
from alexis_hr_python_sdk.type.office_response_mapped import OfficeResponseMapped
from alexis_hr_python_sdk.type.unauthorized_response import UnauthorizedResponse
from alexis_hr_python_sdk.type.create_office_request import CreateOfficeRequest
...
from alexis_hr_python_sdk.pydantic.create_office_request import CreateOfficeRequest as CreateOfficeRequestPydantic
...
from alexis_hr_python_sdk.pydantic.office_response_mapped import OfficeResponseMapped as OfficeResponseMappedPydantic

from . import path

# body param
SchemaForRequestBodyApplicationJson = CreateOfficeRequestSchema


request_body_create_office_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = OfficeResponseMappedSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: OfficeResponseMapped
...
class BaseApi(api_client.Api):
    ...
    def _create_one_office_mapped_args(
        self,
        name: str,
        phone: str,
        email: str,
    ...
    async def _acreate_one_office_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_create_office_request.serialize(body, content_type)
...
class CreateOneOfficeRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_one_office(
        self,
        name: str,
        phone: str,
        email: str,
        ...
        **kwargs,
        ...
        args = self._create_one_office_mapped_args(
            name=name,
            phone=phone,
            email=email,
            timezone=timezone,
        ...
        return await self._acreate_one_office_oapg(
            body=args.body,
            **kwargs,
        )
    
    def create_one_office(
        self,
        name: str,
        phone: str,
        email: str,
        ...
        return self._create_one_office_oapg(
            body=args.body,
        )

class CreateOneOffice(BaseApi):
    ...
    async def acreate_one_office(
        ...
        validate: bool = False,
        **kwargs,
    ) -> OfficeResponseMappedPydantic:
        raw_response = await self.raw.acreate_one_office(
            name=name,
            phone=phone,
            email=email,
            timezone=timezone,
        ...
        if validate:
            return OfficeResponseMappedPydantic(**raw_response.body)
        return api_client.construct_model_instance(OfficeResponseMappedPydantic, raw_response.body)
    ...
    def create_one_office(
        ...
        raw_response = self.raw.create_one_office(
            name=name,
            phone=phone,
            email=email,
            timezone=timezone,
