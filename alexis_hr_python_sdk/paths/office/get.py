...
from alexis_hr_python_sdk.model.offices_get_many_response_mapped import OfficesGetManyResponseMapped as OfficesGetManyResponseMappedSchema
...
from alexis_hr_python_sdk.type.offices_get_many_response_mapped import OfficesGetManyResponseMapped

from ...api_client import Dictionary
from alexis_hr_python_sdk.pydantic.offices_get_many_response_mapped import OfficesGetManyResponseMapped as OfficesGetManyResponseMappedPydantic
...
class FiltersSchema(
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["CFAR"]) -> typing.Union[MetaOapg.properties.CFAR, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["SCB"]) -> typing.Union[MetaOapg.properties.SCB, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["SNI"]) -> typing.Union[MetaOapg.properties.SNI, schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        phone: typing.Union[MetaOapg.properties.phone, dict, frozendict.frozendict, schemas.Unset] = schemas.unset,
        ...
        CFAR: typing.Union[MetaOapg.properties.CFAR, dict, frozendict.frozendict, schemas.Unset] = schemas.unset,
        SCB: typing.Union[MetaOapg.properties.SCB, dict, frozendict.frozendict, schemas.Unset] = schemas.unset,
        SNI: typing.Union[MetaOapg.properties.SNI, dict, frozendict.frozendict, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'FiltersSchema':
        return super().__new__(
...
class SortSchema(
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        CFAR: typing.Union[MetaOapg.properties.CFAR, str, schemas.Unset] = schemas.unset,
        SCB: typing.Union[MetaOapg.properties.SCB, str, schemas.Unset] = schemas.unset,
        SNI: typing.Union[MetaOapg.properties.SNI, str, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'SortSchema':
        return super().__new__(
...
SchemaFor200ResponseBodyApplicationJson = OfficesGetManyResponseMappedSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: OfficesGetManyResponseMapped
...
class BaseApi(api_client.Api):
    ...
    def _list_many_offices_mapped_args(
        self,
    ...
    async def _alist_many_offices_oapg(
        self,
...
class ListManyOfficesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_many_offices(
        self,
        select: typing.Optional[typing.List[str]] = None,
        filters: typing.Optional[typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]]] = None,
        limit: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._list_many_offices_mapped_args(
            select=select,
            filters=filters,
            limit=limit,
            offset=offset,
        ...
        return await self._alist_many_offices_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def list_many_offices(
        self,
        select: typing.Optional[typing.List[str]] = None,
        filters: typing.Optional[typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]]] = None,
        limit: typing.Optional[int] = None,
        ...
        return self._list_many_offices_oapg(
            query_params=args.query,
        )

class ListManyOffices(BaseApi):
    ...
    async def alist_many_offices(
        ...
        validate: bool = False,
        **kwargs,
    ) -> OfficesGetManyResponseMappedPydantic:
        raw_response = await self.raw.alist_many_offices(
            select=select,
            filters=filters,
            limit=limit,
            offset=offset,
        ...
        if validate:
            return OfficesGetManyResponseMappedPydantic(**raw_response.body)
        return api_client.construct_model_instance(OfficesGetManyResponseMappedPydantic, raw_response.body)
    ...
    def list_many_offices(
        ...
        raw_response = self.raw.list_many_offices(
            select=select,
            filters=filters,
            limit=limit,
            offset=offset,
