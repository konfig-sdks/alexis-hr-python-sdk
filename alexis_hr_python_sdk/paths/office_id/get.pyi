...
from alexis_hr_python_sdk.model.office_get_one_response_mapped import OfficeGetOneResponseMapped as OfficeGetOneResponseMappedSchema
...
from alexis_hr_python_sdk.type.office_get_one_response_mapped import OfficeGetOneResponseMapped
...
from alexis_hr_python_sdk.pydantic.office_get_one_response_mapped import OfficeGetOneResponseMapped as OfficeGetOneResponseMappedPydantic
...
SchemaFor200ResponseBodyApplicationJson = OfficeGetOneResponseMappedSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: OfficeGetOneResponseMapped
...
class BaseApi(api_client.Api):
    ...
    def _get_one_office_mapped_args(
        self,
        id: str,
    ...
    async def _aget_one_office_oapg(
        self,
...
class GetOneOfficeRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_one_office(
        self,
        id: str,
        select: typing.Optional[typing.List[str]] = None,
        **kwargs,
        ...
        args = self._get_one_office_mapped_args(
            id=id,
            select=select,
        )
        return await self._aget_one_office_oapg(
    ...
    def get_one_office(
        ...
        return self._get_one_office_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetOneOffice(BaseApi):
    ...
    async def aget_one_office(
        ...
        validate: bool = False,
        **kwargs,
    ) -> OfficeGetOneResponseMappedPydantic:
        raw_response = await self.raw.aget_one_office(
            id=id,
            select=select,
            **kwargs,
        )
        if validate:
            return OfficeGetOneResponseMappedPydantic(**raw_response.body)
        return api_client.construct_model_instance(OfficeGetOneResponseMappedPydantic, raw_response.body)
    ...
    def get_one_office(
        ...
        raw_response = self.raw.get_one_office(
            id=id,
            select=select,
        )
        if validate:
