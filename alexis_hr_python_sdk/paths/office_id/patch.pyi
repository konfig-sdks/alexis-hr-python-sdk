...
from alexis_hr_python_sdk.model.update_office_request import UpdateOfficeRequest as UpdateOfficeRequestSchema
...
from alexis_hr_python_sdk.type.update_office_request import UpdateOfficeRequest
...
from alexis_hr_python_sdk.pydantic.update_office_request import UpdateOfficeRequest as UpdateOfficeRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = UpdateOfficeRequestSchema


request_body_update_office_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = OfficeResponseMappedSchema
...
class BaseApi(api_client.Api):
    ...
    def _update_one_mapped_args(
        ...
        cfar: typing.Optional[str] = None,
        scb: typing.Optional[str] = None,
        sni: typing.Optional[str] = None,
    ...
    async def _aupdate_one_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/office/{id}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_update_office_request.serialize(body, content_type)
