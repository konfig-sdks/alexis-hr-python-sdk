...
from alexis_hr_python_sdk.model.leave_types_get_many_response_mapped import LeaveTypesGetManyResponseMapped as LeaveTypesGetManyResponseMappedSchema
...
from alexis_hr_python_sdk.type.leave_types_get_many_response_mapped import LeaveTypesGetManyResponseMapped
...
from alexis_hr_python_sdk.pydantic.leave_types_get_many_response_mapped import LeaveTypesGetManyResponseMapped as LeaveTypesGetManyResponseMappedPydantic
...
class SelectSchema(
    ...
    class MetaOapg:
        ...
        class items(
            ...
            @schemas.classproperty
            def MINIMUM_DURATION(cls):
                return cls("minimumDuration")
            
            @schemas.classproperty
            def DEDUCTIBLE(cls):
                return cls("deductible")
...
class RelationsSchema(
    ...
    class MetaOapg:
        ...
        class items(
            ...
            @schemas.classproperty
            def LEAVE_TYPE_CODE(cls):
                return cls("leaveTypeCode")
...
class FiltersSchema(
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["minimumDuration"]) -> typing.Union[MetaOapg.properties.minimumDuration, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["deductible"]) -> typing.Union[MetaOapg.properties.deductible, schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        kind: typing.Union[MetaOapg.properties.kind, dict, frozendict.frozendict, schemas.Unset] = schemas.unset,
        minimumDuration: typing.Union[MetaOapg.properties.minimumDuration, dict, frozendict.frozendict, schemas.Unset] = schemas.unset,
        deductible: typing.Union[MetaOapg.properties.deductible, dict, frozendict.frozendict, schemas.Unset] = schemas.unset,
        paid: typing.Union[MetaOapg.properties.paid, dict, frozendict.frozendict, schemas.Unset] = schemas.unset,
        disabled: typing.Union[MetaOapg.properties.disabled, dict, frozendict.frozendict, schemas.Unset] = schemas.unset,
        archived: typing.Union[MetaOapg.properties.archived, dict, frozendict.frozendict, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'FiltersSchema':
        return super().__new__(
...
class SortSchema(
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        minimumDuration: typing.Union[MetaOapg.properties.minimumDuration, str, schemas.Unset] = schemas.unset,
        deductible: typing.Union[MetaOapg.properties.deductible, str, schemas.Unset] = schemas.unset,
...
SchemaFor200ResponseBodyApplicationJson = LeaveTypesGetManyResponseMappedSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: LeaveTypesGetManyResponseMapped
...
class BaseApi(api_client.Api):
    ...
    def _get_many_leave_types_mapped_args(
        self,
    ...
    async def _aget_many_leave_types_oapg(
        self,
    ...
    def _get_many_leave_types_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetManyLeaveTypesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_many_leave_types(
        self,
        select: typing.Optional[typing.List[str]] = None,
        relations: typing.Optional[typing.List[str]] = None,
        filters: typing.Optional[typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]]] = None,
        ...
        **kwargs,
        ...
        args = self._get_many_leave_types_mapped_args(
            select=select,
            relations=relations,
            filters=filters,
            limit=limit,
        ...
        return await self._aget_many_leave_types_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def get_many_leave_types(
        self,
        select: typing.Optional[typing.List[str]] = None,
        relations: typing.Optional[typing.List[str]] = None,
        filters: typing.Optional[typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]]] = None,
        ...
        return self._get_many_leave_types_oapg(
            query_params=args.query,
        )

class GetManyLeaveTypes(BaseApi):
    ...
    async def aget_many_leave_types(
        ...
        validate: bool = False,
        **kwargs,
    ) -> LeaveTypesGetManyResponseMappedPydantic:
        raw_response = await self.raw.aget_many_leave_types(
            select=select,
            relations=relations,
            filters=filters,
            limit=limit,
        ...
        if validate:
            return LeaveTypesGetManyResponseMappedPydantic(**raw_response.body)
        return api_client.construct_model_instance(LeaveTypesGetManyResponseMappedPydantic, raw_response.body)
    ...
    def get_many_leave_types(
        ...
        raw_response = self.raw.get_many_leave_types(
            select=select,
            relations=relations,
            filters=filters,
            limit=limit,
