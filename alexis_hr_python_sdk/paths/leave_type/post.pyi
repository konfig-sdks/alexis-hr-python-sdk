...
from alexis_hr_python_sdk.model.create_leave_type_request import CreateLeaveTypeRequest as CreateLeaveTypeRequestSchema
...
from alexis_hr_python_sdk.type.create_leave_type_request import CreateLeaveTypeRequest
...
from alexis_hr_python_sdk.pydantic.create_leave_type_request import CreateLeaveTypeRequest as CreateLeaveTypeRequestPydantic

# body param
SchemaForRequestBodyApplicationJson = CreateLeaveTypeRequestSchema


request_body_create_leave_type_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = LeaveTypeResponseMappedSchema
...
class BaseApi(api_client.Api):
    ...
    def _create_one_leave_type_mapped_args(
        self,
        name: str,
    ...
    async def _acreate_one_leave_type_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_create_leave_type_request.serialize(body, content_type)
    ...
    def _create_one_leave_type_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class CreateOneLeaveTypeRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_one_leave_type(
        self,
        name: str,
        kind: typing.Optional[str] = None,
        minimum_duration: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._create_one_leave_type_mapped_args(
            name=name,
            kind=kind,
        ...
        return await self._acreate_one_leave_type_oapg(
            body=args.body,
            **kwargs,
        )
    
    def create_one_leave_type(
        self,
        name: str,
        kind: typing.Optional[str] = None,
        minimum_duration: typing.Optional[str] = None,
        ...
        return self._create_one_leave_type_oapg(
            body=args.body,
        )

class CreateOneLeaveType(BaseApi):
    ...
    async def acreate_one_leave_type(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_one_leave_type(
            name=name,
            kind=kind,
            minimum_duration=minimum_duration,
            deductible=deductible,
    ...
    def create_one_leave_type(
        ...
        raw_response = self.raw.create_one_leave_type(
            name=name,
            kind=kind,
            minimum_duration=minimum_duration,
            deductible=deductible,
