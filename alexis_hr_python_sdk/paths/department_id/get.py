...
from alexis_hr_python_sdk.model.department_get_one_response_mapped import DepartmentGetOneResponseMapped as DepartmentGetOneResponseMappedSchema
...
from alexis_hr_python_sdk.type.department_get_one_response_mapped import DepartmentGetOneResponseMapped
...
from alexis_hr_python_sdk.pydantic.department_get_one_response_mapped import DepartmentGetOneResponseMapped as DepartmentGetOneResponseMappedPydantic
...
SchemaFor200ResponseBodyApplicationJson = DepartmentGetOneResponseMappedSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: DepartmentGetOneResponseMapped
...
class GetOne(BaseApi):
    ...
    async def aget_one(
        ...
        validate: bool = False,
        **kwargs,
    ) -> DepartmentGetOneResponseMappedPydantic:
        ...
        if validate:
            return DepartmentGetOneResponseMappedPydantic(**raw_response.body)
        return api_client.construct_model_instance(DepartmentGetOneResponseMappedPydantic, raw_response.body)
