...
class BaseApi(api_client.Api):
    ...
    def _delete_one_department_mapped_args(
        self,
        id: str,
    ...
    async def _adelete_one_department_oapg(
        self,
    ...
    def _delete_one_department_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class DeleteOneDepartmentRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_one_department(
        self,
        id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._delete_one_department_mapped_args(
            id=id,
        )
        return await self._adelete_one_department_oapg(
    ...
    def delete_one_department(
        ...
        return self._delete_one_department_oapg(
            path_params=args.path,
        )

class DeleteOneDepartment(BaseApi):
    ...
    async def adelete_one_department(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_one_department(
            id=id,
            **kwargs,
        )
        if validate:
    ...
    def delete_one_department(
        ...
        raw_response = self.raw.delete_one_department(
            id=id,
        )
        if validate:
            return EmptyResponseMappedPydantic(**raw_response.body)
