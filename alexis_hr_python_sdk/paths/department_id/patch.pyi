...
from alexis_hr_python_sdk.model.update_department_request import UpdateDepartmentRequest as UpdateDepartmentRequestSchema
...
from alexis_hr_python_sdk.type.update_department_request import UpdateDepartmentRequest
...
from alexis_hr_python_sdk.pydantic.update_department_request import UpdateDepartmentRequest as UpdateDepartmentRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = UpdateDepartmentRequestSchema


request_body_update_department_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = DepartmentResponseMappedSchema
...
class BaseApi(api_client.Api):
    ...
    def _update_one_department_mapped_args(
        self,
        name: str,
        id: str,
    ...
    async def _aupdate_one_department_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_update_department_request.serialize(body, content_type)
    ...
    def _update_one_department_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class UpdateOneDepartmentRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_one_department(
        self,
        name: str,
        id: str,
        description: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._update_one_department_mapped_args(
            name=name,
            id=id,
        ...
        return await self._aupdate_one_department_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def update_one_department(
        self,
        name: str,
        id: str,
        description: typing.Optional[str] = None,
        ...
        return self._update_one_department_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateOneDepartment(BaseApi):
    ...
    async def aupdate_one_department(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_one_department(
            name=name,
            id=id,
            description=description,
            cost_center_id=cost_center_id,
    ...
    def update_one_department(
        ...
        raw_response = self.raw.update_one_department(
            name=name,
            id=id,
            description=description,
            cost_center_id=cost_center_id,
