...
from alexis_hr_python_sdk.model.create_employment_type_request import CreateEmploymentTypeRequest as CreateEmploymentTypeRequestSchema
...
from alexis_hr_python_sdk.type.create_employment_type_request import CreateEmploymentTypeRequest

from ...api_client import Dictionary
from alexis_hr_python_sdk.pydantic.create_employment_type_request import CreateEmploymentTypeRequest as CreateEmploymentTypeRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = CreateEmploymentTypeRequestSchema


request_body_create_employment_type_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = EmploymentTypeResponseMappedSchema
...
class BaseApi(api_client.Api):
    ...
    def _create_one_employment_type_mapped_args(
        self,
        name: str,
        vacation: bool,
        country: str,
    ...
    async def _acreate_one_employment_type_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_create_employment_type_request.serialize(body, content_type)
    ...
    def _create_one_employment_type_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class CreateOneEmploymentTypeRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_one_employment_type(
        self,
        name: str,
        vacation: bool,
        country: str,
        ...
        **kwargs,
        ...
        args = self._create_one_employment_type_mapped_args(
            name=name,
            vacation=vacation,
            country=country,
            max_months=max_months,
        )
        return await self._acreate_one_employment_type_oapg(
            body=args.body,
            **kwargs,
        )
    
    def create_one_employment_type(
        self,
        name: str,
        vacation: bool,
        country: str,
        ...
        return self._create_one_employment_type_oapg(
            body=args.body,
        )

class CreateOneEmploymentType(BaseApi):
    ...
    async def acreate_one_employment_type(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_one_employment_type(
            name=name,
            vacation=vacation,
            country=country,
            max_months=max_months,
    ...
    def create_one_employment_type(
        ...
        raw_response = self.raw.create_one_employment_type(
            name=name,
            vacation=vacation,
            country=country,
            max_months=max_months,
