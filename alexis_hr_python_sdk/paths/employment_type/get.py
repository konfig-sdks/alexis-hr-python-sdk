...
from alexis_hr_python_sdk.model.employment_types_get_many_response_mapped import EmploymentTypesGetManyResponseMapped as EmploymentTypesGetManyResponseMappedSchema
...
from alexis_hr_python_sdk.type.employment_types_get_many_response_mapped import EmploymentTypesGetManyResponseMapped
...
from alexis_hr_python_sdk.pydantic.employment_types_get_many_response_mapped import EmploymentTypesGetManyResponseMapped as EmploymentTypesGetManyResponseMappedPydantic
...
class FiltersSchema(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "companyId", "name", "vacation", "country", "maxMonths", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["vacation"]) -> typing.Union[MetaOapg.properties.vacation, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "companyId", "name", "vacation", "country", "maxMonths", ], str]):
        return super().get_item_oapg(name)
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        vacation: typing.Union[MetaOapg.properties.vacation, dict, frozendict.frozendict, schemas.Unset] = schemas.unset,
        country: typing.Union[MetaOapg.properties.country, dict, frozendict.frozendict, schemas.Unset] = schemas.unset,
        maxMonths: typing.Union[MetaOapg.properties.maxMonths, dict, frozendict.frozendict, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'FiltersSchema':
        return super().__new__(
...
class SortSchema(
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        vacation: typing.Union[MetaOapg.properties.vacation, str, schemas.Unset] = schemas.unset,
        country: typing.Union[MetaOapg.properties.country, str, schemas.Unset] = schemas.unset,
        maxMonths: typing.Union[MetaOapg.properties.maxMonths, str, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'SortSchema':
        return super().__new__(
...
SchemaFor200ResponseBodyApplicationJson = EmploymentTypesGetManyResponseMappedSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: EmploymentTypesGetManyResponseMapped
...
class BaseApi(api_client.Api):
    ...
    def _get_many_employment_types_mapped_args(
        self,
    ...
    async def _aget_many_employment_types_oapg(
        self,
    ...
    def _get_many_employment_types_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetManyEmploymentTypesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_many_employment_types(
        self,
        select: typing.Optional[typing.List[str]] = None,
        filters: typing.Optional[typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]]] = None,
        limit: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._get_many_employment_types_mapped_args(
            select=select,
            filters=filters,
            limit=limit,
            offset=offset,
        ...
        return await self._aget_many_employment_types_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def get_many_employment_types(
        self,
        select: typing.Optional[typing.List[str]] = None,
        filters: typing.Optional[typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]]] = None,
        limit: typing.Optional[int] = None,
        ...
        return self._get_many_employment_types_oapg(
            query_params=args.query,
        )

class GetManyEmploymentTypes(BaseApi):
    ...
    async def aget_many_employment_types(
        ...
        validate: bool = False,
        **kwargs,
    ) -> EmploymentTypesGetManyResponseMappedPydantic:
        raw_response = await self.raw.aget_many_employment_types(
            select=select,
            filters=filters,
            limit=limit,
            offset=offset,
        ...
        if validate:
            return EmploymentTypesGetManyResponseMappedPydantic(**raw_response.body)
        return api_client.construct_model_instance(EmploymentTypesGetManyResponseMappedPydantic, raw_response.body)
    ...
    def get_many_employment_types(
        ...
        raw_response = self.raw.get_many_employment_types(
            select=select,
            filters=filters,
            limit=limit,
            offset=offset,
