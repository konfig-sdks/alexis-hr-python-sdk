...
from alexis_hr_python_sdk.model.children_get_many_response_mapped import ChildrenGetManyResponseMapped as ChildrenGetManyResponseMappedSchema
...
from alexis_hr_python_sdk.type.children_get_many_response_mapped import ChildrenGetManyResponseMapped
...
from alexis_hr_python_sdk.pydantic.children_get_many_response_mapped import ChildrenGetManyResponseMapped as ChildrenGetManyResponseMappedPydantic
...
class FiltersSchema(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "employeeId", "name", "birthdate", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "employeeId", "name", "birthdate", ], str]):
        return super().get_item_oapg(name)
...
SchemaFor200ResponseBodyApplicationJson = ChildrenGetManyResponseMappedSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ChildrenGetManyResponseMapped
...
class GetMany(BaseApi):
    ...
    async def aget_many(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ChildrenGetManyResponseMappedPydantic:
        ...
        if validate:
            return ChildrenGetManyResponseMappedPydantic(**raw_response.body)
        return api_client.construct_model_instance(ChildrenGetManyResponseMappedPydantic, raw_response.body)
