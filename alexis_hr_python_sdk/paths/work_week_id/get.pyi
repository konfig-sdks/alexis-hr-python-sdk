...
from alexis_hr_python_sdk.model.work_week_get_one_response_mapped import WorkWeekGetOneResponseMapped as WorkWeekGetOneResponseMappedSchema
...
from alexis_hr_python_sdk.type.work_week_get_one_response_mapped import WorkWeekGetOneResponseMapped
...
from alexis_hr_python_sdk.pydantic.work_week_get_one_response_mapped import WorkWeekGetOneResponseMapped as WorkWeekGetOneResponseMappedPydantic
...
SchemaFor200ResponseBodyApplicationJson = WorkWeekGetOneResponseMappedSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: WorkWeekGetOneResponseMapped
...
class GetOne(BaseApi):
    ...
    async def aget_one(
        ...
        validate: bool = False,
        **kwargs,
    ) -> WorkWeekGetOneResponseMappedPydantic:
        ...
        if validate:
            return WorkWeekGetOneResponseMappedPydantic(**raw_response.body)
        return api_client.construct_model_instance(WorkWeekGetOneResponseMappedPydantic, raw_response.body)
