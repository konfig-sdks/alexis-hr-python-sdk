...
from alexis_hr_python_sdk.model.update_work_week_request import UpdateWorkWeekRequest as UpdateWorkWeekRequestSchema

from alexis_hr_python_sdk.type.update_work_week_request import UpdateWorkWeekRequest
...
from alexis_hr_python_sdk.pydantic.update_work_week_request import UpdateWorkWeekRequest as UpdateWorkWeekRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = UpdateWorkWeekRequestSchema


request_body_update_work_week_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = WorkWeekResponseMappedSchema
    ...
    async def _aupdate_one_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/work-week/{id}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_update_work_week_request.serialize(body, content_type)
