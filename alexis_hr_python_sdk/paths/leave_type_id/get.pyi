...
from alexis_hr_python_sdk.model.leave_type_get_one_response_mapped import LeaveTypeGetOneResponseMapped as LeaveTypeGetOneResponseMappedSchema
...
from alexis_hr_python_sdk.type.leave_type_get_one_response_mapped import LeaveTypeGetOneResponseMapped
...
from alexis_hr_python_sdk.pydantic.leave_type_get_one_response_mapped import LeaveTypeGetOneResponseMapped as LeaveTypeGetOneResponseMappedPydantic
...
SchemaFor200ResponseBodyApplicationJson = LeaveTypeGetOneResponseMappedSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: LeaveTypeGetOneResponseMapped
...
class BaseApi(api_client.Api):
    ...
    def _get_one_leave_type_mapped_args(
        self,
        id: str,
    ...
    async def _aget_one_leave_type_oapg(
        self,
...
class GetOneLeaveTypeRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_one_leave_type(
        self,
        id: str,
        select: typing.Optional[typing.List[str]] = None,
        relations: typing.Optional[typing.List[str]] = None,
        **kwargs,
        ...
        args = self._get_one_leave_type_mapped_args(
            id=id,
            select=select,
            relations=relations,
        )
        return await self._aget_one_leave_type_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_one_leave_type(
        self,
        id: str,
        select: typing.Optional[typing.List[str]] = None,
        relations: typing.Optional[typing.List[str]] = None,
        ...
        return self._get_one_leave_type_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetOneLeaveType(BaseApi):
    ...
    async def aget_one_leave_type(
        ...
        validate: bool = False,
        **kwargs,
    ) -> LeaveTypeGetOneResponseMappedPydantic:
        raw_response = await self.raw.aget_one_leave_type(
            id=id,
            select=select,
            relations=relations,
            **kwargs,
        ...
        if validate:
            return LeaveTypeGetOneResponseMappedPydantic(**raw_response.body)
        return api_client.construct_model_instance(LeaveTypeGetOneResponseMappedPydantic, raw_response.body)
    ...
    def get_one_leave_type(
        ...
        raw_response = self.raw.get_one_leave_type(
            id=id,
            select=select,
            relations=relations,
        )
