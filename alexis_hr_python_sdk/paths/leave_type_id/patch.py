...
from alexis_hr_python_sdk.model.leave_type_response_mapped import LeaveTypeResponseMapped as LeaveTypeResponseMappedSchema
...
from alexis_hr_python_sdk.model.update_leave_type_request import UpdateLeaveTypeRequest as UpdateLeaveTypeRequestSchema
...
from alexis_hr_python_sdk.type.update_leave_type_request import UpdateLeaveTypeRequest
...
from alexis_hr_python_sdk.type.leave_type_response_mapped import LeaveTypeResponseMapped
...
from alexis_hr_python_sdk.pydantic.leave_type_response_mapped import LeaveTypeResponseMapped as LeaveTypeResponseMappedPydantic
...
from alexis_hr_python_sdk.pydantic.update_leave_type_request import UpdateLeaveTypeRequest as UpdateLeaveTypeRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = UpdateLeaveTypeRequestSchema


request_body_update_leave_type_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = LeaveTypeResponseMappedSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: LeaveTypeResponseMapped
...
class BaseApi(api_client.Api):
    ...
    def _update_one_leave_type_mapped_args(
        self,
        id: str,
        name: typing.Optional[str] = None,
        kind: typing.Optional[str] = None,
        minimum_duration: typing.Optional[str] = None,
        deductible: typing.Optional[bool] = None,
        ...
        if minimum_duration is not None:
            _body["minimumDuration"] = minimum_duration
        if deductible is not None:
            _body["deductible"] = deductible
        if paid is not None:
            _body["paid"] = paid
    ...
    async def _aupdate_one_leave_type_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/leave-type/{id}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_update_leave_type_request.serialize(body, content_type)
    ...
    def _update_one_leave_type_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class UpdateOneLeaveTypeRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_one_leave_type(
        self,
        id: str,
        name: typing.Optional[str] = None,
        kind: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._update_one_leave_type_mapped_args(
            id=id,
            name=name,
            kind=kind,
        ...
        return await self._aupdate_one_leave_type_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def update_one_leave_type(
        self,
        id: str,
        name: typing.Optional[str] = None,
        kind: typing.Optional[str] = None,
        ...
        return self._update_one_leave_type_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateOneLeaveType(BaseApi):
    ...
    async def aupdate_one_leave_type(
        ...
        validate: bool = False,
        **kwargs,
    ) -> LeaveTypeResponseMappedPydantic:
        raw_response = await self.raw.aupdate_one_leave_type(
            id=id,
            name=name,
            kind=kind,
            minimum_duration=minimum_duration,
        ...
        if validate:
            return LeaveTypeResponseMappedPydantic(**raw_response.body)
        return api_client.construct_model_instance(LeaveTypeResponseMappedPydantic, raw_response.body)
    ...
    def update_one_leave_type(
        ...
        raw_response = self.raw.update_one_leave_type(
            id=id,
            name=name,
            kind=kind,
            minimum_duration=minimum_duration,
