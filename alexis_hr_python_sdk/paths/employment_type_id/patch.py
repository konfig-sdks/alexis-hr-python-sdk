...
class BaseApi(api_client.Api):
    ...
    def _update_one_employment_type_0_mapped_args(
        self,
        country: str,
        id: str,
    ...
    async def _aupdate_one_employment_type_0_oapg(
        self,
    ...
    def _update_one_employment_type_0_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class UpdateOneEmploymentType0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_one_employment_type_0(
        self,
        country: str,
        id: str,
        name: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._update_one_employment_type_0_mapped_args(
            country=country,
            id=id,
            name=name,
            vacation=vacation,
        ...
        return await self._aupdate_one_employment_type_0_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def update_one_employment_type_0(
        self,
        country: str,
        id: str,
        name: typing.Optional[str] = None,
        ...
        return self._update_one_employment_type_0_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateOneEmploymentType0(BaseApi):
    ...
    async def aupdate_one_employment_type_0(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_one_employment_type_0(
            country=country,
            id=id,
            name=name,
            vacation=vacation,
    ...
    def update_one_employment_type_0(
        ...
        raw_response = self.raw.update_one_employment_type_0(
            country=country,
            id=id,
            name=name,
            vacation=vacation,
