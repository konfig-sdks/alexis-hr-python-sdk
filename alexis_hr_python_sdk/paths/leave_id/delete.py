...
class BaseApi(api_client.Api):
    ...
    def _delete_one_leave_mapped_args(
        self,
        id: str,
    ...
    async def _adelete_one_leave_oapg(
        self,
...
class DeleteOneLeaveRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_one_leave(
        self,
        id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._delete_one_leave_mapped_args(
            id=id,
        )
        return await self._adelete_one_leave_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def delete_one_leave(
        self,
        id: str,
    ) -> typing.Union[
        ApiResponseFor204,
        ...
        return self._delete_one_leave_oapg(
            path_params=args.path,
        )

class DeleteOneLeave(BaseApi):
    ...
    async def adelete_one_leave(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_one_leave(
            id=id,
            **kwargs,
        )
        if validate:
    ...
    def delete_one_leave(
        ...
        raw_response = self.raw.delete_one_leave(
            id=id,
        )
        if validate:
            return EmptyResponseMappedPydantic(**raw_response.body)
