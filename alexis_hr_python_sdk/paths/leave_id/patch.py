...
from alexis_hr_python_sdk.model.leave_response_mapped import LeaveResponseMapped as LeaveResponseMappedSchema
from alexis_hr_python_sdk.model.unauthorized_response import UnauthorizedResponse as UnauthorizedResponseSchema
from alexis_hr_python_sdk.model.update_leave_request import UpdateLeaveRequest as UpdateLeaveRequestSchema
...
from alexis_hr_python_sdk.type.leave_response_mapped import LeaveResponseMapped
...
from alexis_hr_python_sdk.type.update_leave_request import UpdateLeaveRequest

from ...api_client import Dictionary
from alexis_hr_python_sdk.pydantic.update_leave_request import UpdateLeaveRequest as UpdateLeaveRequestPydantic
...
from alexis_hr_python_sdk.pydantic.leave_response_mapped import LeaveResponseMapped as LeaveResponseMappedPydantic
...
# body param
SchemaForRequestBodyApplicationJson = UpdateLeaveRequestSchema


request_body_update_leave_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = LeaveResponseMappedSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: LeaveResponseMapped
...
class BaseApi(api_client.Api):
    ...
    def _update_one_leave_mapped_args(
        self,
        extent: typing.Union[int, float],
        id: str,
        ...
        morning: typing.Optional[bool] = None,
        afternoon: typing.Optional[bool] = None,
        status: typing.Optional[str] = None,
        approval_note: typing.Optional[str] = None,
        ...
        if morning is not None:
            _body["morning"] = morning
        if afternoon is not None:
            _body["afternoon"] = afternoon
        if status is not None:
            _body["status"] = status
        if approval_note is not None:
            _body["approvalNote"] = approval_note
        args.body = _body
        if id is not None:
            _path_params["id"] = id
    ...
    async def _aupdate_one_leave_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/leave/{id}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_update_leave_request.serialize(body, content_type)
...
class UpdateOneLeaveRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_one_leave(
        self,
        extent: typing.Union[int, float],
        id: str,
        description: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._update_one_leave_mapped_args(
            extent=extent,
            id=id,
        ...
        return await self._aupdate_one_leave_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def update_one_leave(
        self,
        extent: typing.Union[int, float],
        id: str,
        description: typing.Optional[str] = None,
        ...
        return self._update_one_leave_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateOneLeave(BaseApi):
    ...
    async def aupdate_one_leave(
        ...
        validate: bool = False,
        **kwargs,
    ) -> LeaveResponseMappedPydantic:
        raw_response = await self.raw.aupdate_one_leave(
            extent=extent,
            id=id,
            description=description,
            child_id=child_id,
        ...
        if validate:
            return LeaveResponseMappedPydantic(**raw_response.body)
        return api_client.construct_model_instance(LeaveResponseMappedPydantic, raw_response.body)
    ...
    def update_one_leave(
        ...
        raw_response = self.raw.update_one_leave(
            extent=extent,
            id=id,
            description=description,
            child_id=child_id,
