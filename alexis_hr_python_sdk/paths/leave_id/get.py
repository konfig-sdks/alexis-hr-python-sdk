...
from alexis_hr_python_sdk.model.leave_get_one_response_mapped import LeaveGetOneResponseMapped as LeaveGetOneResponseMappedSchema
...
from alexis_hr_python_sdk.type.leave_get_one_response_mapped import LeaveGetOneResponseMapped
...
from alexis_hr_python_sdk.pydantic.leave_get_one_response_mapped import LeaveGetOneResponseMapped as LeaveGetOneResponseMappedPydantic
...
SchemaFor200ResponseBodyApplicationJson = LeaveGetOneResponseMappedSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: LeaveGetOneResponseMapped
...
class BaseApi(api_client.Api):
    ...
    def _get_one_leave_mapped_args(
        self,
        id: str,
    ...
    async def _aget_one_leave_oapg(
        self,
...
class GetOneLeaveRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_one_leave(
        self,
        id: str,
        select: typing.Optional[typing.List[str]] = None,
        relations: typing.Optional[typing.List[str]] = None,
        **kwargs,
        ...
        args = self._get_one_leave_mapped_args(
            id=id,
            select=select,
            relations=relations,
        )
        return await self._aget_one_leave_oapg(
    ...
    def get_one_leave(
        ...
        return self._get_one_leave_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetOneLeave(BaseApi):
    ...
    async def aget_one_leave(
        ...
        validate: bool = False,
        **kwargs,
    ) -> LeaveGetOneResponseMappedPydantic:
        raw_response = await self.raw.aget_one_leave(
            id=id,
            select=select,
            relations=relations,
            **kwargs,
        ...
        if validate:
            return LeaveGetOneResponseMappedPydantic(**raw_response.body)
        return api_client.construct_model_instance(LeaveGetOneResponseMappedPydantic, raw_response.body)
    ...
    def get_one_leave(
        ...
        raw_response = self.raw.get_one_leave(
            id=id,
            select=select,
            relations=relations,
        )
