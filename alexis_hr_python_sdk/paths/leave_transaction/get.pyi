...
from alexis_hr_python_sdk.model.leave_transactions_get_many_response_mapped import LeaveTransactionsGetManyResponseMapped as LeaveTransactionsGetManyResponseMappedSchema
...
from alexis_hr_python_sdk.type.leave_transactions_get_many_response_mapped import LeaveTransactionsGetManyResponseMapped
from alexis_hr_python_sdk.type.unauthorized_response import UnauthorizedResponse

from ...api_client import Dictionary
from alexis_hr_python_sdk.pydantic.leave_transactions_get_many_response_mapped import LeaveTransactionsGetManyResponseMapped as LeaveTransactionsGetManyResponseMappedPydantic
...
class SelectSchema(
    ...
    class MetaOapg:
        ...
        class items(
            ...
            @schemas.classproperty
            def LEAVE_TYPE_ID(cls):
                return cls("leaveTypeId")
...
class FiltersSchema(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["description", "id", "leaveTypeId", "employeeId", "childId", "date", "hours", "extent", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["extent"]) -> typing.Union[MetaOapg.properties.extent, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["description", "id", "leaveTypeId", "employeeId", "childId", "date", "hours", "extent", ], str]):
        return super().get_item_oapg(name)
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        leaveTypeId: typing.Union[MetaOapg.properties.leaveTypeId, dict, frozendict.frozendict, schemas.Unset] = schemas.unset,
        employeeId: typing.Union[MetaOapg.properties.employeeId, dict, frozendict.frozendict, schemas.Unset] = schemas.unset,
        childId: typing.Union[MetaOapg.properties.childId, dict, frozendict.frozendict, schemas.Unset] = schemas.unset,
        ...
        extent: typing.Union[MetaOapg.properties.extent, dict, frozendict.frozendict, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'FiltersSchema':
        return super().__new__(
...
class SortSchema(
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        leaveTypeId: typing.Union[MetaOapg.properties.leaveTypeId, str, schemas.Unset] = schemas.unset,
        ...
        extent: typing.Union[MetaOapg.properties.extent, str, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'SortSchema':
        return super().__new__(
...
SchemaFor200ResponseBodyApplicationJson = LeaveTransactionsGetManyResponseMappedSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: LeaveTransactionsGetManyResponseMapped
...
class BaseApi(api_client.Api):
    ...
    def _list_many_transactions_mapped_args(
        self,
    ...
    async def _alist_many_transactions_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/leave-transaction',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _list_many_transactions_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class ListManyTransactionsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_many_transactions(
        self,
        select: typing.Optional[typing.List[str]] = None,
        relations: typing.Optional[typing.List[str]] = None,
        filters: typing.Optional[typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]]] = None,
        ...
        **kwargs,
        ...
        args = self._list_many_transactions_mapped_args(
            select=select,
            relations=relations,
            filters=filters,
            limit=limit,
        ...
        return await self._alist_many_transactions_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def list_many_transactions(
        self,
        select: typing.Optional[typing.List[str]] = None,
        relations: typing.Optional[typing.List[str]] = None,
        filters: typing.Optional[typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]]] = None,
        ...
        return self._list_many_transactions_oapg(
            query_params=args.query,
        )

class ListManyTransactions(BaseApi):
    ...
    async def alist_many_transactions(
        ...
        validate: bool = False,
        **kwargs,
    ) -> LeaveTransactionsGetManyResponseMappedPydantic:
        raw_response = await self.raw.alist_many_transactions(
            select=select,
            relations=relations,
            filters=filters,
            limit=limit,
        ...
        if validate:
            return LeaveTransactionsGetManyResponseMappedPydantic(**raw_response.body)
        return api_client.construct_model_instance(LeaveTransactionsGetManyResponseMappedPydantic, raw_response.body)
    ...
    def list_many_transactions(
        ...
        raw_response = self.raw.list_many_transactions(
            select=select,
            relations=relations,
            filters=filters,
            limit=limit,
