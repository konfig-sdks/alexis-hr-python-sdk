...
from alexis_hr_python_sdk.model.create_leave_request import CreateLeaveRequest as CreateLeaveRequestSchema
...
from alexis_hr_python_sdk.type.create_leave_request import CreateLeaveRequest
...
from alexis_hr_python_sdk.pydantic.create_leave_request import CreateLeaveRequest as CreateLeaveRequestPydantic

# body param
SchemaForRequestBodyApplicationJson = CreateLeaveRequestSchema


request_body_create_leave_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = LeaveResponseMappedSchema
...
class BaseApi(api_client.Api):
    ...
    def _create_one_mapped_args(
        ...
        extent: typing.Optional[typing.Union[int, float]] = None,
        morning: typing.Optional[typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]]] = None,
        afternoon: typing.Optional[typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]]] = None,
    ...
    async def _acreate_one_oapg(
        ...
        **kwargs,
        ...
        serialized_data = request_body_create_leave_request.serialize(body, content_type)
