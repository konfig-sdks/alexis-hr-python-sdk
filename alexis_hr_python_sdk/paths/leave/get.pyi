...
from alexis_hr_python_sdk.model.leaves_get_many_response_mapped import LeavesGetManyResponseMapped as LeavesGetManyResponseMappedSchema
...
from alexis_hr_python_sdk.type.leaves_get_many_response_mapped import LeavesGetManyResponseMapped
...
from alexis_hr_python_sdk.pydantic.leaves_get_many_response_mapped import LeavesGetManyResponseMapped as LeavesGetManyResponseMappedPydantic
...
class FiltersSchema(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "employeeId", "typeId", "status", "duration", "startDate", "endDate", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "employeeId", "typeId", "status", "duration", "startDate", "endDate", ], str]):
        return super().get_item_oapg(name)
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        duration: typing.Union[MetaOapg.properties.duration, dict, frozendict.frozendict, schemas.Unset] = schemas.unset,
...
SchemaFor200ResponseBodyApplicationJson = LeavesGetManyResponseMappedSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: LeavesGetManyResponseMapped
...
class BaseApi(api_client.Api):
    ...
    def _get_many_leaves_mapped_args(
        self,
    ...
    async def _aget_many_leaves_oapg(
        self,
...
class GetManyLeavesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_many_leaves(
        self,
        select: typing.Optional[typing.List[str]] = None,
        relations: typing.Optional[typing.List[str]] = None,
        filters: typing.Optional[typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]]] = None,
        ...
        **kwargs,
        ...
        args = self._get_many_leaves_mapped_args(
            select=select,
            relations=relations,
            filters=filters,
            limit=limit,
        ...
        return await self._aget_many_leaves_oapg(
    ...
    def get_many_leaves(
        ...
        return self._get_many_leaves_oapg(
            query_params=args.query,
        )

class GetManyLeaves(BaseApi):
    ...
    async def aget_many_leaves(
        ...
        validate: bool = False,
        **kwargs,
    ) -> LeavesGetManyResponseMappedPydantic:
        raw_response = await self.raw.aget_many_leaves(
            select=select,
            relations=relations,
            filters=filters,
            limit=limit,
        ...
        if validate:
            return LeavesGetManyResponseMappedPydantic(**raw_response.body)
        return api_client.construct_model_instance(LeavesGetManyResponseMappedPydantic, raw_response.body)
    ...
    def get_many_leaves(
        ...
        raw_response = self.raw.get_many_leaves(
            select=select,
            relations=relations,
            filters=filters,
            limit=limit,
