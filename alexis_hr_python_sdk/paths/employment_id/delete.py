...
class RemoveOneRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_one(
        self,
        id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._remove_one_mapped_args(
            id=id,
        )
        return await self._aremove_one_oapg(
    ...
    def remove_one(
        ...
        return self._remove_one_oapg(
            path_params=args.path,
        )

class RemoveOne(BaseApi):
    ...
    async def aremove_one(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_one(
            id=id,
            **kwargs,
        )
        if validate:
    ...
    def remove_one(
        ...
        raw_response = self.raw.remove_one(
            id=id,
        )
        if validate:
            return EmptyResponseMappedPydantic(**raw_response.body)
