...
from alexis_hr_python_sdk.model.employment_get_one_response_mapped import EmploymentGetOneResponseMapped as EmploymentGetOneResponseMappedSchema
...
from alexis_hr_python_sdk.type.employment_get_one_response_mapped import EmploymentGetOneResponseMapped
...
from alexis_hr_python_sdk.pydantic.employment_get_one_response_mapped import EmploymentGetOneResponseMapped as EmploymentGetOneResponseMappedPydantic
...
SchemaFor200ResponseBodyApplicationJson = EmploymentGetOneResponseMappedSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: EmploymentGetOneResponseMapped
...
class GetOne(BaseApi):
    ...
    async def aget_one(
        ...
        validate: bool = False,
        **kwargs,
    ) -> EmploymentGetOneResponseMappedPydantic:
        ...
        if validate:
            return EmploymentGetOneResponseMappedPydantic(**raw_response.body)
        return api_client.construct_model_instance(EmploymentGetOneResponseMappedPydantic, raw_response.body)
