...
class BaseApi(api_client.Api):
    ...
    def _update_employment_data_mapped_args(
        self,
        id: str,
    ...
    async def _aupdate_employment_data_oapg(
        self,
    ...
    def _update_employment_data_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class UpdateEmploymentDataRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_employment_data(
        self,
        id: str,
        employee_id: typing.Optional[str] = None,
        user_id: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._update_employment_data_mapped_args(
            id=id,
        ...
        return await self._aupdate_employment_data_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def update_employment_data(
        self,
        id: str,
        employee_id: typing.Optional[str] = None,
        user_id: typing.Optional[str] = None,
        ...
        return self._update_employment_data_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateEmploymentData(BaseApi):
    ...
    async def aupdate_employment_data(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_employment_data(
            id=id,
            employee_id=employee_id,
            user_id=user_id,
            type_id=type_id,
    ...
    def update_employment_data(
        ...
        raw_response = self.raw.update_employment_data(
            id=id,
            employee_id=employee_id,
            user_id=user_id,
            type_id=type_id,
