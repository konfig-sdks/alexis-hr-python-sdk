...
from alexis_hr_python_sdk.model.timesheet_get_one_response_mapped import TimesheetGetOneResponseMapped as TimesheetGetOneResponseMappedSchema
from alexis_hr_python_sdk.model.bad_request_response import BadRequestResponse as BadRequestResponseSchema

from alexis_hr_python_sdk.type.timesheet_get_one_response_mapped import TimesheetGetOneResponseMapped
...
from alexis_hr_python_sdk.pydantic.timesheet_get_one_response_mapped import TimesheetGetOneResponseMapped as TimesheetGetOneResponseMappedPydantic
...
SchemaFor200ResponseBodyApplicationJson = TimesheetGetOneResponseMappedSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: TimesheetGetOneResponseMapped
...
class Get(BaseApi):
    ...
    async def aget(
        ...
        validate: bool = False,
        **kwargs,
    ) -> TimesheetGetOneResponseMappedPydantic:
        ...
        if validate:
            return TimesheetGetOneResponseMappedPydantic(**raw_response.body)
        return api_client.construct_model_instance(TimesheetGetOneResponseMappedPydantic, raw_response.body)
