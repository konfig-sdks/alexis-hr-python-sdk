...
from alexis_hr_python_sdk.model.departments_get_many_response_mapped import DepartmentsGetManyResponseMapped as DepartmentsGetManyResponseMappedSchema

from alexis_hr_python_sdk.type.forbidden_response import ForbiddenResponse
from alexis_hr_python_sdk.type.departments_get_many_response_mapped import DepartmentsGetManyResponseMapped
...
from alexis_hr_python_sdk.pydantic.departments_get_many_response_mapped import DepartmentsGetManyResponseMapped as DepartmentsGetManyResponseMappedPydantic
        ...
        class items(
            ...
            class MetaOapg:
                enum_value_to_name = {
                    ...
                    "effectiveCostCenterId": "EFFECTIVE_COST_CENTER_ID",
                    "parentId": "PARENT_ID",
                }
            ...
            @schemas.classproperty
            def EFFECTIVE_COST_CENTER_ID(cls):
                return cls("effectiveCostCenterId")
...
class FiltersSchema(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            __annotations__ = {
                ...
                "effectiveCostCenterId": effectiveCostCenterId,
                "parentId": parentId,
            }
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["effectiveCostCenterId"]) -> MetaOapg.properties.effectiveCostCenterId: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "companyId", "name", "costCenterId", "effectiveCostCenterId", "parentId", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["effectiveCostCenterId"]) -> typing.Union[MetaOapg.properties.effectiveCostCenterId, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "companyId", "name", "costCenterId", "effectiveCostCenterId", "parentId", ], str]):
        return super().get_item_oapg(name)
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        effectiveCostCenterId: typing.Union[MetaOapg.properties.effectiveCostCenterId, dict, frozendict.frozendict, schemas.Unset] = schemas.unset,
        parentId: typing.Union[MetaOapg.properties.parentId, dict, frozendict.frozendict, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'FiltersSchema':
        return super().__new__(
...
class SortSchema(
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        effectiveCostCenterId: typing.Union[MetaOapg.properties.effectiveCostCenterId, str, schemas.Unset] = schemas.unset,
...
SchemaFor200ResponseBodyApplicationJson = DepartmentsGetManyResponseMappedSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: DepartmentsGetManyResponseMapped
...
class BaseApi(api_client.Api):
    ...
    def _list_many_departments_mapped_args(
        self,
    ...
    async def _alist_many_departments_oapg(
        self,
    ...
    def _list_many_departments_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class ListManyDepartmentsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_many_departments(
        self,
        select: typing.Optional[typing.List[str]] = None,
        relations: typing.Optional[typing.List[str]] = None,
        filters: typing.Optional[typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]]] = None,
        ...
        **kwargs,
        ...
        args = self._list_many_departments_mapped_args(
            select=select,
            relations=relations,
            filters=filters,
            limit=limit,
        ...
        return await self._alist_many_departments_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def list_many_departments(
        self,
        select: typing.Optional[typing.List[str]] = None,
        relations: typing.Optional[typing.List[str]] = None,
        filters: typing.Optional[typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]]] = None,
        ...
        return self._list_many_departments_oapg(
            query_params=args.query,
        )

class ListManyDepartments(BaseApi):
    ...
    async def alist_many_departments(
        ...
        validate: bool = False,
        **kwargs,
    ) -> DepartmentsGetManyResponseMappedPydantic:
        raw_response = await self.raw.alist_many_departments(
            select=select,
            relations=relations,
            filters=filters,
            limit=limit,
        ...
        if validate:
            return DepartmentsGetManyResponseMappedPydantic(**raw_response.body)
        return api_client.construct_model_instance(DepartmentsGetManyResponseMappedPydantic, raw_response.body)
    ...
    def list_many_departments(
        ...
        raw_response = self.raw.list_many_departments(
            select=select,
            relations=relations,
            filters=filters,
            limit=limit,
