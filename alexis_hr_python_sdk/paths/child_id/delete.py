...
class DeleteChildRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_child(
        self,
        id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._delete_child_mapped_args(
            id=id,
        )
        return await self._adelete_child_oapg(
    ...
    def delete_child(
        ...
        return self._delete_child_oapg(
            path_params=args.path,
        )

class DeleteChild(BaseApi):
    ...
    async def adelete_child(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_child(
            id=id,
            **kwargs,
        )
        if validate:
    ...
    def delete_child(
        ...
        raw_response = self.raw.delete_child(
            id=id,
        )
        if validate:
            return EmptyResponseMappedPydantic(**raw_response.body)
