...
class BaseApi(api_client.Api):
    ...
    def _update_child_data_mapped_args(
        self,
        name: str,
        birthdate: datetime,
        id: str,
    ...
    async def _aupdate_child_data_oapg(
        self,
...
class UpdateChildDataRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_child_data(
        self,
        name: str,
        birthdate: datetime,
        id: str,
        **kwargs,
        ...
        args = self._update_child_data_mapped_args(
            name=name,
            birthdate=birthdate,
            id=id,
        )
        return await self._aupdate_child_data_oapg(
            body=args.body,
    ...
    def update_child_data(
        ...
        return self._update_child_data_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateChildData(BaseApi):
    ...
    async def aupdate_child_data(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_child_data(
            name=name,
            birthdate=birthdate,
            id=id,
            **kwargs,
    ...
    def update_child_data(
        ...
        raw_response = self.raw.update_child_data(
            name=name,
            birthdate=birthdate,
            id=id,
        )
