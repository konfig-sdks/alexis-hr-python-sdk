...
from alexis_hr_python_sdk.model.child_response_mapped import ChildResponseMapped as ChildResponseMappedSchema
from alexis_hr_python_sdk.model.bad_request_response import BadRequestResponse as BadRequestResponseSchema
from alexis_hr_python_sdk.model.update_child_request import UpdateChildRequest as UpdateChildRequestSchema

from alexis_hr_python_sdk.type.update_child_request import UpdateChildRequest
...
from alexis_hr_python_sdk.type.child_response_mapped import ChildResponseMapped
...
from alexis_hr_python_sdk.pydantic.update_child_request import UpdateChildRequest as UpdateChildRequestPydantic
...
from alexis_hr_python_sdk.pydantic.child_response_mapped import ChildResponseMapped as ChildResponseMappedPydantic
...
# body param
SchemaForRequestBodyApplicationJson = UpdateChildRequestSchema


request_body_update_child_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ChildResponseMappedSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ChildResponseMapped
...
class BaseApi(api_client.Api):
    ...
    def _replace_child_data_mapped_args(
        self,
        name: str,
        birthdate: datetime,
        id: str,
    ...
    async def _areplace_child_data_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/child/{id}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_update_child_request.serialize(body, content_type)
...
class ReplaceChildDataRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def areplace_child_data(
        self,
        name: str,
        birthdate: datetime,
        id: str,
        **kwargs,
        ...
        args = self._replace_child_data_mapped_args(
            name=name,
            birthdate=birthdate,
            id=id,
        )
        return await self._areplace_child_data_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def replace_child_data(
        self,
        name: str,
        birthdate: datetime,
        id: str,
        ...
        return self._replace_child_data_oapg(
            body=args.body,
            path_params=args.path,
        )

class ReplaceChildData(BaseApi):
    ...
    async def areplace_child_data(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ChildResponseMappedPydantic:
        raw_response = await self.raw.areplace_child_data(
            name=name,
            birthdate=birthdate,
            id=id,
            **kwargs,
        ...
        if validate:
            return ChildResponseMappedPydantic(**raw_response.body)
        return api_client.construct_model_instance(ChildResponseMappedPydantic, raw_response.body)
    ...
    def replace_child_data(
        ...
        raw_response = self.raw.replace_child_data(
            name=name,
            birthdate=birthdate,
            id=id,
        )
