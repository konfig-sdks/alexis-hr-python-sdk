...
from alexis_hr_python_sdk.model.child_get_one_response_mapped import ChildGetOneResponseMapped as ChildGetOneResponseMappedSchema
...
from alexis_hr_python_sdk.type.child_get_one_response_mapped import ChildGetOneResponseMapped
...
from alexis_hr_python_sdk.pydantic.child_get_one_response_mapped import ChildGetOneResponseMapped as ChildGetOneResponseMappedPydantic
...
SchemaFor200ResponseBodyApplicationJson = ChildGetOneResponseMappedSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ChildGetOneResponseMapped
...
class BaseApi(api_client.Api):
    ...
    def _get_one_child_mapped_args(
        self,
        id: str,
    ...
    async def _aget_one_child_oapg(
        self,
...
class GetOneChildRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_one_child(
        self,
        id: str,
        select: typing.Optional[typing.List[str]] = None,
        **kwargs,
        ...
        args = self._get_one_child_mapped_args(
            id=id,
            select=select,
        )
        return await self._aget_one_child_oapg(
    ...
    def get_one_child(
        ...
        return self._get_one_child_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetOneChild(BaseApi):
    ...
    async def aget_one_child(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ChildGetOneResponseMappedPydantic:
        raw_response = await self.raw.aget_one_child(
            id=id,
            select=select,
            **kwargs,
        )
        if validate:
            return ChildGetOneResponseMappedPydantic(**raw_response.body)
        return api_client.construct_model_instance(ChildGetOneResponseMappedPydantic, raw_response.body)
    ...
    def get_one_child(
        ...
        raw_response = self.raw.get_one_child(
            id=id,
            select=select,
        )
        if validate:
