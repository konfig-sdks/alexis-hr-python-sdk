...
from alexis_hr_python_sdk.model.work_weeks_get_many_response_mapped import WorkWeeksGetManyResponseMapped as WorkWeeksGetManyResponseMappedSchema
...
from alexis_hr_python_sdk.type.work_weeks_get_many_response_mapped import WorkWeeksGetManyResponseMapped
...
from alexis_hr_python_sdk.pydantic.work_weeks_get_many_response_mapped import WorkWeeksGetManyResponseMapped as WorkWeeksGetManyResponseMappedPydantic
...
class SelectSchema(
    ...
    class MetaOapg:
        ...
        class items(
            ...
            @schemas.classproperty
            def EFFECTIVE_FROM(cls):
                return cls("effectiveFrom")
...
class FiltersSchema(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "companyId", "officeId", "employeeId", "effectiveFrom", "timezone", "duration", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "companyId", "officeId", "employeeId", "effectiveFrom", "timezone", "duration", ], str]):
        return super().get_item_oapg(name)
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        effectiveFrom: typing.Union[MetaOapg.properties.effectiveFrom, dict, frozendict.frozendict, schemas.Unset] = schemas.unset,
...
SchemaFor200ResponseBodyApplicationJson = WorkWeeksGetManyResponseMappedSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: WorkWeeksGetManyResponseMapped
...
class GetMany(BaseApi):
    ...
    async def aget_many(
        ...
        validate: bool = False,
        **kwargs,
    ) -> WorkWeeksGetManyResponseMappedPydantic:
        ...
        if validate:
            return WorkWeeksGetManyResponseMappedPydantic(**raw_response.body)
        return api_client.construct_model_instance(WorkWeeksGetManyResponseMappedPydantic, raw_response.body)
