...
from alexis_hr_python_sdk.model.create_work_week_request import CreateWorkWeekRequest as CreateWorkWeekRequestSchema
from alexis_hr_python_sdk.model.work_week_response_mapped import WorkWeekResponseMapped as WorkWeekResponseMappedSchema
...
from alexis_hr_python_sdk.model.work_week_day_request import WorkWeekDayRequest as WorkWeekDayRequestSchema
...
from alexis_hr_python_sdk.type.create_work_week_request import CreateWorkWeekRequest
from alexis_hr_python_sdk.type.work_week_day_request import WorkWeekDayRequest
from alexis_hr_python_sdk.type.unauthorized_response import UnauthorizedResponse
from alexis_hr_python_sdk.type.work_week_response_mapped import WorkWeekResponseMapped

from ...api_client import Dictionary
from alexis_hr_python_sdk.pydantic.work_week_response_mapped import WorkWeekResponseMapped as WorkWeekResponseMappedPydantic
...
from alexis_hr_python_sdk.pydantic.work_week_day_request import WorkWeekDayRequest as WorkWeekDayRequestPydantic
from alexis_hr_python_sdk.pydantic.forbidden_response import ForbiddenResponse as ForbiddenResponsePydantic
from alexis_hr_python_sdk.pydantic.create_work_week_request import CreateWorkWeekRequest as CreateWorkWeekRequestPydantic

from . import path

# body param
SchemaForRequestBodyApplicationJson = CreateWorkWeekRequestSchema


request_body_create_work_week_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = WorkWeekResponseMappedSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: WorkWeekResponseMapped
...
class BaseApi(api_client.Api):
    ...
    def _create_one_workweek_mapped_args(
        self,
        ...
        effective_to: typing.Optional[datetime] = None,
        ...
        if tuesday is not None:
            _body["tuesday"] = tuesday
        if wednesday is not None:
            _body["wednesday"] = wednesday
        if thursday is not None:
            _body["thursday"] = thursday
        if friday is not None:
            _body["friday"] = friday
        if saturday is not None:
            _body["saturday"] = saturday
        if sunday is not None:
            _body["sunday"] = sunday
        args.body = _body
        return args

    async def _acreate_one_workweek_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/work-week',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_create_work_week_request.serialize(body, content_type)
...
class CreateOneWorkweekRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_one_workweek(
        self,
        effective_from: datetime,
        timezone: str,
        duration: typing.Union[int, float],
        ...
        **kwargs,
        ...
        args = self._create_one_workweek_mapped_args(
        ...
        return await self._acreate_one_workweek_oapg(
            body=args.body,
            **kwargs,
        )
    
    def create_one_workweek(
        self,
        effective_from: datetime,
        timezone: str,
        duration: typing.Union[int, float],
        ...
        return self._create_one_workweek_oapg(
            body=args.body,
        )

class CreateOneWorkweek(BaseApi):
    ...
    async def acreate_one_workweek(
        ...
        validate: bool = False,
        **kwargs,
    ) -> WorkWeekResponseMappedPydantic:
        raw_response = await self.raw.acreate_one_workweek(
            effective_from=effective_from,
            timezone=timezone,
            duration=duration,
            monday=monday,
        ...
        if validate:
            return WorkWeekResponseMappedPydantic(**raw_response.body)
        return api_client.construct_model_instance(WorkWeekResponseMappedPydantic, raw_response.body)
    ...
    def create_one_workweek(
        ...
        raw_response = self.raw.create_one_workweek(
            effective_from=effective_from,
            timezone=timezone,
            duration=duration,
            monday=monday,
