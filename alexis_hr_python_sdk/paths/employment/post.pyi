...
from alexis_hr_python_sdk.model.create_employment_request import CreateEmploymentRequest as CreateEmploymentRequestSchema
...
from alexis_hr_python_sdk.type.create_employment_request import CreateEmploymentRequest
...
from alexis_hr_python_sdk.pydantic.create_employment_request import CreateEmploymentRequest as CreateEmploymentRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = CreateEmploymentRequestSchema


request_body_create_employment_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = EmploymentResponseMappedSchema
...
class BaseApi(api_client.Api):
    ...
    def _create_one_employment_mapped_args(
        self,
        employee_id: str,
        user_id: str,
        type_id: str,
    ...
    async def _acreate_one_employment_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_create_employment_request.serialize(body, content_type)
    ...
    def _create_one_employment_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class CreateOneEmploymentRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_one_employment(
        self,
        employee_id: str,
        user_id: str,
        type_id: str,
        ...
        **kwargs,
        ...
        args = self._create_one_employment_mapped_args(
        ...
        return await self._acreate_one_employment_oapg(
            body=args.body,
            **kwargs,
        )
    
    def create_one_employment(
        self,
        employee_id: str,
        user_id: str,
        type_id: str,
        ...
        return self._create_one_employment_oapg(
            body=args.body,
        )

class CreateOneEmployment(BaseApi):
    ...
    async def acreate_one_employment(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_one_employment(
            employee_id=employee_id,
            user_id=user_id,
            type_id=type_id,
            start_date=start_date,
    ...
    def create_one_employment(
        ...
        raw_response = self.raw.create_one_employment(
            employee_id=employee_id,
            user_id=user_id,
            type_id=type_id,
            start_date=start_date,
