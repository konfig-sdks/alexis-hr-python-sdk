...
from alexis_hr_python_sdk.model.employments_get_many_response_mapped import EmploymentsGetManyResponseMapped as EmploymentsGetManyResponseMappedSchema
...
from alexis_hr_python_sdk.type.employments_get_many_response_mapped import EmploymentsGetManyResponseMapped
...
from alexis_hr_python_sdk.pydantic.employments_get_many_response_mapped import EmploymentsGetManyResponseMapped as EmploymentsGetManyResponseMappedPydantic
...
class SelectSchema(
    ...
    class MetaOapg:
        ...
        class items(
            ...
            @schemas.classproperty
            def EFFECTIVE_END_DATE(cls):
                return cls("effectiveEndDate")
...
class FiltersSchema(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "companyId", "employeeId", "typeId", "startDate", "endDate", "updated", "effectiveEndDate", "terminated", "rate", "note", "country", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "companyId", "employeeId", "typeId", "startDate", "endDate", "updated", "effectiveEndDate", "terminated", "rate", "note", "country", ], str]):
        return super().get_item_oapg(name)
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        typeId: typing.Union[MetaOapg.properties.typeId, dict, frozendict.frozendict, schemas.Unset] = schemas.unset,
        ...
        effectiveEndDate: typing.Union[MetaOapg.properties.effectiveEndDate, dict, frozendict.frozendict, schemas.Unset] = schemas.unset,
        terminated: typing.Union[MetaOapg.properties.terminated, dict, frozendict.frozendict, schemas.Unset] = schemas.unset,
...
class SortSchema(
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        effectiveEndDate: typing.Union[MetaOapg.properties.effectiveEndDate, str, schemas.Unset] = schemas.unset,
        terminated: typing.Union[MetaOapg.properties.terminated, str, schemas.Unset] = schemas.unset,
...
SchemaFor200ResponseBodyApplicationJson = EmploymentsGetManyResponseMappedSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: EmploymentsGetManyResponseMapped
...
class BaseApi(api_client.Api):
    ...
    def _list_many_employments_mapped_args(
        self,
    ...
    async def _alist_many_employments_oapg(
        self,
    ...
    def _list_many_employments_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class ListManyEmploymentsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_many_employments(
        self,
        select: typing.Optional[typing.List[str]] = None,
        relations: typing.Optional[typing.List[str]] = None,
        filters: typing.Optional[typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]]] = None,
        ...
        **kwargs,
        ...
        args = self._list_many_employments_mapped_args(
            select=select,
            relations=relations,
            filters=filters,
            limit=limit,
        ...
        return await self._alist_many_employments_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def list_many_employments(
        self,
        select: typing.Optional[typing.List[str]] = None,
        relations: typing.Optional[typing.List[str]] = None,
        filters: typing.Optional[typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]]] = None,
        ...
        return self._list_many_employments_oapg(
            query_params=args.query,
        )

class ListManyEmployments(BaseApi):
    ...
    async def alist_many_employments(
        ...
        validate: bool = False,
        **kwargs,
    ) -> EmploymentsGetManyResponseMappedPydantic:
        raw_response = await self.raw.alist_many_employments(
            select=select,
            relations=relations,
            filters=filters,
            limit=limit,
        ...
        if validate:
            return EmploymentsGetManyResponseMappedPydantic(**raw_response.body)
        return api_client.construct_model_instance(EmploymentsGetManyResponseMappedPydantic, raw_response.body)
    ...
    def list_many_employments(
        ...
        raw_response = self.raw.list_many_employments(
            select=select,
            relations=relations,
            filters=filters,
            limit=limit,
