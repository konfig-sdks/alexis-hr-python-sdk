...
from alexis_hr_python_sdk.model.team_response_mapped import TeamResponseMapped as TeamResponseMappedSchema
...
from alexis_hr_python_sdk.model.update_team_request import UpdateTeamRequest as UpdateTeamRequestSchema

from alexis_hr_python_sdk.type.team_response_mapped import TeamResponseMapped
...
from alexis_hr_python_sdk.type.update_team_request import UpdateTeamRequest
...
from alexis_hr_python_sdk.pydantic.update_team_request import UpdateTeamRequest as UpdateTeamRequestPydantic
...
from alexis_hr_python_sdk.pydantic.team_response_mapped import TeamResponseMapped as TeamResponseMappedPydantic
...
# body param
SchemaForRequestBodyApplicationJson = UpdateTeamRequestSchema


request_body_update_team_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = TeamResponseMappedSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: TeamResponseMapped
...
class BaseApi(api_client.Api):
    ...
    def _replace_team_mapped_args(
        self,
        id: str,
        description: typing.Optional[str] = None,
        name: typing.Optional[str] = None,
        bg_color: typing.Optional[str] = None,
        fg_color: typing.Optional[str] = None,
        ...
        if bg_color is not None:
            _body["bgColor"] = bg_color
        if fg_color is not None:
            _body["fgColor"] = fg_color
        args.body = _body
        if id is not None:
            _path_params["id"] = id
    ...
    async def _areplace_team_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/team/{id}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_update_team_request.serialize(body, content_type)
...
class ReplaceTeamRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def areplace_team(
        self,
        id: str,
        description: typing.Optional[str] = None,
        name: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._replace_team_mapped_args(
            id=id,
        ...
        return await self._areplace_team_oapg(
            body=args.body,
    ...
    def replace_team(
        ...
        return self._replace_team_oapg(
            body=args.body,
            path_params=args.path,
        )

class ReplaceTeam(BaseApi):
    ...
    async def areplace_team(
        ...
        validate: bool = False,
        **kwargs,
    ) -> TeamResponseMappedPydantic:
        raw_response = await self.raw.areplace_team(
            id=id,
            description=description,
            name=name,
            bg_color=bg_color,
        ...
        if validate:
            return TeamResponseMappedPydantic(**raw_response.body)
        return api_client.construct_model_instance(TeamResponseMappedPydantic, raw_response.body)
    ...
    def replace_team(
        ...
        raw_response = self.raw.replace_team(
            id=id,
            description=description,
            name=name,
            bg_color=bg_color,
