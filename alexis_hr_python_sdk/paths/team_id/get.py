...
from alexis_hr_python_sdk.model.team_get_one_response_mapped import TeamGetOneResponseMapped as TeamGetOneResponseMappedSchema
...
from alexis_hr_python_sdk.type.team_get_one_response_mapped import TeamGetOneResponseMapped
...
from alexis_hr_python_sdk.pydantic.team_get_one_response_mapped import TeamGetOneResponseMapped as TeamGetOneResponseMappedPydantic
...
SchemaFor200ResponseBodyApplicationJson = TeamGetOneResponseMappedSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: TeamGetOneResponseMapped
...
class GetOneTeamRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_one_team(
        self,
        id: str,
        select: typing.Optional[typing.List[str]] = None,
        **kwargs,
        ...
        args = self._get_one_team_mapped_args(
            id=id,
            select=select,
        )
        return await self._aget_one_team_oapg(
    ...
    def get_one_team(
        ...
        return self._get_one_team_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetOneTeam(BaseApi):
    ...
    async def aget_one_team(
        ...
        validate: bool = False,
        **kwargs,
    ) -> TeamGetOneResponseMappedPydantic:
        raw_response = await self.raw.aget_one_team(
            id=id,
            select=select,
            **kwargs,
        )
        if validate:
            return TeamGetOneResponseMappedPydantic(**raw_response.body)
        return api_client.construct_model_instance(TeamGetOneResponseMappedPydantic, raw_response.body)
    ...
    def get_one_team(
        ...
        raw_response = self.raw.get_one_team(
            id=id,
            select=select,
        )
        if validate:
