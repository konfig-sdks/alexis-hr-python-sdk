...
from alexis_hr_python_sdk.model.timesheet_entry_types_get_many_response_mapped import TimesheetEntryTypesGetManyResponseMapped as TimesheetEntryTypesGetManyResponseMappedSchema
...
from alexis_hr_python_sdk.type.timesheet_entry_types_get_many_response_mapped import TimesheetEntryTypesGetManyResponseMapped
...
from alexis_hr_python_sdk.pydantic.timesheet_entry_types_get_many_response_mapped import TimesheetEntryTypesGetManyResponseMapped as TimesheetEntryTypesGetManyResponseMappedPydantic
...
class FiltersSchema(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "name", "kind", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "name", "kind", ], str]):
        return super().get_item_oapg(name)
...
SchemaFor200ResponseBodyApplicationJson = TimesheetEntryTypesGetManyResponseMappedSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: TimesheetEntryTypesGetManyResponseMapped
...
class BaseApi(api_client.Api):
    ...
    def _list_many_timesheet_entry_types_mapped_args(
        self,
    ...
    async def _alist_many_timesheet_entry_types_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/timesheet-entry-type',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _list_many_timesheet_entry_types_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class ListManyTimesheetEntryTypesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_many_timesheet_entry_types(
        self,
        select: typing.Optional[typing.List[str]] = None,
        filters: typing.Optional[typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]]] = None,
        limit: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._list_many_timesheet_entry_types_mapped_args(
            select=select,
            filters=filters,
            limit=limit,
            offset=offset,
        ...
        return await self._alist_many_timesheet_entry_types_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def list_many_timesheet_entry_types(
        self,
        select: typing.Optional[typing.List[str]] = None,
        filters: typing.Optional[typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]]] = None,
        limit: typing.Optional[int] = None,
        ...
        return self._list_many_timesheet_entry_types_oapg(
            query_params=args.query,
        )

class ListManyTimesheetEntryTypes(BaseApi):
    ...
    async def alist_many_timesheet_entry_types(
        ...
        validate: bool = False,
        **kwargs,
    ) -> TimesheetEntryTypesGetManyResponseMappedPydantic:
        raw_response = await self.raw.alist_many_timesheet_entry_types(
            select=select,
            filters=filters,
            limit=limit,
            offset=offset,
        ...
        if validate:
            return TimesheetEntryTypesGetManyResponseMappedPydantic(**raw_response.body)
        return api_client.construct_model_instance(TimesheetEntryTypesGetManyResponseMappedPydantic, raw_response.body)
    ...
    def list_many_timesheet_entry_types(
        ...
        raw_response = self.raw.list_many_timesheet_entry_types(
            select=select,
            filters=filters,
            limit=limit,
            offset=offset,
