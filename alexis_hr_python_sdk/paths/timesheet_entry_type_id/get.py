...
from alexis_hr_python_sdk.model.timesheet_entry_type_get_one_response_mapped import TimesheetEntryTypeGetOneResponseMapped as TimesheetEntryTypeGetOneResponseMappedSchema
...
from alexis_hr_python_sdk.type.timesheet_entry_type_get_one_response_mapped import TimesheetEntryTypeGetOneResponseMapped
...
from alexis_hr_python_sdk.pydantic.timesheet_entry_type_get_one_response_mapped import TimesheetEntryTypeGetOneResponseMapped as TimesheetEntryTypeGetOneResponseMappedPydantic
...
SchemaFor200ResponseBodyApplicationJson = TimesheetEntryTypeGetOneResponseMappedSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: TimesheetEntryTypeGetOneResponseMapped
...
class BaseApi(api_client.Api):
    ...
    def _get_one_timesheet_entry_type_mapped_args(
        self,
        id: str,
    ...
    async def _aget_one_timesheet_entry_type_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/timesheet-entry-type/{id}',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_one_timesheet_entry_type_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetOneTimesheetEntryTypeRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_one_timesheet_entry_type(
        self,
        id: str,
        select: typing.Optional[typing.List[str]] = None,
        **kwargs,
        ...
        args = self._get_one_timesheet_entry_type_mapped_args(
            id=id,
            select=select,
        )
        return await self._aget_one_timesheet_entry_type_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_one_timesheet_entry_type(
        self,
        id: str,
        select: typing.Optional[typing.List[str]] = None,
    ) -> typing.Union[
        ...
        return self._get_one_timesheet_entry_type_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetOneTimesheetEntryType(BaseApi):
    ...
    async def aget_one_timesheet_entry_type(
        ...
        validate: bool = False,
        **kwargs,
    ) -> TimesheetEntryTypeGetOneResponseMappedPydantic:
        raw_response = await self.raw.aget_one_timesheet_entry_type(
            id=id,
            select=select,
            **kwargs,
        )
        if validate:
            return TimesheetEntryTypeGetOneResponseMappedPydantic(**raw_response.body)
        return api_client.construct_model_instance(TimesheetEntryTypeGetOneResponseMappedPydantic, raw_response.body)
    ...
    def get_one_timesheet_entry_type(
        ...
        raw_response = self.raw.get_one_timesheet_entry_type(
            id=id,
            select=select,
        )
        if validate:
