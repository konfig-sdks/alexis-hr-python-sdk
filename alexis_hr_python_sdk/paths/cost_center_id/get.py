...
from alexis_hr_python_sdk.model.cost_center_get_one_response_mapped import CostCenterGetOneResponseMapped as CostCenterGetOneResponseMappedSchema
...
from alexis_hr_python_sdk.type.cost_center_get_one_response_mapped import CostCenterGetOneResponseMapped

from ...api_client import Dictionary
from alexis_hr_python_sdk.pydantic.cost_center_get_one_response_mapped import CostCenterGetOneResponseMapped as CostCenterGetOneResponseMappedPydantic
...
SchemaFor200ResponseBodyApplicationJson = CostCenterGetOneResponseMappedSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: CostCenterGetOneResponseMapped
...
class BaseApi(api_client.Api):
    ...
    def _get_one_cost_center_mapped_args(
        self,
        id: str,
    ...
    async def _aget_one_cost_center_oapg(
        self,
...
class GetOneCostCenterRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_one_cost_center(
        self,
        id: str,
        select: typing.Optional[typing.List[str]] = None,
        **kwargs,
        ...
        args = self._get_one_cost_center_mapped_args(
            id=id,
            select=select,
        )
        return await self._aget_one_cost_center_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_one_cost_center(
        self,
        id: str,
        select: typing.Optional[typing.List[str]] = None,
    ) -> typing.Union[
        ...
        return self._get_one_cost_center_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetOneCostCenter(BaseApi):
    ...
    async def aget_one_cost_center(
        ...
        validate: bool = False,
        **kwargs,
    ) -> CostCenterGetOneResponseMappedPydantic:
        raw_response = await self.raw.aget_one_cost_center(
            id=id,
            select=select,
            **kwargs,
        )
        if validate:
            return CostCenterGetOneResponseMappedPydantic(**raw_response.body)
        return api_client.construct_model_instance(CostCenterGetOneResponseMappedPydantic, raw_response.body)
    ...
    def get_one_cost_center(
        ...
        raw_response = self.raw.get_one_cost_center(
            id=id,
            select=select,
        )
        if validate:
