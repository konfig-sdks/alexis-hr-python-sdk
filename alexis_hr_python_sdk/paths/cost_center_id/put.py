...
from alexis_hr_python_sdk.model.update_cost_center_request import UpdateCostCenterRequest as UpdateCostCenterRequestSchema
from alexis_hr_python_sdk.model.cost_center_response_mapped import CostCenterResponseMapped as CostCenterResponseMappedSchema
...
from alexis_hr_python_sdk.type.update_cost_center_request import UpdateCostCenterRequest
from alexis_hr_python_sdk.type.internal_server_error_response import InternalServerErrorResponse
from alexis_hr_python_sdk.type.cost_center_response_mapped import CostCenterResponseMapped
...
from alexis_hr_python_sdk.pydantic.cost_center_response_mapped import CostCenterResponseMapped as CostCenterResponseMappedPydantic
from alexis_hr_python_sdk.pydantic.update_cost_center_request import UpdateCostCenterRequest as UpdateCostCenterRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = UpdateCostCenterRequestSchema


request_body_update_cost_center_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = CostCenterResponseMappedSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: CostCenterResponseMapped
...
class BaseApi(api_client.Api):
    ...
    def _replace_one_cost_center_mapped_args(
        self,
        id: str,
    ...
    async def _areplace_one_cost_center_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/cost-center/{id}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_update_cost_center_request.serialize(body, content_type)
    ...
    def _replace_one_cost_center_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class ReplaceOneCostCenterRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def areplace_one_cost_center(
        self,
        id: str,
        code: typing.Optional[str] = None,
        name: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._replace_one_cost_center_mapped_args(
            id=id,
            code=code,
            name=name,
        )
        return await self._areplace_one_cost_center_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def replace_one_cost_center(
        self,
        id: str,
        code: typing.Optional[str] = None,
        name: typing.Optional[str] = None,
        ...
        return self._replace_one_cost_center_oapg(
            body=args.body,
            path_params=args.path,
        )

class ReplaceOneCostCenter(BaseApi):
    ...
    async def areplace_one_cost_center(
        ...
        validate: bool = False,
        **kwargs,
    ) -> CostCenterResponseMappedPydantic:
        raw_response = await self.raw.areplace_one_cost_center(
            id=id,
            code=code,
            name=name,
            **kwargs,
        ...
        if validate:
            return CostCenterResponseMappedPydantic(**raw_response.body)
        return api_client.construct_model_instance(CostCenterResponseMappedPydantic, raw_response.body)
    ...
    def replace_one_cost_center(
        ...
        raw_response = self.raw.replace_one_cost_center(
            id=id,
            code=code,
            name=name,
        )
