...
class BaseApi(api_client.Api):
    ...
    def _update_one_cost_center_mapped_args(
        self,
        id: str,
    ...
    async def _aupdate_one_cost_center_oapg(
        self,
    ...
    def _update_one_cost_center_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class UpdateOneCostCenterRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_one_cost_center(
        self,
        id: str,
        code: typing.Optional[str] = None,
        name: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._update_one_cost_center_mapped_args(
            id=id,
            code=code,
            name=name,
        )
        return await self._aupdate_one_cost_center_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def update_one_cost_center(
        self,
        id: str,
        code: typing.Optional[str] = None,
        name: typing.Optional[str] = None,
        ...
        return self._update_one_cost_center_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateOneCostCenter(BaseApi):
    ...
    async def aupdate_one_cost_center(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_one_cost_center(
            id=id,
            code=code,
            name=name,
            **kwargs,
    ...
    def update_one_cost_center(
        ...
        raw_response = self.raw.update_one_cost_center(
            id=id,
            code=code,
            name=name,
        )
