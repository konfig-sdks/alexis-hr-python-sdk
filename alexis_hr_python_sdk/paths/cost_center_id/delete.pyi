...
class BaseApi(api_client.Api):
    ...
    def _delete_one_cost_center_mapped_args(
        self,
        id: str,
    ...
    async def _adelete_one_cost_center_oapg(
        self,
    ...
    def _delete_one_cost_center_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class DeleteOneCostCenterRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_one_cost_center(
        self,
        id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._delete_one_cost_center_mapped_args(
            id=id,
        )
        return await self._adelete_one_cost_center_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def delete_one_cost_center(
        self,
        id: str,
    ) -> typing.Union[
        ApiResponseFor204,
        ...
        return self._delete_one_cost_center_oapg(
            path_params=args.path,
        )

class DeleteOneCostCenter(BaseApi):
    ...
    async def adelete_one_cost_center(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_one_cost_center(
            id=id,
            **kwargs,
        )
        if validate:
    ...
    def delete_one_cost_center(
        ...
        raw_response = self.raw.delete_one_cost_center(
            id=id,
        )
        if validate:
            return EmptyResponseMappedPydantic(**raw_response.body)
