...
from alexis_hr_python_sdk.model.employee_team_reference_get_one_response_mapped import EmployeeTeamReferenceGetOneResponseMapped as EmployeeTeamReferenceGetOneResponseMappedSchema
...
from alexis_hr_python_sdk.type.employee_team_reference_get_one_response_mapped import EmployeeTeamReferenceGetOneResponseMapped
...
from alexis_hr_python_sdk.pydantic.employee_team_reference_get_one_response_mapped import EmployeeTeamReferenceGetOneResponseMapped as EmployeeTeamReferenceGetOneResponseMappedPydantic
...
SchemaFor200ResponseBodyApplicationJson = EmployeeTeamReferenceGetOneResponseMappedSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: EmployeeTeamReferenceGetOneResponseMapped
...
class BaseApi(api_client.Api):
    ...
    def _get_one_employee_team_reference_mapped_args(
        self,
        id: str,
    ...
    async def _aget_one_employee_team_reference_oapg(
        self,
    ...
    def _get_one_employee_team_reference_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetOneEmployeeTeamReferenceRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_one_employee_team_reference(
        self,
        id: str,
        select: typing.Optional[typing.List[str]] = None,
        relations: typing.Optional[typing.List[str]] = None,
        **kwargs,
        ...
        args = self._get_one_employee_team_reference_mapped_args(
            id=id,
            select=select,
            relations=relations,
        )
        return await self._aget_one_employee_team_reference_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_one_employee_team_reference(
        self,
        id: str,
        select: typing.Optional[typing.List[str]] = None,
        relations: typing.Optional[typing.List[str]] = None,
        ...
        return self._get_one_employee_team_reference_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetOneEmployeeTeamReference(BaseApi):
    ...
    async def aget_one_employee_team_reference(
        ...
        validate: bool = False,
        **kwargs,
    ) -> EmployeeTeamReferenceGetOneResponseMappedPydantic:
        raw_response = await self.raw.aget_one_employee_team_reference(
            id=id,
            select=select,
            relations=relations,
            **kwargs,
        ...
        if validate:
            return EmployeeTeamReferenceGetOneResponseMappedPydantic(**raw_response.body)
        return api_client.construct_model_instance(EmployeeTeamReferenceGetOneResponseMappedPydantic, raw_response.body)
    ...
    def get_one_employee_team_reference(
        ...
        raw_response = self.raw.get_one_employee_team_reference(
            id=id,
            select=select,
            relations=relations,
        )
