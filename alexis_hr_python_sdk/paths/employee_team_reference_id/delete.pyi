...
class DeleteOneRaw(BaseApi):
    ...
    async def adelete_one(
        ...
        **kwargs,
        ...
        args = self._delete_one_mapped_args(
            id=id,
        )
        return await self._adelete_one_oapg(
    ...
    def delete_one(
        ...
        return self._delete_one_oapg(
            path_params=args.path,
        )

class DeleteOne(BaseApi):
    ...
    async def adelete_one(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_one(
            id=id,
            **kwargs,
        )
        if validate:
    ...
    def delete_one(
        ...
        raw_response = self.raw.delete_one(
            id=id,
        )
        if validate:
            return EmptyResponseMappedPydantic(**raw_response.body)
