...
class BaseApi(api_client.Api):
    ...
    def _delete_one_entry_mapped_args(
        self,
        id: str,
    ...
    async def _adelete_one_entry_oapg(
        self,
...
class DeleteOneEntryRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_one_entry(
        self,
        id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._delete_one_entry_mapped_args(
            id=id,
        )
        return await self._adelete_one_entry_oapg(
    ...
    def delete_one_entry(
        ...
        return self._delete_one_entry_oapg(
            path_params=args.path,
        )

class DeleteOneEntry(BaseApi):
    ...
    async def adelete_one_entry(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_one_entry(
            id=id,
            **kwargs,
        )
        if validate:
    ...
    def delete_one_entry(
        ...
        raw_response = self.raw.delete_one_entry(
            id=id,
        )
        if validate:
            return EmptyResponseMappedPydantic(**raw_response.body)
