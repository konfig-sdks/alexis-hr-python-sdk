...
from alexis_hr_python_sdk.model.update_timesheet_entry_request import UpdateTimesheetEntryRequest as UpdateTimesheetEntryRequestSchema
...
from alexis_hr_python_sdk.model.timesheet_entry_response_mapped import TimesheetEntryResponseMapped as TimesheetEntryResponseMappedSchema

from alexis_hr_python_sdk.type.update_timesheet_entry_request import UpdateTimesheetEntryRequest
from alexis_hr_python_sdk.type.timesheet_entry_response_mapped import TimesheetEntryResponseMapped
...
from alexis_hr_python_sdk.pydantic.timesheet_entry_response_mapped import TimesheetEntryResponseMapped as TimesheetEntryResponseMappedPydantic
...
from alexis_hr_python_sdk.pydantic.update_timesheet_entry_request import UpdateTimesheetEntryRequest as UpdateTimesheetEntryRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = UpdateTimesheetEntryRequestSchema


request_body_update_timesheet_entry_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = TimesheetEntryResponseMappedSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: TimesheetEntryResponseMapped
...
class BaseApi(api_client.Api):
    ...
    def _update_one_entry_0_mapped_args(
        self,
        id: str,
        type_id: typing.Optional[str] = None,
        employee_id: typing.Optional[str] = None,
        date: typing.Optional[datetime] = None,
        minutes: typing.Optional[typing.Union[int, float]] = None,
    ...
    async def _aupdate_one_entry_0_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/timesheet-entry/{id}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_update_timesheet_entry_request.serialize(body, content_type)
...
class UpdateOneEntry0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_one_entry_0(
        self,
        id: str,
        type_id: typing.Optional[str] = None,
        employee_id: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._update_one_entry_0_mapped_args(
            id=id,
            type_id=type_id,
        ...
        return await self._aupdate_one_entry_0_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def update_one_entry_0(
        self,
        id: str,
        type_id: typing.Optional[str] = None,
        employee_id: typing.Optional[str] = None,
        ...
        return self._update_one_entry_0_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateOneEntry0(BaseApi):
    ...
    async def aupdate_one_entry_0(
        ...
        validate: bool = False,
        **kwargs,
    ) -> TimesheetEntryResponseMappedPydantic:
        raw_response = await self.raw.aupdate_one_entry_0(
            id=id,
            type_id=type_id,
            employee_id=employee_id,
            date=date,
        ...
        if validate:
            return TimesheetEntryResponseMappedPydantic(**raw_response.body)
        return api_client.construct_model_instance(TimesheetEntryResponseMappedPydantic, raw_response.body)
    ...
    def update_one_entry_0(
        ...
        raw_response = self.raw.update_one_entry_0(
            id=id,
            type_id=type_id,
            employee_id=employee_id,
            date=date,
