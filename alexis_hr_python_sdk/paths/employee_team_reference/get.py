...
from alexis_hr_python_sdk.model.employee_team_references_get_many_response_mapped import EmployeeTeamReferencesGetManyResponseMapped as EmployeeTeamReferencesGetManyResponseMappedSchema

from alexis_hr_python_sdk.type.employee_team_references_get_many_response_mapped import EmployeeTeamReferencesGetManyResponseMapped
...
from alexis_hr_python_sdk.pydantic.employee_team_references_get_many_response_mapped import EmployeeTeamReferencesGetManyResponseMapped as EmployeeTeamReferencesGetManyResponseMappedPydantic
...
class FiltersSchema(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "companyId", "teamId", "userId", "employeeId", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "companyId", "teamId", "userId", "employeeId", ], str]):
        return super().get_item_oapg(name)
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        teamId: typing.Union[MetaOapg.properties.teamId, dict, frozendict.frozendict, schemas.Unset] = schemas.unset,
...
SchemaFor200ResponseBodyApplicationJson = EmployeeTeamReferencesGetManyResponseMappedSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: EmployeeTeamReferencesGetManyResponseMapped
...
class GetMany(BaseApi):
    ...
    async def aget_many(
        ...
        validate: bool = False,
        **kwargs,
    ) -> EmployeeTeamReferencesGetManyResponseMappedPydantic:
        ...
        if validate:
            return EmployeeTeamReferencesGetManyResponseMappedPydantic(**raw_response.body)
        return api_client.construct_model_instance(EmployeeTeamReferencesGetManyResponseMappedPydantic, raw_response.body)
