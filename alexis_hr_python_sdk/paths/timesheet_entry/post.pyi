...
from alexis_hr_python_sdk.model.create_timesheet_entry_request import CreateTimesheetEntryRequest as CreateTimesheetEntryRequestSchema
...
from alexis_hr_python_sdk.type.create_timesheet_entry_request import CreateTimesheetEntryRequest
...
from alexis_hr_python_sdk.pydantic.create_timesheet_entry_request import CreateTimesheetEntryRequest as CreateTimesheetEntryRequestPydantic

# body param
SchemaForRequestBodyApplicationJson = CreateTimesheetEntryRequestSchema


request_body_create_timesheet_entry_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = TimesheetEntryResponseMappedSchema
...
class BaseApi(api_client.Api):
    ...
    def _create_one_entry_mapped_args(
        self,
        type_id: str,
        employee_id: str,
        date: datetime,
    ...
    async def _acreate_one_entry_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_create_timesheet_entry_request.serialize(body, content_type)
...
class CreateOneEntryRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_one_entry(
        self,
        type_id: str,
        employee_id: str,
        date: datetime,
        ...
        **kwargs,
        ...
        args = self._create_one_entry_mapped_args(
            type_id=type_id,
        ...
        return await self._acreate_one_entry_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def create_one_entry(
        ...
        return self._create_one_entry_oapg(
            body=args.body,
        )

class CreateOneEntry(BaseApi):
    ...
    async def acreate_one_entry(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_one_entry(
            type_id=type_id,
            employee_id=employee_id,
            date=date,
            minutes=minutes,
    ...
    def create_one_entry(
        ...
        raw_response = self.raw.create_one_entry(
            type_id=type_id,
            employee_id=employee_id,
            date=date,
            minutes=minutes,
