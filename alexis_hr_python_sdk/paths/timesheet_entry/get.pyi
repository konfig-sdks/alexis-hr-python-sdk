...
from alexis_hr_python_sdk.model.timesheet_entries_get_many_response_mapped import TimesheetEntriesGetManyResponseMapped as TimesheetEntriesGetManyResponseMappedSchema
...
from alexis_hr_python_sdk.type.timesheet_entries_get_many_response_mapped import TimesheetEntriesGetManyResponseMapped
...
from alexis_hr_python_sdk.pydantic.timesheet_entries_get_many_response_mapped import TimesheetEntriesGetManyResponseMapped as TimesheetEntriesGetManyResponseMappedPydantic
...
class SelectSchema(
    ...
    class MetaOapg:
        ...
        class items(
            ...
            @schemas.classproperty
            def TIMESHEET_ID(cls):
                return cls("timesheetId")
...
class FiltersSchema(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "timesheetId", "typeId", "employeeId", "date", "updated", "status", "minutes", "note", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "timesheetId", "typeId", "employeeId", "date", "updated", "status", "minutes", "note", ], str]):
        return super().get_item_oapg(name)
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        timesheetId: typing.Union[MetaOapg.properties.timesheetId, dict, frozendict.frozendict, schemas.Unset] = schemas.unset,
...
class SortSchema(
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        minutes: typing.Union[MetaOapg.properties.minutes, str, schemas.Unset] = schemas.unset,
...
SchemaFor200ResponseBodyApplicationJson = TimesheetEntriesGetManyResponseMappedSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: TimesheetEntriesGetManyResponseMapped
...
class BaseApi(api_client.Api):
    ...
    def _list_many_entries_mapped_args(
        self,
    ...
    async def _alist_many_entries_oapg(
        self,
...
class ListManyEntriesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_many_entries(
        self,
        select: typing.Optional[typing.List[str]] = None,
        relations: typing.Optional[typing.List[str]] = None,
        filters: typing.Optional[typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]]] = None,
        ...
        **kwargs,
        ...
        args = self._list_many_entries_mapped_args(
            select=select,
            relations=relations,
            filters=filters,
            limit=limit,
        ...
        return await self._alist_many_entries_oapg(
    ...
    def list_many_entries(
        ...
        return self._list_many_entries_oapg(
            query_params=args.query,
        )

class ListManyEntries(BaseApi):
    ...
    async def alist_many_entries(
        ...
        validate: bool = False,
        **kwargs,
    ) -> TimesheetEntriesGetManyResponseMappedPydantic:
        raw_response = await self.raw.alist_many_entries(
            select=select,
            relations=relations,
            filters=filters,
            limit=limit,
        ...
        if validate:
            return TimesheetEntriesGetManyResponseMappedPydantic(**raw_response.body)
        return api_client.construct_model_instance(TimesheetEntriesGetManyResponseMappedPydantic, raw_response.body)
    ...
    def list_many_entries(
        ...
        raw_response = self.raw.list_many_entries(
            select=select,
            relations=relations,
            filters=filters,
            limit=limit,
