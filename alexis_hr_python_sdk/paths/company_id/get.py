...
from alexis_hr_python_sdk.model.company_get_one_response_mapped import CompanyGetOneResponseMapped as CompanyGetOneResponseMappedSchema
...
from alexis_hr_python_sdk.type.company_get_one_response_mapped import CompanyGetOneResponseMapped
...
from alexis_hr_python_sdk.pydantic.company_get_one_response_mapped import CompanyGetOneResponseMapped as CompanyGetOneResponseMappedPydantic
...
SchemaFor200ResponseBodyApplicationJson = CompanyGetOneResponseMappedSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: CompanyGetOneResponseMapped
...
class GetOne(BaseApi):
    ...
    async def aget_one(
        ...
        validate: bool = False,
        **kwargs,
    ) -> CompanyGetOneResponseMappedPydantic:
        ...
        if validate:
            return CompanyGetOneResponseMappedPydantic(**raw_response.body)
        return api_client.construct_model_instance(CompanyGetOneResponseMappedPydantic, raw_response.body)
