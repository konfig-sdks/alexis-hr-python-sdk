...
from alexis_hr_python_sdk.model.leave_transaction_get_one_response_mapped import LeaveTransactionGetOneResponseMapped as LeaveTransactionGetOneResponseMappedSchema
...
from alexis_hr_python_sdk.type.leave_transaction_get_one_response_mapped import LeaveTransactionGetOneResponseMapped
...
from alexis_hr_python_sdk.pydantic.leave_transaction_get_one_response_mapped import LeaveTransactionGetOneResponseMapped as LeaveTransactionGetOneResponseMappedPydantic
...
SchemaFor200ResponseBodyApplicationJson = LeaveTransactionGetOneResponseMappedSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: LeaveTransactionGetOneResponseMapped
...
class BaseApi(api_client.Api):
    ...
    def _get_one_leave_transaction_mapped_args(
        self,
        id: str,
    ...
    async def _aget_one_leave_transaction_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/leave-transaction/{id}',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_one_leave_transaction_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetOneLeaveTransactionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_one_leave_transaction(
        self,
        id: str,
        select: typing.Optional[typing.List[str]] = None,
        relations: typing.Optional[typing.List[str]] = None,
        **kwargs,
        ...
        args = self._get_one_leave_transaction_mapped_args(
            id=id,
            select=select,
            relations=relations,
        )
        return await self._aget_one_leave_transaction_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_one_leave_transaction(
        self,
        id: str,
        select: typing.Optional[typing.List[str]] = None,
        relations: typing.Optional[typing.List[str]] = None,
        ...
        return self._get_one_leave_transaction_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetOneLeaveTransaction(BaseApi):
    ...
    async def aget_one_leave_transaction(
        ...
        validate: bool = False,
        **kwargs,
    ) -> LeaveTransactionGetOneResponseMappedPydantic:
        raw_response = await self.raw.aget_one_leave_transaction(
            id=id,
            select=select,
            relations=relations,
            **kwargs,
        ...
        if validate:
            return LeaveTransactionGetOneResponseMappedPydantic(**raw_response.body)
        return api_client.construct_model_instance(LeaveTransactionGetOneResponseMappedPydantic, raw_response.body)
    ...
    def get_one_leave_transaction(
        ...
        raw_response = self.raw.get_one_leave_transaction(
            id=id,
            select=select,
            relations=relations,
        )
