...
from alexis_hr_python_sdk.pydantic.bank_account_response import BankAccountResponse
from alexis_hr_python_sdk.pydantic.employee_tax_response import EmployeeTaxResponse
from alexis_hr_python_sdk.pydantic.home_address_response import HomeAddressResponse
...
class EmployeeResponse(BaseModel):
    ...
    manager_employee_id: typing.Optional[str] = Field(None, alias='managerEmployeeId')

    department_id: typing.Optional[str] = Field(None, alias='departmentId')

    cost_center_id: typing.Optional[str] = Field(None, alias='costCenterId')

    employment_id: typing.Optional[str] = Field(None, alias='employmentId')

    employment_type_id: typing.Optional[str] = Field(None, alias='employmentTypeId')

    employment_country: typing.Optional[str] = Field(None, alias='employmentCountry')

    compensation_id: typing.Optional[str] = Field(None, alias='compensationId')
    ...
    tax: typing.Optional[EmployeeTaxResponse] = Field(None, alias='tax')

    work_email: typing.Optional[str] = Field(None, alias='workEmail')

    work_phone: typing.Optional[str] = Field(None, alias='workPhone')

    work_phone_sanitized: typing.Optional[str] = Field(None, alias='workPhoneSanitized')

    hire_date: typing.Optional[datetime] = Field(None, alias='hireDate')

    end_date: typing.Optional[datetime] = Field(None, alias='endDate')

    has_occupational_pension: typing.Optional[bool] = Field(None, alias='hasOccupationalPension')

    private_email: typing.Optional[str] = Field(None, alias='privateEmail')
    ...
    private_phone: typing.Optional[str] = Field(None, alias='privatePhone')

    private_phone_sanitized: typing.Optional[str] = Field(None, alias='privatePhoneSanitized')
    ...
    pronoun: typing.Optional[str] = Field(None, alias='pronoun')

    bank_account: typing.Optional[BankAccountResponse] = Field(None, alias='bankAccount')

    home_address: typing.Optional[HomeAddressResponse] = Field(None, alias='homeAddress')

    custom: typing.Optional[typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]]] = Field(None, alias='custom')
