...
from alexis_hr_python_sdk.pydantic.point_response_coordinates import PointResponseCoordinates

class PointResponse(BaseModel):
    type: str = Field(alias='type')

    coordinates: PointResponseCoordinates = Field(alias='coordinates')
