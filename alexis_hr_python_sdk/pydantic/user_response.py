...
class UserResponse(BaseModel):
    # User ID
    id: typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]] = Field(alias='id')

    # locale
    locale: typing.Optional[str] = Field(None, alias='locale')

    system_role: typing.Optional[Literal["admin", "anonymous"]] = Field(None, alias='systemRole')
