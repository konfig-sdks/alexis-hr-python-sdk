...
from alexis_hr_python_sdk.pydantic.employee_get_many_relations_response import EmployeeGetManyRelationsResponse
from alexis_hr_python_sdk.pydantic.employee_response import EmployeeResponse

class EmployeesGetManyResponseMapped(BaseModel):
    # Status String
    status: str = Field(alias='status')

    # Resource data
    data: typing.List[EmployeeResponse] = Field(alias='data')
    ...
    # Resource relations
    relations: typing.Optional[EmployeeGetManyRelationsResponse] = Field(None, alias='relations')
