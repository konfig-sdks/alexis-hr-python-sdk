...
from alexis_hr_python_sdk.pydantic.timesheet_entry_relations_response import TimesheetEntryRelationsResponse
from alexis_hr_python_sdk.pydantic.timesheet_entry_response import TimesheetEntryResponse

class TimesheetEntriesGetManyResponseMapped(BaseModel):
    # Status String
    status: str = Field(alias='status')

    # Resource data
    data: typing.List[TimesheetEntryResponse] = Field(alias='data')
    ...
    # Resource relations
    relations: typing.Optional[TimesheetEntryRelationsResponse] = Field(None, alias='relations')
