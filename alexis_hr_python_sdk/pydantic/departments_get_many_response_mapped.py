...
from alexis_hr_python_sdk.pydantic.department_relations_response import DepartmentRelationsResponse
from alexis_hr_python_sdk.pydantic.department_response import DepartmentResponse

class DepartmentsGetManyResponseMapped(BaseModel):
    # Status String
    status: str = Field(alias='status')

    # Resource data
    data: typing.List[DepartmentResponse] = Field(alias='data')
    ...
    # Resource relations
    relations: typing.Optional[DepartmentRelationsResponse] = Field(None, alias='relations')
