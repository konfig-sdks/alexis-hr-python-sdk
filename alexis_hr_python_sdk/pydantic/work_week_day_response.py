...
from alexis_hr_python_sdk.pydantic.work_shift_response import WorkShiftResponse

class WorkWeekDayResponse(BaseModel):
    working: bool = Field(alias='working')

    duration: typing.Union[int, float] = Field(alias='duration')

    shifts: typing.List[WorkShiftResponse] = Field(alias='shifts')
