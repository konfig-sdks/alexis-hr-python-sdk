...
from alexis_hr_python_sdk.pydantic.employee_get_one_relations_response import EmployeeGetOneRelationsResponse
from alexis_hr_python_sdk.pydantic.employee_response import EmployeeResponse

class EmployeeGetOneResponseMapped(BaseModel):
    # Status String
    status: str = Field(alias='status')

    # Resource data
    data: EmployeeResponse = Field(alias='data')

    # Resource relations
    relations: typing.Optional[EmployeeGetOneRelationsResponse] = Field(None, alias='relations')
