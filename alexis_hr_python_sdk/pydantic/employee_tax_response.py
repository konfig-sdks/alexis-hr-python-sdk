...
class EmployeeTaxResponse(BaseModel):
    table: typing.Optional[typing.Union[int, float]] = Field(None, alias='table')

    column: typing.Optional[typing.Union[int, float]] = Field(None, alias='column')
