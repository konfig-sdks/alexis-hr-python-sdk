...
from alexis_hr_python_sdk.pydantic.timesheet_relations_response import TimesheetRelationsResponse
from alexis_hr_python_sdk.pydantic.timesheet_response import TimesheetResponse

class TimesheetsGetManyResponseMapped(BaseModel):
    # Status String
    status: str = Field(alias='status')

    # Resource data
    data: typing.List[TimesheetResponse] = Field(alias='data')
    ...
    # Resource relations
    relations: typing.Optional[TimesheetRelationsResponse] = Field(None, alias='relations')
