...
from alexis_hr_python_sdk.pydantic.leave_type_response import LeaveTypeResponse

class LeaveTransactionRelationsResponse(BaseModel):
    child: typing.Optional[typing.List[ChildResponse]] = Field(None, alias='child')

    leave_type: typing.Optional[typing.List[LeaveTypeResponse]] = Field(None, alias='leaveType')
