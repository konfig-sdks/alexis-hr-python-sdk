...
from alexis_hr_python_sdk.pydantic.work_week_relations_response import WorkWeekRelationsResponse
from alexis_hr_python_sdk.pydantic.work_week_response import WorkWeekResponse

class WorkWeeksGetManyResponseMapped(BaseModel):
    # Status String
    status: str = Field(alias='status')

    # Resource data
    data: typing.List[WorkWeekResponse] = Field(alias='data')
    ...
    # Resource relations
    relations: typing.Optional[WorkWeekRelationsResponse] = Field(None, alias='relations')
