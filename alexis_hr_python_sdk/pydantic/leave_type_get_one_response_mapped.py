...
from alexis_hr_python_sdk.pydantic.leave_type_get_one_relation_response import LeaveTypeGetOneRelationResponse
from alexis_hr_python_sdk.pydantic.leave_type_response import LeaveTypeResponse

class LeaveTypeGetOneResponseMapped(BaseModel):
    # Status String
    status: str = Field(alias='status')

    # Resource data
    data: LeaveTypeResponse = Field(alias='data')

    # Resource relations
    relations: typing.Optional[LeaveTypeGetOneRelationResponse] = Field(None, alias='relations')
