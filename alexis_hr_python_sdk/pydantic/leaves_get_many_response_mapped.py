...
from alexis_hr_python_sdk.pydantic.leave_relations_response import LeaveRelationsResponse
from alexis_hr_python_sdk.pydantic.leave_response import LeaveResponse

class LeavesGetManyResponseMapped(BaseModel):
    # Status String
    status: str = Field(alias='status')

    # Resource data
    data: typing.List[LeaveResponse] = Field(alias='data')
    ...
    # Resource relations
    relations: typing.Optional[LeaveRelationsResponse] = Field(None, alias='relations')
