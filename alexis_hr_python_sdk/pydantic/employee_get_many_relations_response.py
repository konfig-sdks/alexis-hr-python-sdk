...
from alexis_hr_python_sdk.pydantic.child_response import ChildResponse
from alexis_hr_python_sdk.pydantic.compensation_response import CompensationResponse
from alexis_hr_python_sdk.pydantic.cost_center_response import CostCenterResponse
from alexis_hr_python_sdk.pydantic.department_response import DepartmentResponse
from alexis_hr_python_sdk.pydantic.emergency_contact_response import EmergencyContactResponse
from alexis_hr_python_sdk.pydantic.employee_response import EmployeeResponse
from alexis_hr_python_sdk.pydantic.employee_team_reference_response import EmployeeTeamReferenceResponse
from alexis_hr_python_sdk.pydantic.employment_response import EmploymentResponse
from alexis_hr_python_sdk.pydantic.employment_type_response import EmploymentTypeResponse
from alexis_hr_python_sdk.pydantic.office_response import OfficeResponse

class EmployeeGetManyRelationsResponse(BaseModel):
    office: typing.Optional[typing.List[OfficeResponse]] = Field(None, alias='office')

    cost_center: typing.Optional[typing.List[CostCenterResponse]] = Field(None, alias='costCenter')

    effective_cost_center: typing.Optional[typing.List[CostCenterResponse]] = Field(None, alias='effectiveCostCenter')

    child: typing.Optional[typing.List[ChildResponse]] = Field(None, alias='child')

    department: typing.Optional[typing.List[DepartmentResponse]] = Field(None, alias='department')

    emergency_contact: typing.Optional[typing.List[EmergencyContactResponse]] = Field(None, alias='emergencyContact')

    employment: typing.Optional[typing.List[EmploymentResponse]] = Field(None, alias='employment')

    employment_type: typing.Optional[typing.List[EmploymentTypeResponse]] = Field(None, alias='employmentType')

    compensation: typing.Optional[typing.List[CompensationResponse]] = Field(None, alias='compensation')

    manager_employee: typing.Optional[typing.List[EmployeeResponse]] = Field(None, alias='managerEmployee')

    team_reference: typing.Optional[typing.List[EmployeeTeamReferenceResponse]] = Field(None, alias='teamReference')
