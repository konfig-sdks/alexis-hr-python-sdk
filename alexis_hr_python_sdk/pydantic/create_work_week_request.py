...
from alexis_hr_python_sdk.pydantic.work_week_day_request import WorkWeekDayRequest

class CreateWorkWeekRequest(BaseModel):
    ...
    monday: WorkWeekDayRequest = Field(alias='monday')

    tuesday: WorkWeekDayRequest = Field(alias='tuesday')

    wednesday: WorkWeekDayRequest = Field(alias='wednesday')

    thursday: WorkWeekDayRequest = Field(alias='thursday')

    friday: WorkWeekDayRequest = Field(alias='friday')

    saturday: WorkWeekDayRequest = Field(alias='saturday')

    sunday: WorkWeekDayRequest = Field(alias='sunday')
