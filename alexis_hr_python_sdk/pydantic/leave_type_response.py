...
class LeaveTypeResponse(BaseModel):
    ...
    kind: Literal["SICK_LEAVE", "PARENTAL_LEAVE", "VACATION", "OFF_DUTY", "CHILDCARE"] = Field(alias='kind')

    minimum_duration: Literal["DAY", "HALF_DAY", "HOUR", "MINUTE"] = Field(alias='minimumDuration')

    deductible: bool = Field(alias='deductible')

    paid: bool = Field(alias='paid')

    disabled: bool = Field(alias='disabled')

    archived: typing.Optional[typing.Optional[bool]] = Field(None, alias='archived')
