...
class WorkShiftRequest(BaseModel):
    start_hour: typing.Union[int, float] = Field(alias='startHour')

    start_minute: typing.Union[int, float] = Field(alias='startMinute')

    end_hour: typing.Union[int, float] = Field(alias='endHour')

    end_minute: typing.Union[int, float] = Field(alias='endMinute')
