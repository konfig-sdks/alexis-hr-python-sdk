...
from alexis_hr_python_sdk.pydantic.employment_relations_response import EmploymentRelationsResponse
from alexis_hr_python_sdk.pydantic.employment_response import EmploymentResponse

class EmploymentsGetManyResponseMapped(BaseModel):
    # Status String
    status: str = Field(alias='status')

    # Resource data
    data: typing.List[EmploymentResponse] = Field(alias='data')
    ...
    # Resource relations
    relations: typing.Optional[EmploymentRelationsResponse] = Field(None, alias='relations')
