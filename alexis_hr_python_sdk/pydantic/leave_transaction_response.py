...
from alexis_hr_python_sdk.pydantic.leave_transaction_parent_response import LeaveTransactionParentResponse
...
class LeaveTransactionResponse(BaseModel):
    ...
    parent: LeaveTransactionParentResponse = Field(alias='parent')

    status: Literal["APPROVED", "CONFIRMED"] = Field(alias='status')
