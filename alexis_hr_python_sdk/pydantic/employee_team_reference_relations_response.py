...
from alexis_hr_python_sdk.pydantic.employee_team_reference_relations_response_employee import EmployeeTeamReferenceRelationsResponseEmployee
from alexis_hr_python_sdk.pydantic.team_response import TeamResponse
from alexis_hr_python_sdk.pydantic.user_response import UserResponse

class EmployeeTeamReferenceRelationsResponse(BaseModel):
    employee: typing.Optional[EmployeeTeamReferenceRelationsResponseEmployee] = Field(None, alias='employee')

    team: typing.Optional[typing.List[TeamResponse]] = Field(None, alias='team')

    user: typing.Optional[typing.List[UserResponse]] = Field(None, alias='user')
