...
class CompanyResponse(BaseModel):
    ...
    org_number: typing.Optional[str] = Field(None, alias='orgNumber')

    billable_users: typing.Optional[typing.Union[int, float]] = Field(None, alias='billableUsers')

    vat_number: typing.Optional[str] = Field(None, alias='vatNumber')
    ...
    background_url: typing.Optional[str] = Field(None, alias='backgroundUrl')

    offboard_date: typing.Optional[str] = Field(None, alias='offboardDate')
