...
from alexis_hr_python_sdk.pydantic.point_response import PointResponse

class HomeAddressResponse(BaseModel):
    ...
    location: typing.Optional[PointResponse] = Field(None, alias='location')
