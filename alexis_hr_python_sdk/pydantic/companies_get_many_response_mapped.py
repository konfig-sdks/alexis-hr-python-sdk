...
from alexis_hr_python_sdk.pydantic.company_response import CompanyResponse

class CompaniesGetManyResponseMapped(BaseModel):
    # Status String
    status: str = Field(alias='status')

    # Resource data
    data: typing.List[CompanyResponse] = Field(alias='data')
