...
from alexis_hr_python_sdk.pydantic.timesheet_entry_type_response import TimesheetEntryTypeResponse
from alexis_hr_python_sdk.pydantic.timesheet_response import TimesheetResponse

class TimesheetEntryRelationsResponse(BaseModel):
    employee: typing.Optional[typing.List[EmployeeResponse]] = Field(None, alias='employee')

    timesheet: typing.Optional[typing.List[TimesheetResponse]] = Field(None, alias='timesheet')

    type: typing.Optional[typing.List[TimesheetEntryTypeResponse]] = Field(None, alias='type')
