...
class CreateLeaveRequest(BaseModel):
    ...
    duration: Literal["minutes", "half_day", "one_day", "longer"] = Field(alias='duration')
    ...
    child_id: typing.Optional[str] = Field(None, alias='childId')

    extent: typing.Optional[typing.Union[int, float]] = Field(None, alias='extent')

    morning: typing.Optional[typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]]] = Field(None, alias='morning')

    afternoon: typing.Optional[typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]]] = Field(None, alias='afternoon')
