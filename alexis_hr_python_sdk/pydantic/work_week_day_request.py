...
from alexis_hr_python_sdk.pydantic.work_shift_request import WorkShiftRequest

class WorkWeekDayRequest(BaseModel):
    working: bool = Field(alias='working')

    duration: typing.Union[int, float] = Field(alias='duration')

    shifts: typing.List[WorkShiftRequest] = Field(alias='shifts')
