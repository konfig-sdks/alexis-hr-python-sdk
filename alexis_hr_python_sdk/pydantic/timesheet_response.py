...
class TimesheetResponse(BaseModel):
    ...
    status: Literal["PENDING", "SUBMITTED", "APPROVED", "REJECTED"] = Field(alias='status')

    start_date: datetime = Field(alias='startDate')

    end_date: datetime = Field(alias='endDate')

    local_cut_off_date: datetime = Field(alias='localCutOffDate')

    utc_cut_off_date: datetime = Field(alias='utcCutOffDate')

    approval_deadline_date: datetime = Field(alias='approvalDeadlineDate')

    interval: Literal["WEEKLY", "MONTHLY"] = Field(alias='interval')

    approver_employee_id: str = Field(alias='approverEmployeeId')

    employee_id: str = Field(alias='employeeId')

    submit_date: datetime = Field(alias='submitDate')

    approval_date: datetime = Field(alias='approvalDate')

    rejected_date: datetime = Field(alias='rejectedDate')
