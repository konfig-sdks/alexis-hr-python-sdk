...
from alexis_hr_python_sdk.pydantic.leave_transaction_relations_response import LeaveTransactionRelationsResponse
from alexis_hr_python_sdk.pydantic.leave_transaction_response import LeaveTransactionResponse

class LeaveTransactionsGetManyResponseMapped(BaseModel):
    # Status String
    status: str = Field(alias='status')

    # Resource data
    data: typing.List[LeaveTransactionResponse] = Field(alias='data')
    ...
    # Resource relations
    relations: typing.Optional[LeaveTransactionRelationsResponse] = Field(None, alias='relations')
