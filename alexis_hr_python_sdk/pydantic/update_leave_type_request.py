...
class UpdateLeaveTypeRequest(BaseModel):
    ...
    minimum_duration: typing.Optional[str] = Field(None, alias='minimumDuration')

    deductible: typing.Optional[bool] = Field(None, alias='deductible')

    paid: typing.Optional[bool] = Field(None, alias='paid')
