...
from alexis_hr_python_sdk.pydantic.employee_team_reference_relations_response import EmployeeTeamReferenceRelationsResponse
from alexis_hr_python_sdk.pydantic.employee_team_reference_response import EmployeeTeamReferenceResponse

class EmployeeTeamReferencesGetManyResponseMapped(BaseModel):
    # Status String
    status: str = Field(alias='status')

    # Resource data
    data: typing.List[EmployeeTeamReferenceResponse] = Field(alias='data')

    # Number of all resources
    total: typing.Union[int, float] = Field(alias='total')

    # Number of received resources
    count: typing.Union[int, float] = Field(alias='count')

    # Offset amount of received resources
    offset: typing.Optional[typing.Union[int, float]] = Field(None, alias='offset')

    # Resource relations
    relations: typing.Optional[EmployeeTeamReferenceRelationsResponse] = Field(None, alias='relations')
