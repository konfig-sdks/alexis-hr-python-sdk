...
from alexis_hr_python_sdk.pydantic.work_week_day_response import WorkWeekDayResponse

class WorkWeekResponse(BaseModel):
    ...
    monday: WorkWeekDayResponse = Field(alias='monday')

    tuesday: WorkWeekDayResponse = Field(alias='tuesday')

    wednesday: WorkWeekDayResponse = Field(alias='wednesday')

    thursday: WorkWeekDayResponse = Field(alias='thursday')

    friday: WorkWeekDayResponse = Field(alias='friday')

    saturday: WorkWeekDayResponse = Field(alias='saturday')

    sunday: WorkWeekDayResponse = Field(alias='sunday')

    office_id: typing.Optional[str] = Field(None, alias='officeId')

    employee_id: typing.Optional[str] = Field(None, alias='employeeId')

    effective_to: typing.Optional[datetime] = Field(None, alias='effectiveTo')
