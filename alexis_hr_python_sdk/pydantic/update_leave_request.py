...
class UpdateLeaveRequest(BaseModel):
    extent: typing.Union[int, float] = Field(alias='extent')

    description: typing.Optional[str] = Field(None, alias='description')

    child_id: typing.Optional[str] = Field(None, alias='childId')

    duration: typing.Optional[Literal["minutes", "half_day", "one_day", "longer"]] = Field(None, alias='duration')

    start_date: typing.Optional[datetime] = Field(None, alias='startDate')

    end_date: typing.Optional[datetime] = Field(None, alias='endDate')

    morning: typing.Optional[bool] = Field(None, alias='morning')

    afternoon: typing.Optional[bool] = Field(None, alias='afternoon')
