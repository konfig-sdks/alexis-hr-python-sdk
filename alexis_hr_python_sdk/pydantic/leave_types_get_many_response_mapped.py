...
from alexis_hr_python_sdk.pydantic.leave_type_get_many_relations_response import LeaveTypeGetManyRelationsResponse
from alexis_hr_python_sdk.pydantic.leave_type_response import LeaveTypeResponse

class LeaveTypesGetManyResponseMapped(BaseModel):
    # Status String
    status: str = Field(alias='status')

    # Resource data
    data: typing.List[LeaveTypeResponse] = Field(alias='data')
    ...
    # Resource relations
    relations: typing.Optional[LeaveTypeGetManyRelationsResponse] = Field(None, alias='relations')
