...
from alexis_hr_python_sdk.client_custom import ClientCustom
from alexis_hr_python_sdk.configuration import Configuration
from alexis_hr_python_sdk.api_client import ApiClient
from alexis_hr_python_sdk.type_util import copy_signature
...
class AlexisHr(ClientCustom):
    ...
    def __init__(self, configuration: typing.Union[Configuration, None] = None, **kwargs):
        ...
        self.child: ChildApi = ChildApi(api_client)
        ...
        self.employee_team_reference: EmployeeTeamReferenceApi = EmployeeTeamReferenceApi(api_client)
        self.employment: EmploymentApi = EmploymentApi(api_client)
        self.employment_type: EmploymentTypeApi = EmploymentTypeApi(api_client)
        self.leave: LeaveApi = LeaveApi(api_client)
        self.leave_transaction: LeaveTransactionApi = LeaveTransactionApi(api_client)
        self.leave_type: LeaveTypeApi = LeaveTypeApi(api_client)
        self.office: OfficeApi = OfficeApi(api_client)
        self.team: TeamApi = TeamApi(api_client)
        self.timesheet: TimesheetApi = TimesheetApi(api_client)
        self.timesheet_entry: TimesheetEntryApi = TimesheetEntryApi(api_client)
        self.timesheet_entry_type: TimesheetEntryTypeApi = TimesheetEntryTypeApi(api_client)
        self.work_week: WorkWeekApi = WorkWeekApi(api_client)
