...
from alexis_hr_python_sdk.paths.compensation.post import CreateOneCompensationRaw
from alexis_hr_python_sdk.paths.compensation_id.delete import DeleteOneRaw
from alexis_hr_python_sdk.paths.compensation.get import GetManyCompensationsRaw
from alexis_hr_python_sdk.paths.compensation_id.get import GetOneRaw
from alexis_hr_python_sdk.paths.compensation_id.put import ReplaceOneCompensationRaw
from alexis_hr_python_sdk.paths.compensation_id.patch import UpdateOneRaw


class CompensationApiRaw(
    CreateOneCompensationRaw,
    DeleteOneRaw,
    GetManyCompensationsRaw,
    GetOneRaw,
    ReplaceOneCompensationRaw,
    UpdateOneRaw,
):
    """NOTE:
