...
from alexis_hr_python_sdk.paths.employee_team_reference.post import CreateOneEmployeeTeamReferenceRaw
from alexis_hr_python_sdk.paths.employee_team_reference_id.delete import DeleteOneRaw
from alexis_hr_python_sdk.paths.employee_team_reference.get import GetManyRaw
from alexis_hr_python_sdk.paths.employee_team_reference_id.get import GetOneEmployeeTeamReferenceRaw
from alexis_hr_python_sdk.paths.employee_team_reference_id.put import ReplaceOneRaw
from alexis_hr_python_sdk.paths.employee_team_reference_id.patch import UpdateOneEmployeeTeamReferenceRaw


class EmployeeTeamReferenceApiRaw(
    CreateOneEmployeeTeamReferenceRaw,
    DeleteOneRaw,
    GetManyRaw,
    GetOneEmployeeTeamReferenceRaw,
    ReplaceOneRaw,
    UpdateOneEmployeeTeamReferenceRaw,
):
    """NOTE:
