...
from alexis_hr_python_sdk.paths.work_week.post import CreateOneWorkweekRaw
from alexis_hr_python_sdk.paths.work_week_id.delete import DeleteOneRaw
from alexis_hr_python_sdk.paths.work_week.get import GetManyRaw
from alexis_hr_python_sdk.paths.work_week_id.get import GetOneRaw
from alexis_hr_python_sdk.paths.work_week_id.put import ReplaceOneRaw
from alexis_hr_python_sdk.paths.work_week_id.patch import UpdateOneRaw


class WorkWeekApiRaw(
    CreateOneWorkweekRaw,
    DeleteOneRaw,
    GetManyRaw,
    GetOneRaw,
    ReplaceOneRaw,
