...
from alexis_hr_python_sdk.paths.cost_center.post import CreateOneCostCenterRaw
from alexis_hr_python_sdk.paths.cost_center_id.delete import DeleteOneCostCenterRaw
from alexis_hr_python_sdk.paths.cost_center.get import GetManyRaw
from alexis_hr_python_sdk.paths.cost_center_id.get import GetOneCostCenterRaw
from alexis_hr_python_sdk.paths.cost_center_id.put import ReplaceOneCostCenterRaw
from alexis_hr_python_sdk.paths.cost_center_id.patch import UpdateOneCostCenterRaw


class CostCenterApiRaw(
    CreateOneCostCenterRaw,
    DeleteOneCostCenterRaw,
    GetManyRaw,
    GetOneCostCenterRaw,
    ReplaceOneCostCenterRaw,
    UpdateOneCostCenterRaw,
):
    """NOTE:
