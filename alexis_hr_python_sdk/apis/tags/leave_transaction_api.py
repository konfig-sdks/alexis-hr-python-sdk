...
from alexis_hr_python_sdk.paths.leave_transaction_id.get import GetOneLeaveTransaction
from alexis_hr_python_sdk.paths.leave_transaction.get import ListManyTransactions
from alexis_hr_python_sdk.apis.tags.leave_transaction_api_raw import LeaveTransactionApiRaw


class LeaveTransactionApi(
    ...
    """
    raw: LeaveTransactionApiRaw

    def __init__(self, api_client=None):
        super().__init__(api_client)
        self.raw = LeaveTransactionApiRaw(api_client)
