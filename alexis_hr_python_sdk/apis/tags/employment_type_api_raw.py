...
from alexis_hr_python_sdk.paths.employment_type.post import CreateOneEmploymentTypeRaw
from alexis_hr_python_sdk.paths.employment_type_id.delete import DeleteOneTypeRaw
from alexis_hr_python_sdk.paths.employment_type.get import GetManyEmploymentTypesRaw
from alexis_hr_python_sdk.paths.employment_type_id.get import GetOneRaw
from alexis_hr_python_sdk.paths.employment_type_id.put import UpdateOneEmploymentTypeRaw
from alexis_hr_python_sdk.paths.employment_type_id.patch import UpdateOneEmploymentType0Raw


class EmploymentTypeApiRaw(
    CreateOneEmploymentTypeRaw,
    DeleteOneTypeRaw,
    GetManyEmploymentTypesRaw,
    GetOneRaw,
    UpdateOneEmploymentTypeRaw,
    UpdateOneEmploymentType0Raw,
):
    """NOTE:
