...
from alexis_hr_python_sdk.paths.employment.post import CreateOneEmploymentRaw
from alexis_hr_python_sdk.paths.employment_id.get import GetOneRaw
from alexis_hr_python_sdk.paths.employment.get import ListManyEmploymentsRaw
from alexis_hr_python_sdk.paths.employment_id.delete import RemoveOneRaw
from alexis_hr_python_sdk.paths.employment_id.put import ReplaceOneRaw
from alexis_hr_python_sdk.paths.employment_id.patch import UpdateEmploymentDataRaw


class EmploymentApiRaw(
    CreateOneEmploymentRaw,
    GetOneRaw,
    ListManyEmploymentsRaw,
    RemoveOneRaw,
    ReplaceOneRaw,
    UpdateEmploymentDataRaw,
):
    """NOTE:
