...
from alexis_hr_python_sdk.paths.employee.post import CreateOneEmployeeRaw
from alexis_hr_python_sdk.paths.employee_id.get import GetOneRaw
from alexis_hr_python_sdk.paths.employee.get import ListManyEmployeesRaw
from alexis_hr_python_sdk.paths.employee_id.delete import RemoveEmployeeRaw
from alexis_hr_python_sdk.paths.employee_id.put import ReplaceOneEmployeeRaw
from alexis_hr_python_sdk.paths.employee_id.patch import UpdateOneRaw


class EmployeeApiRaw(
    CreateOneEmployeeRaw,
    GetOneRaw,
    ListManyEmployeesRaw,
    RemoveEmployeeRaw,
    ReplaceOneEmployeeRaw,
    UpdateOneRaw,
):
    """NOTE:
