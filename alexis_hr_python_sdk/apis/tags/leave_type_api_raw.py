...
from alexis_hr_python_sdk.paths.leave_type.post import CreateOneLeaveTypeRaw
from alexis_hr_python_sdk.paths.leave_type_id.delete import DeleteOneLeaveTypeRaw
from alexis_hr_python_sdk.paths.leave_type.get import GetManyLeaveTypesRaw
from alexis_hr_python_sdk.paths.leave_type_id.get import GetOneLeaveTypeRaw
from alexis_hr_python_sdk.paths.leave_type_id.put import ReplaceLeaveTypeRaw
from alexis_hr_python_sdk.paths.leave_type_id.patch import UpdateOneLeaveTypeRaw


class LeaveTypeApiRaw(
    CreateOneLeaveTypeRaw,
    DeleteOneLeaveTypeRaw,
    GetManyLeaveTypesRaw,
    GetOneLeaveTypeRaw,
    ReplaceLeaveTypeRaw,
    UpdateOneLeaveTypeRaw,
):
    """NOTE:
