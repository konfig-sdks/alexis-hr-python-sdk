...
from alexis_hr_python_sdk.paths.timesheet_entry_type_id.get import GetOneTimesheetEntryType
from alexis_hr_python_sdk.paths.timesheet_entry_type.get import ListManyTimesheetEntryTypes
from alexis_hr_python_sdk.apis.tags.timesheet_entry_type_api_raw import TimesheetEntryTypeApiRaw


class TimesheetEntryTypeApi(
    ...
    """
    raw: TimesheetEntryTypeApiRaw

    def __init__(self, api_client=None):
        super().__init__(api_client)
        self.raw = TimesheetEntryTypeApiRaw(api_client)
