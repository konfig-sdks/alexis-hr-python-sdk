...
from alexis_hr_python_sdk.paths.department.post import CreateOneRaw
from alexis_hr_python_sdk.paths.department_id.delete import DeleteOneDepartmentRaw
from alexis_hr_python_sdk.paths.department_id.get import GetOneRaw
from alexis_hr_python_sdk.paths.department.get import ListManyDepartmentsRaw
from alexis_hr_python_sdk.paths.department_id.put import ReplaceOneRaw
from alexis_hr_python_sdk.paths.department_id.patch import UpdateOneDepartmentRaw


class DepartmentApiRaw(
    CreateOneRaw,
    DeleteOneDepartmentRaw,
    GetOneRaw,
    ListManyDepartmentsRaw,
    ReplaceOneRaw,
    UpdateOneDepartmentRaw,
):
    """NOTE:
