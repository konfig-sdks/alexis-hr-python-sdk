...
class DepartmentResponse(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            effectiveCostCenterId = schemas.StrSchema
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "companyId", "name", "description", "costCenterId", "effectiveCostCenterId", "parentId", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "companyId", "name", "description", "costCenterId", "effectiveCostCenterId", "parentId", ], str]):
