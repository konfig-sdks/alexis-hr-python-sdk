...
class DepartmentRelationsResponse(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["costCenter", "effectiveCostCenter", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["costCenter", "effectiveCostCenter", ], str]):
