...
class WorkWeeksGetManyResponseMapped(
    schemas.DictSchema
):
    """
        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['WorkWeekResponse']:
                        return WorkWeekResponse
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['WorkWeekResponse'], typing.List['WorkWeekResponse']],
                ...
                def __getitem__(self, i: int) -> 'WorkWeekResponse':
            ...
            @staticmethod
            def relations() -> typing.Type['WorkWeekRelationsResponse']:
                return WorkWeekRelationsResponse
            __annotations__ = {
                "status": status,
                "data": data,
                "total": total,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["relations"]) -> 'WorkWeekRelationsResponse': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["relations"]) -> typing.Union['WorkWeekRelationsResponse', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        relations: typing.Union['WorkWeekRelationsResponse', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
