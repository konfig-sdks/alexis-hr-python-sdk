...
class WorkShiftResponse(
    ...
    class MetaOapg:
        ...
        class properties:
            startHour = schemas.NumberSchema
            startMinute = schemas.NumberSchema
            endHour = schemas.NumberSchema
            endMinute = schemas.NumberSchema
    ...
    endHour: MetaOapg.properties.endHour
    startHour: MetaOapg.properties.startHour
    startMinute: MetaOapg.properties.startMinute
    endMinute: MetaOapg.properties.endMinute
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["startHour", "startMinute", "endHour", "endMinute", "duration", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["startHour"]) -> MetaOapg.properties.startHour: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["startMinute"]) -> MetaOapg.properties.startMinute: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["endHour"]) -> MetaOapg.properties.endHour: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["endMinute"]) -> MetaOapg.properties.endMinute: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["startHour", "startMinute", "endHour", "endMinute", "duration", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        endHour: typing.Union[MetaOapg.properties.endHour, decimal.Decimal, int, float, ],
        startHour: typing.Union[MetaOapg.properties.startHour, decimal.Decimal, int, float, ],
        startMinute: typing.Union[MetaOapg.properties.startMinute, decimal.Decimal, int, float, ],
        endMinute: typing.Union[MetaOapg.properties.endMinute, decimal.Decimal, int, float, ],
