...
class EmergencyContactResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "employeeId", "fullName", "relationship", "phone", "email", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "employeeId", "fullName", "relationship", "phone", "email", ], str]):
