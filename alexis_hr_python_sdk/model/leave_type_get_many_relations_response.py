...
class LeaveTypeGetManyRelationsResponse(
    schemas.DictSchema
):
    """
        ...
        class properties:
            ...
            class leaveTypeCode(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['LeaveTypeCodeResponse']:
                        return LeaveTypeCodeResponse
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['LeaveTypeCodeResponse'], typing.List['LeaveTypeCodeResponse']],
                ...
                def __getitem__(self, i: int) -> 'LeaveTypeCodeResponse':
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["leaveTypeCode"]) -> MetaOapg.properties.leaveTypeCode: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["leaveTypeCode", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["leaveTypeCode"]) -> typing.Union[MetaOapg.properties.leaveTypeCode, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["leaveTypeCode", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        leaveTypeCode: typing.Union[MetaOapg.properties.leaveTypeCode, list, tuple, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
