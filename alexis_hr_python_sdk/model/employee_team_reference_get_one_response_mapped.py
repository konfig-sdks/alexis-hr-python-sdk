...
class EmployeeTeamReferenceGetOneResponseMapped(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def data() -> typing.Type['EmployeeTeamReferenceResponse']:
                return EmployeeTeamReferenceResponse
        
            @staticmethod
            def relations() -> typing.Type['EmployeeTeamReferenceRelationsResponse']:
                return EmployeeTeamReferenceRelationsResponse
            __annotations__ = {
                "status": status,
                "data": data,
                "relations": relations,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["data"]) -> 'EmployeeTeamReferenceResponse': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["relations"]) -> 'EmployeeTeamReferenceRelationsResponse': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["data"]) -> 'EmployeeTeamReferenceResponse': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["relations"]) -> typing.Union['EmployeeTeamReferenceRelationsResponse', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        relations: typing.Union['EmployeeTeamReferenceRelationsResponse', schemas.Unset] = schemas.unset,
