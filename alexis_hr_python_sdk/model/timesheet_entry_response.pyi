...
class TimesheetEntryResponse(
    ...
    timesheetId: MetaOapg.properties.timesheetId
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "timesheetId", "typeId", "employeeId", "date", "status", "minutes", "updated", "note", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["timesheetId"]) -> MetaOapg.properties.timesheetId: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "timesheetId", "typeId", "employeeId", "date", "status", "minutes", "updated", "note", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        timesheetId: typing.Union[MetaOapg.properties.timesheetId, str, ],
        minutes: typing.Union[MetaOapg.properties.minutes, decimal.Decimal, int, float, ],
