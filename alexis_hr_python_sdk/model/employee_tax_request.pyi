...
class EmployeeTaxRequest(
    ...
    class MetaOapg:
        ...
        class properties:
            table = schemas.NumberSchema
            column = schemas.NumberSchema
            __annotations__ = {
                "table": table,
                "column": column,
            }
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        table: typing.Union[MetaOapg.properties.table, decimal.Decimal, int, float, schemas.Unset] = schemas.unset,
        column: typing.Union[MetaOapg.properties.column, decimal.Decimal, int, float, schemas.Unset] = schemas.unset,
