...
class UpdateEmploymentRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["employeeId", "userId", "typeId", "startDate", "endDate", "effectiveEndDate", "terminated", "rate", "note", "country", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["employeeId", "userId", "typeId", "startDate", "endDate", "effectiveEndDate", "terminated", "rate", "note", "country", ], str]):
