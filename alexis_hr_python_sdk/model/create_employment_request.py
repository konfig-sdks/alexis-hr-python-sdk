...
class CreateEmploymentRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["employeeId", "userId", "typeId", "startDate", "terminated", "rate", "country", "endDate", "effectiveEndDate", "note", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["employeeId", "userId", "typeId", "startDate", "terminated", "rate", "country", "endDate", "effectiveEndDate", "note", ], str]):
