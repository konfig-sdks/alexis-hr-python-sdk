...
class EmployeeTeamReferenceRelationsResponseEmployee(
    schemas.ListSchema
):
    """NOTE:
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['EmployeeTeamReferenceRelationsResponseEmployeeItem']:
            return EmployeeTeamReferenceRelationsResponseEmployeeItem

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['EmployeeTeamReferenceRelationsResponseEmployeeItem'], typing.List['EmployeeTeamReferenceRelationsResponseEmployeeItem']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'EmployeeTeamReferenceRelationsResponseEmployee':
    ...
    def __getitem__(self, i: int) -> 'EmployeeTeamReferenceRelationsResponseEmployeeItem':
