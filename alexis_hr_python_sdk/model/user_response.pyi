...
class UserResponse(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["systemRole"]) -> MetaOapg.properties.systemRole: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "locale", "systemRole", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["systemRole"]) -> typing.Union[MetaOapg.properties.systemRole, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "locale", "systemRole", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        systemRole: typing.Union[MetaOapg.properties.systemRole, str, schemas.Unset] = schemas.unset,
