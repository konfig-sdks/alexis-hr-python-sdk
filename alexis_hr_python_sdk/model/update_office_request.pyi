...
class UpdateOfficeRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "phone", "email", "timezone", "CFAR", "SCB", "SNI", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "phone", "email", "timezone", "CFAR", "SCB", "SNI", ], str]):
