...
class CreateEmploymentTypeRequest(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "vacation", "country", "maxMonths", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "vacation", "country", "maxMonths", ], str]):
