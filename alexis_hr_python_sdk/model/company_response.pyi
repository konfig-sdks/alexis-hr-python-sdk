...
class CompanyResponse(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            orgNumber = schemas.StrSchema
            billableUsers = schemas.NumberSchema
            vatNumber = schemas.StrSchema
            phone = schemas.StrSchema
            email = schemas.StrSchema
            legalName = schemas.StrSchema
            logoUrl = schemas.StrSchema
            backgroundUrl = schemas.StrSchema
            offboardDate = schemas.StrSchema
            __annotations__ = {
                "id": id,
                "name": name,
                "orgNumber": orgNumber,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["orgNumber"]) -> MetaOapg.properties.orgNumber: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["billableUsers"]) -> MetaOapg.properties.billableUsers: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["vatNumber"]) -> MetaOapg.properties.vatNumber: ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["backgroundUrl"]) -> MetaOapg.properties.backgroundUrl: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["offboardDate"]) -> MetaOapg.properties.offboardDate: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "name", "orgNumber", "billableUsers", "vatNumber", "phone", "email", "legalName", "logoUrl", "backgroundUrl", "offboardDate", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["orgNumber"]) -> typing.Union[MetaOapg.properties.orgNumber, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["billableUsers"]) -> typing.Union[MetaOapg.properties.billableUsers, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["vatNumber"]) -> typing.Union[MetaOapg.properties.vatNumber, schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["backgroundUrl"]) -> typing.Union[MetaOapg.properties.backgroundUrl, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["offboardDate"]) -> typing.Union[MetaOapg.properties.offboardDate, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "name", "orgNumber", "billableUsers", "vatNumber", "phone", "email", "legalName", "logoUrl", "backgroundUrl", "offboardDate", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        orgNumber: typing.Union[MetaOapg.properties.orgNumber, str, schemas.Unset] = schemas.unset,
        billableUsers: typing.Union[MetaOapg.properties.billableUsers, decimal.Decimal, int, float, schemas.Unset] = schemas.unset,
        vatNumber: typing.Union[MetaOapg.properties.vatNumber, str, schemas.Unset] = schemas.unset,
        ...
        backgroundUrl: typing.Union[MetaOapg.properties.backgroundUrl, str, schemas.Unset] = schemas.unset,
        offboardDate: typing.Union[MetaOapg.properties.offboardDate, str, schemas.Unset] = schemas.unset,
