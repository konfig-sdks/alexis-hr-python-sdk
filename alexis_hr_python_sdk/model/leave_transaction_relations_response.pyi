...
class LeaveTransactionRelationsResponse(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["child", "leaveType", "employee", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["child", "leaveType", "employee", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        leaveType: typing.Union[MetaOapg.properties.leaveType, list, tuple, schemas.Unset] = schemas.unset,
