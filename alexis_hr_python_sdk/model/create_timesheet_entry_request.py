...
class CreateTimesheetEntryRequest(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["typeId", "employeeId", "date", "minutes", "note", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["typeId", "employeeId", "date", "minutes", "note", ], str]):
