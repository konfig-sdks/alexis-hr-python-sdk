...
class TimesheetEntryRelationsResponse(
    schemas.DictSchema
):
    """
        ...
        class properties:
            ...
            class timesheet(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['TimesheetResponse']:
                        return TimesheetResponse
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['TimesheetResponse'], typing.List['TimesheetResponse']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'timesheet':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'TimesheetResponse':
                    return super().__getitem__(i)
            ...
            class type(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['TimesheetEntryTypeResponse']:
                        return TimesheetEntryTypeResponse
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['TimesheetEntryTypeResponse'], typing.List['TimesheetEntryTypeResponse']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'type':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'TimesheetEntryTypeResponse':
                    return super().__getitem__(i)
            __annotations__ = {
                "employee": employee,
                "timesheet": timesheet,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["timesheet"]) -> MetaOapg.properties.timesheet: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["employee", "timesheet", "type", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["timesheet"]) -> typing.Union[MetaOapg.properties.timesheet, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["employee", "timesheet", "type", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        employee: typing.Union[MetaOapg.properties.employee, list, tuple, schemas.Unset] = schemas.unset,
        timesheet: typing.Union[MetaOapg.properties.timesheet, list, tuple, schemas.Unset] = schemas.unset,
