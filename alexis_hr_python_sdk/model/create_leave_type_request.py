...
class CreateLeaveTypeRequest(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            minimumDuration = schemas.StrSchema
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "kind", "minimumDuration", "deductible", "paid", "disabled", "archived", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "kind", "minimumDuration", "deductible", "paid", "disabled", "archived", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        deductible: typing.Union[MetaOapg.properties.deductible, bool, schemas.Unset] = schemas.unset,
