...
class LeaveTypeCodeResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "companyId", "leaveTypeId", "code", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "companyId", "leaveTypeId", "code", ], str]):
