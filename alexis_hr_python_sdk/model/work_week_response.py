...
class WorkWeekResponse(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def monday() -> typing.Type['WorkWeekDayResponse']:
                return WorkWeekDayResponse
        
            @staticmethod
            def tuesday() -> typing.Type['WorkWeekDayResponse']:
                return WorkWeekDayResponse
        
            @staticmethod
            def wednesday() -> typing.Type['WorkWeekDayResponse']:
                return WorkWeekDayResponse
        
            @staticmethod
            def thursday() -> typing.Type['WorkWeekDayResponse']:
                return WorkWeekDayResponse
        
            @staticmethod
            def friday() -> typing.Type['WorkWeekDayResponse']:
                return WorkWeekDayResponse
        
            @staticmethod
            def saturday() -> typing.Type['WorkWeekDayResponse']:
                return WorkWeekDayResponse
        
            @staticmethod
            def sunday() -> typing.Type['WorkWeekDayResponse']:
                return WorkWeekDayResponse
            officeId = schemas.StrSchema
            employeeId = schemas.StrSchema
            effectiveTo = schemas.DateTimeSchema
            __annotations__ = {
                "id": id,
                "companyId": companyId,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["monday"]) -> 'WorkWeekDayResponse': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["tuesday"]) -> 'WorkWeekDayResponse': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["wednesday"]) -> 'WorkWeekDayResponse': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["thursday"]) -> 'WorkWeekDayResponse': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["friday"]) -> 'WorkWeekDayResponse': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["saturday"]) -> 'WorkWeekDayResponse': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["sunday"]) -> 'WorkWeekDayResponse': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "companyId", "effectiveFrom", "timezone", "duration", "monday", "tuesday", "wednesday", "thursday", "friday", "saturday", "sunday", "officeId", "employeeId", "effectiveTo", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["monday"]) -> 'WorkWeekDayResponse': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["tuesday"]) -> 'WorkWeekDayResponse': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["wednesday"]) -> 'WorkWeekDayResponse': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["thursday"]) -> 'WorkWeekDayResponse': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["friday"]) -> 'WorkWeekDayResponse': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["saturday"]) -> 'WorkWeekDayResponse': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["sunday"]) -> 'WorkWeekDayResponse': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "companyId", "effectiveFrom", "timezone", "duration", "monday", "tuesday", "wednesday", "thursday", "friday", "saturday", "sunday", "officeId", "employeeId", "effectiveTo", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        effectiveTo: typing.Union[MetaOapg.properties.effectiveTo, str, datetime, schemas.Unset] = schemas.unset,
