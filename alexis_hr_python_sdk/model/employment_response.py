...
class EmploymentResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "companyId", "employeeId", "typeId", "startDate", "terminated", "rate", "country", "endDate", "updated", "effectiveEndDate", "note", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "companyId", "employeeId", "typeId", "startDate", "terminated", "rate", "country", "endDate", "updated", "effectiveEndDate", "note", ], str]):
