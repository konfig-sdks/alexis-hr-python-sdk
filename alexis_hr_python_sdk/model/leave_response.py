...
class LeaveResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "employeeId", "typeId", "status", "duration", "startDate", "endDate", "description", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "employeeId", "typeId", "status", "duration", "startDate", "endDate", "description", ], str]):
