...
class CreateWorkWeekRequest(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def monday() -> typing.Type['WorkWeekDayRequest']:
                return WorkWeekDayRequest
        
            @staticmethod
            def tuesday() -> typing.Type['WorkWeekDayRequest']:
                return WorkWeekDayRequest
        
            @staticmethod
            def wednesday() -> typing.Type['WorkWeekDayRequest']:
                return WorkWeekDayRequest
        
            @staticmethod
            def thursday() -> typing.Type['WorkWeekDayRequest']:
                return WorkWeekDayRequest
        
            @staticmethod
            def friday() -> typing.Type['WorkWeekDayRequest']:
                return WorkWeekDayRequest
        
            @staticmethod
            def saturday() -> typing.Type['WorkWeekDayRequest']:
                return WorkWeekDayRequest
        
            @staticmethod
            def sunday() -> typing.Type['WorkWeekDayRequest']:
                return WorkWeekDayRequest
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["monday"]) -> 'WorkWeekDayRequest': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["tuesday"]) -> 'WorkWeekDayRequest': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["wednesday"]) -> 'WorkWeekDayRequest': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["thursday"]) -> 'WorkWeekDayRequest': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["friday"]) -> 'WorkWeekDayRequest': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["saturday"]) -> 'WorkWeekDayRequest': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["sunday"]) -> 'WorkWeekDayRequest': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["effectiveFrom", "timezone", "duration", "monday", "tuesday", "wednesday", "thursday", "friday", "saturday", "sunday", "employeeId", "officeId", "effectiveTo", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["monday"]) -> 'WorkWeekDayRequest': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["tuesday"]) -> 'WorkWeekDayRequest': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["wednesday"]) -> 'WorkWeekDayRequest': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["thursday"]) -> 'WorkWeekDayRequest': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["friday"]) -> 'WorkWeekDayRequest': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["saturday"]) -> 'WorkWeekDayRequest': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["sunday"]) -> 'WorkWeekDayRequest': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["effectiveFrom", "timezone", "duration", "monday", "tuesday", "wednesday", "thursday", "friday", "saturday", "sunday", "employeeId", "officeId", "effectiveTo", ], str]):
