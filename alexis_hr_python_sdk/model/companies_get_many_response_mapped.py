...
class CompaniesGetManyResponseMapped(
    schemas.DictSchema
):
    """
        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['CompanyResponse']:
                        return CompanyResponse
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['CompanyResponse'], typing.List['CompanyResponse']],
                ...
                def __getitem__(self, i: int) -> 'CompanyResponse':
