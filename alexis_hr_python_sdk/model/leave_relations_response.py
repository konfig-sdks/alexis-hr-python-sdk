...
class LeaveRelationsResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["type", "employee", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["type", "employee", ], str]):
