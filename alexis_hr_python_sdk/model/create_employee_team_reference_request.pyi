...
class CreateEmployeeTeamReferenceRequest(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["teamId", "companyId", "employeeId", "userId", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["teamId", "companyId", "employeeId", "userId", ], str]):
