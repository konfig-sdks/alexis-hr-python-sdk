...
class TimesheetEntriesGetManyResponseMapped(
    schemas.DictSchema
):
    """
        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['TimesheetEntryResponse']:
                        return TimesheetEntryResponse
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['TimesheetEntryResponse'], typing.List['TimesheetEntryResponse']],
                ...
                def __getitem__(self, i: int) -> 'TimesheetEntryResponse':
            ...
            @staticmethod
            def relations() -> typing.Type['TimesheetEntryRelationsResponse']:
                return TimesheetEntryRelationsResponse
            __annotations__ = {
                "status": status,
                "data": data,
                "total": total,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["relations"]) -> 'TimesheetEntryRelationsResponse': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["relations"]) -> typing.Union['TimesheetEntryRelationsResponse', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        relations: typing.Union['TimesheetEntryRelationsResponse', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
