...
class BankAccountResponse(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["clearing"]) -> MetaOapg.properties.clearing: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["bank", "clearing", "number", "iban", "bic", "country", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["clearing"]) -> typing.Union[MetaOapg.properties.clearing, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["bank", "clearing", "number", "iban", "bic", "country", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        clearing: typing.Union[MetaOapg.properties.clearing, str, schemas.Unset] = schemas.unset,
