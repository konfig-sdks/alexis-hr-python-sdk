...
setup(
    name=NAME,
    version=VERSION,
    description="AlexisHR API",
    author="AlexisHR Support",
    author_email="support@alexishr.com",
    url="https://github.com/konfig-sdks/alexis-hr-python-sdk/tree/main/python",
    keywords=["Konfig", "AlexisHR API"],
    python_requires=">=3.7",
